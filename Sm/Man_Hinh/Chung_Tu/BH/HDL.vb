...
#Region "Columns Edit"
    ...
    Dim EditGia2, EditGia_NT2, EditMa_Thue, EditThue_Suat, EditThue, EditThue_NT, EditGia3, EditGia_nt3, EditTien2, EditTien_nt2, EditTien3, EditTien_nt3 As New Cyber.Fill.CyberColumnGridView
    'Dim EditSL_DC As New Cyber.Fill.CyberColumnGridView
#End Region
...
#End Region
    Private Sub HDL_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#Region "Load And Set And Default"
    Private Sub V_Load()
        ...
        TxtT_Tien_NT2.InputMask = IIf(DrDmct.Item("M_IP_MK_TIEN_NT").ToString.Trim <> "", DrDmct.Item("M_IP_MK_TIEN_NT").ToString.Trim, TxtT_Tien_NT.InputMask)
        TxtT_Tien2.InputMask = IIf(DrDmct.Item("M_IP_MK_TIEN").ToString.Trim <> "", DrDmct.Item("M_IP_MK_TIEN").ToString.Trim, TxtT_Tien.InputMask)
    ...
    Private Sub V_GetColumn()
        ...
        'EditSL_DC.GetColumn(DetailGRV, "Sl_DC")
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Master()
        ...
        '--DB
        AddHandler TxtMa_DB_H.CyberValiting, AddressOf V_Ma_DB_H
        AddHandler TxtMa_DB_H.CyberLeave, AddressOf L_Ma_DB_H
        '--Ma_BP_H
        ...
        '----------------------------------------------------------------------------------------------------------
        AddHandler TxtSo_DH.Leave, AddressOf L_So_HD
        '----------------------------------------------------------------------------------------------------------
        ...
        AddHandler CmdLich_Su.Click, AddressOf V_Lich_Su_So_SO
    End Sub
    Private Sub V_AddHandler_Detail()
        ...
        'If Not EditSL_DC.Column Is Nothing Then AddHandler EditSo_Luong.EditColumn.Leave, AddressOf L_Tinh_Toan
    ...
    Private Sub VisibleColumnMa_NT()
        If TxtMa_NT.Text.Trim = "" Or TxtMa_NT.Text.Trim.ToUpper = osysvar("M_Ma_NT0").ToString.Trim.ToUpper Then
            ...
            If Not EditThue Is Nothing Then EditThue.Visible = False
        Else
            EditTien.Visible = True
            EditGia.Visible = True
            TxtT_Tien.Visible = True

            EditTien2.Visible = True
            EditGia2.Visible = True
            TxtT_Tien2.Visible = True

            EditThue.Visible = True

            EditTien3.Visible = True
            EditGia3.Visible = True

            TxtT_Tien3.Visible = True
            ...
            If Not EditThue Is Nothing Then EditThue.Visible = True
    ...
    Private Sub VisibleColumnMa_GD()
        'If EditTien_nt2.Column Is Nothing Then
        '    LabTien_NT2.Visible = False
        '    TxtT_Tien_NT2.Visible = False
        '    TxtT_Tien2.Visible = False
        'End If
        'If EditTien_nt3.Column Is Nothing Then
        '    LabTien_NT3.Visible = False
    ...
    Private Sub V_GetNoVoucherAuto()
        ...
        'txtSo_ct.Text = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_SysGetSo_So", M_Mode + "#" + txtSo_ct.Text.Trim + "#" + M_Stt_Rec + "#" + _Ngay_Ct + "#" + _Ngay_LCt + "#" + M_Ma_CT + "#" + M_Ma_Dvcs + "#" + M_User_Name)
        Dim _Return As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_SysGetSo_So", M_Mode + "#" + txtSo_ct.Text.Trim + "#" + M_Stt_Rec + "#" + _Ngay_Ct + "#" + _Ngay_LCt + "#" + M_Ma_CT + "#" + M_Ma_Dvcs + "#" + M_User_Name)
        Dim _Dt As DataTable = _Return.Tables(0)
        txtSo_ct.Text = _Dt.Rows(0).Item("So_SO").ToString


    End Sub
#End Region
#Region "Valid - Master"
    Private Sub L_So_HD(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim _Dt As Date = TxtNgay_Ct.Value
        TxtSo_DH.Text = TxtSo_DH.Text.Trim.Replace(" ", "").Trim
        If TxtSo_DH.Text.Trim = "" Then Exit Sub

        TxtSo_DH.Text = CyberVoucher.V_FormatSo_DH(AppConn, osysvar, M_Ma_CT, "S", M_Mode, _Dt, TxtSo_DH.Text, CbbMa_TTCP_H, TxtMa_Dvcs.Text, M_User_Name, CyberSmlib)

        Dim nCount As Integer = 0
        For i As Integer = 0 To Dv_DetailTmp.Count - 1
            If Not Dv_DetailTmp.Item(i).Item("Ma_Vt").ToString.Trim = "" Then nCount = nCount + 1
        Next
        If nCount > 0 Then Exit Sub

        Dim _DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetHDLFromHDH", M_Stt_Rec & "#" & M_Ma_CT & "#" & _Dt.ToString("yyyyMMdd") & "#" & TxtSo_DH.Text & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        ...
        If TxtMa_Kh.Text.Trim = "" And _DsTmp.Tables(1).Columns.Contains("Ma_kh") Then TxtMa_Kh.Text = _DsTmp.Tables(1).Rows(0).Item("Ma_kh")
        If TxtTen_kh.Text.Trim = "" And _DsTmp.Tables(1).Columns.Contains("Ten_kh") Then TxtTen_kh.Text = _DsTmp.Tables(1).Rows(0).Item("Ten_kh")
        If TxtDia_Chi.Text.Trim = "" And _DsTmp.Tables(1).Columns.Contains("Dia_Chi") Then TxtDia_Chi.Text = _DsTmp.Tables(1).Rows(0).Item("Dia_Chi")


        If txtOng_ba.Text.Trim = "" And _DsTmp.Tables(1).Columns.Contains("Ong_ba") Then txtOng_ba.Text = _DsTmp.Tables(1).Rows(0).Item("Ong_ba")

        If TxtMa_Bp_H.Text.Trim = "" And _DsTmp.Tables(1).Columns.Contains("Ma_Bp_H") Then TxtMa_Bp_H.Text = _DsTmp.Tables(1).Rows(0).Item("Ma_Bp_H")
        If txtTen_BP_H.Text.Trim = "" And _DsTmp.Tables(1).Columns.Contains("Ten_Bp_H") Then txtTen_BP_H.Text = _DsTmp.Tables(1).Rows(0).Item("Ten_Bp_H")

        If txtMa_HS_H.Text.Trim = "" And _DsTmp.Tables(1).Columns.Contains("Ma_HS_H") Then txtMa_HS_H.Text = _DsTmp.Tables(1).Rows(0).Item("Ma_HS_H")
        If txtTen_HS_H.Text.Trim = "" And _DsTmp.Tables(1).Columns.Contains("Ten_HS_H") Then txtTen_HS_H.Text = _DsTmp.Tables(1).Rows(0).Item("Ten_HS_H")

        If TxtMa_DB_H.Text.Trim = "" And _DsTmp.Tables(1).Columns.Contains("Ma_DB_H") Then TxtMa_DB_H.Text = _DsTmp.Tables(1).Rows(0).Item("Ma_DB_H")
        If TxtTen_DB_H.Text.Trim = "" And _DsTmp.Tables(1).Columns.Contains("Ten_DB_H") Then TxtTen_DB_H.Text = _DsTmp.Tables(1).Rows(0).Item("Ten_DB_H")

        If txtDien_giai.Text.Trim = "" And _DsTmp.Tables(1).Columns.Contains("Dien_Giai") Then txtDien_giai.Text = _DsTmp.Tables(1).Rows(0).Item("Dien_Giai")
...
#End Region
#Region "Valid --- Ma_DB"
    Private Sub V_Ma_DB_H(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        TxtMa_DB_H.V_LookUp(M_LAN, M_Para, osysvar, AppConn, DsLookup, "Ma_DB", "DmDB", "1=1", "1=1")
    End Sub
    Private Sub L_Ma_DB_H(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If TxtMa_DB_H.Text = "" Then
            TxtTen_DB_H.Text = ""
            Exit Sub
        End If
        DrReturn = TxtMa_DB_H.GetRowsSelectData(True)
        If Not DrReturn Is Nothing Then
            TxtMa_DB_H.Text = DrReturn.Item("Ma_DB")
            TxtTen_DB_H.Text = DrReturn.Item("Ten_DB")
        Else
            TxtMa_DB_H.Text = ""
            TxtTen_DB_H.Text = ""
        End If
...
#Region "Valid - Detail - Core"
    Private Sub UpdateList()
        ...
        For iRow As Integer = 0 To Dv_DetailTmp.Count - 1
            ...
            If Dv_DetailTmp.Table.Columns.Contains("Thue") Then nT_Thue_NT = nT_Tien_NT + Dv_DetailTmp.Item(iRow).Item("Thue_NT")
            If Dv_DetailTmp.Table.Columns.Contains("Thue") Then nT_Thue = nT_Tien + Dv_DetailTmp.Item(iRow).Item("Thue")
            ...
            nT_SL_DC = nT_SL_DC + Dv_DetailTmp.Item(iRow).Item("SL_DC")
        Next

        TxtT_SO_LUONG.Double = nT_So_Luong
        TxtT_SL_DC.Double = nT_SL_DC
    ...
    Private Sub V_Tinh_Toan(ByVal iRow As Integer)
        ...
        '--------------------------------------------------------------------------------
        'If (Dv_DetailTmp.Item(iRow).Item("So_Luong") + Dv_DetailTmp.Item(iRow).Item("Sl_DC")) * Dv_DetailTmp.Item(iRow).Item("Gia_NT") <> 0 Then
        If Dv_DetailTmp.Item(iRow).Item("So_Luong") * Dv_DetailTmp.Item(iRow).Item("Gia_NT") <> 0 Then
            Dv_DetailTmp.Item(iRow).BeginEdit()
            'Dv_DetailTmp.Item(iRow).Item("Tien_NT") = CyberSupport.V_Round((Dv_DetailTmp.Item(iRow).Item("So_Luong") + Dv_DetailTmp.Item(iRow).Item("Sl_DC")) * Dv_DetailTmp.Item(iRow).Item("Gia_NT"), M_R_TIEN_NT)
        ...
        'If (Dv_DetailTmp.Item(iRow).Item("So_Luong") + Dv_DetailTmp.Item(iRow).Item("Sl_DC")) * Dv_DetailTmp.Item(iRow).Item("Gia_NT2") <> 0 Then
        If Dv_DetailTmp.Item(iRow).Item("So_Luong") * Dv_DetailTmp.Item(iRow).Item("Gia_NT2") <> 0 Then
            Dv_DetailTmp.Item(iRow).BeginEdit()
            'Dv_DetailTmp.Item(iRow).Item("Tien_NT2") = CyberSupport.V_Round((Dv_DetailTmp.Item(iRow).Item("So_Luong") + Dv_DetailTmp.Item(iRow).Item("Sl_DC")) * Dv_DetailTmp.Item(iRow).Item("Gia_NT2"), M_R_TIEN_NT)
        ...
        'If (Dv_DetailTmp.Item(iRow).Item("So_Luong") + Dv_DetailTmp.Item(iRow).Item("Sl_DC")) * Dv_DetailTmp.Item(iRow).Item("Gia_NT3") <> 0 Then
        If Dv_DetailTmp.Item(iRow).Item("So_Luong") * Dv_DetailTmp.Item(iRow).Item("Gia_NT3") <> 0 Then
            Dv_DetailTmp.Item(iRow).BeginEdit()
            ' Dv_DetailTmp.Item(iRow).Item("Tien_NT3") = CyberSupport.V_Round((Dv_DetailTmp.Item(iRow).Item("So_Luong") + Dv_DetailTmp.Item(iRow).Item("Sl_DC")) * Dv_DetailTmp.Item(iRow).Item("Gia_NT3"), M_R_TIEN_NT)
        ...
        End If
        '----------------------------------------
        If Dv_DetailTmp.Table.Columns.Contains("Thue_Suat") And Dv_DetailTmp.Table.Columns.Contains("Thue") Then
            'If (Dv_DetailTmp.Item(iRow).Item("So_Luong") + Dv_DetailTmp.Item(iRow).Item("Sl_DC")) * Dv_DetailTmp.Item(iRow).Item("Thue_Suat") <> 0 Then
            If Dv_DetailTmp.Item(iRow).Item("So_Luong") * Dv_DetailTmp.Item(iRow).Item("Thue_Suat") <> 0 Then
                Dv_DetailTmp.Item(iRow).BeginEdit()
                Dv_DetailTmp.Item(iRow).Item("Thue") = CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("Tien2") * Dv_DetailTmp.Item(iRow).Item("Thue_Suat") / 100, M_R_TIEN_NT)
                Dv_DetailTmp.Item(iRow).Item("Thue_NT") = CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("Tien_NT2") * Dv_DetailTmp.Item(iRow).Item("Thue_Suat") / 100, M_R_TIEN_NT)
                Dv_DetailTmp.Item(iRow).EndEdit()
            End If
            ...
            Dv_DetailTmp.Item(iRow).Item("Tien_NT3") = Dv_DetailTmp.Item(iRow).Item("Tien_NT2") + Dv_DetailTmp.Item(iRow).Item("Thue_NT")
            Dv_DetailTmp.Item(iRow).Item("Tien3") = Dv_DetailTmp.Item(iRow).Item("Tien2") + Dv_DetailTmp.Item(iRow).Item("Thue")
            Dv_DetailTmp.Item(iRow).EndEdit()
        End If
        '----------------------------------------
    ...
    Private Sub V_Ma_Thue(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        CyberSupport.V_Lookup("Ma_Thue", "Dmthue", "1=1", "1=1", M_Mode, M_Ma_CT, M_LAN, Me.Para, Me.SysVar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_Thue(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim DrReturn As DataRow = CyberSupport.L_Lookup(M_Mode, M_Ma_CT, sender, True)
        Dim iRow As Integer = -1
        iRow = DetailGRV.GetFocusedDataSourceRowIndex
        If iRow < 0 Then Exit Sub
        ...
        Else
            ...
            Dv_DetailTmp.Item(iRow).Item("Thue_Suat") = If(DrReturn Is Nothing, 0, DrReturn.Item("Thue_Suat"))
            Dv_DetailTmp.Item(iRow).EndEdit()
        End If
...
#Region "Vat tu kho/Vitri - "
    ...
    Private Sub L_Ma_Vt(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim _ma_Thue As String = DrReturn.Item("Ma_Thue")
        Dim _Thue_Suat As Decimal = DrReturn.Item("Thue_Suat")
        ...
        If Dv_DetailTmp.Table.Columns.Contains("Ma_Thue") Then Dv_DetailTmp.Item(iRow).Item("Ma_Thue") = IIf(Dv_DetailTmp.Item(iRow).Item("Ma_Thue").ToString.Trim = "", _ma_Thue, Dv_DetailTmp.Item(iRow).Item("Ma_Thue").ToString.Trim)
        If Dv_DetailTmp.Table.Columns.Contains("Thue_Suat") Then Dv_DetailTmp.Item(iRow).Item("Thue_Suat") = IIf(Dv_DetailTmp.Item(iRow).Item("Thue_Suat") = 0, _Thue_Suat, Dv_DetailTmp.Item(iRow).Item("Thue_Suat"))
    ...
    Private Sub V_SetPriceSales(ByVal iRow As Integer)
        ...
        If Dv_DetailTmp.Table.Columns.Contains("Thue_NT") Then If _DtGia.Columns.Contains("Thue_NT") Then Dv_DetailTmp.Item(iRow).Item("Thue_NT") = _DtGia.Rows(0).Item("Thue_NT")
        If Dv_DetailTmp.Table.Columns.Contains("Ma_Thue") Then If _DtGia.Columns.Contains("Ma_Thue") Then Dv_DetailTmp.Item(iRow).Item("Ma_Thue") = _DtGia.Rows(0).Item("Ma_Thue")
        If Dv_DetailTmp.Table.Columns.Contains("Thue_Suat") Then If _DtGia.Columns.Contains("Thue_Suat") Then Dv_DetailTmp.Item(iRow).Item("Thue_Suat") = _DtGia.Rows(0).Item("Thue_Suat")

        If _DtGia.Columns.Contains("Gia_NT3") Then Dv_DetailTmp.Item(iRow).Item("Gia_NT3") = _DtGia.Rows(0).Item("Gia_NT3")
        If _DtGia.Columns.Contains("Tien_Nt3") Then Dv_DetailTmp.Item(iRow).Item("Tien_Nt3") = _DtGia.Rows(0).Item("Tien_Nt3")
...
#Region "Button"
    ...
    Private Sub V_Save_Luu(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        TxtLenh_SO.Text = _So_Ct
        For i As Integer = 0 To Dt_DetailTmp.Rows.Count - 1
            Dt_DetailTmp.Rows(i).BeginEdit()
            If Dt_DetailTmp.Columns.Contains("So_So") Then Dt_DetailTmp.Rows(i).Item("So_So") = TxtLenh_SO.Text.Trim
    ...
    Private Function ChkDa_Xuat(ByVal _Mode) As Boolean
        ...
        For i As Integer = 0 To nCount - 1
            ...
            strSl_DC = strSl_DC + IIf(i = 0, "", "!~!") + Dt_DetailTmp.Rows(i).Item("Sl_DC").ToString.Trim.Replace(",", ".").Replace(" ", "")

        Next
        DsTmp = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_ChkHDLDaXuat", nCount.ToString.Trim & "#" & _Mode & "#" & _Dt.ToString("yyyyMMdd") & "#" & _So & "#" & strMa_vt & "#" & strMa_kho & "#" & strMa_Db & "#" & strSo_Luong & "#" & strSl_DC & "#" & M_Stt_Rec & "#" & M_Ma_Dvcs & "#" & M_User_Name)
    ...
    Private Function ChkVsave() As Boolean
        ...
        For iRow = 0 To Dt_DetailTmp.Rows.Count - 1
            ...
            If Dt_DetailTmp.Columns.Contains("So_So") Then Dt_DetailTmp.Rows(iRow).Item("So_So") = TxtLenh_SO.Text.Trim
        Next
        Dt_DetailTmp.AcceptChanges()
        ...
        UpdateList()
        '----------------------------------------------------------------------------------------------------------------------------
        'Dim Dt_Group As DataTable = CyberSmodb.dtSumGroup("So_Luong", "Ma_VT", Dt_DetailTmp, "1=1")
        ''---Dim Dt_Group As DataTable = CyberSmodb.dtSumGroup("So_Luong,Tien2,Tien_NT2", "Ma_VT,Ma_Lo,Ma_kho", Dt_DetailTmp, "1=1")
        'If Dt_Group.Rows.Count <> Dt_DetailTmp.Rows.Count Then
        '    MsgBox("Có 2 vật tư hàng hóa có 2 dòng dữ liệu", MsgBoxStyle.Critical + MsgBoxStyle.OkOnly, SysVar("M_CYBER_VER"))
        '    Return False
        'End If
        '----------------------------------------------------------------------------------------------------------------------------
        ChkVsave = True
...
#Region "Sms - Import"
    ...
    Private Sub SetTxt()
        ...
        'TxtT_Tien_NT3.Visible = False
        'TxtT_Tien3.Visible = False
        'TxtT_Tien_NT.Visible = False
        'TxtT_Tien.Visible = False
    End Sub
#End Region
#Region "Xem phiếu xuất kho/Lịch sử lệnh xuất hàng"
    Private Sub V_XemPhieuXuat(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim _Cp_name As String = "CP_HDLXemPX"
        Dim _StrFilter As String = M_Stt_Rec + "#" + TxtLenh_SO.Text + "#" + M_Ma_CT + "#" + M_Ma_Dvcs + "#" + M_User_Name
    ...
    End Sub
    Private Sub V_Lich_Su_So_So(ByVal sender As System.Object, ByVal e As System.EventArgs)

        Dim _Ma_Kh As String = TxtMa_Kh.Text
        Dim _CP_name As String = "CP_Filter" + M_Ma_CT.Trim
        Dim _StrFilter As String = "0#" + "ma_Kh" + "#" + _Ma_Kh
        _StrFilter = _StrFilter + "#" + ""
        _StrFilter = _StrFilter + "#" + "19000101"
        _StrFilter = _StrFilter + "#" + "20401231"
        _StrFilter = _StrFilter + "#" + "0"
        _StrFilter = _StrFilter + "#" + "9"
        _StrFilter = _StrFilter + "#" + M_Ma_CT
        _StrFilter = _StrFilter + "#" + M_Ma_Dvcs
        _StrFilter = _StrFilter + "#" + M_User_Name
        Dim DsTmp_History As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, _CP_name, _StrFilter)
        Dim _DvMaster_His As DataView = New DataView(DsTmp_History.Tables(1))
        Dim _Dv_Detail_His As DataView = New DataView(DsTmp_History.Tables(0))
        Dim _Stt_Rec_His As String = ""
        CyberFrom.V_ViewVoucher(AppConn, osysvar, M_LAN, M_Para, DrDmct, DsTmp_History, DsHead, DsLookup, _DvMaster_His, _Dv_Detail_His, _Stt_Rec_His, _StrFilter, CyberFill, CyberSmlib, CyberSupport, False, True)
