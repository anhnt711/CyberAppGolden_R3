...
#End Region
    Private Sub HDH_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Master()
        ...
        AddHandler CmdXemPhieuXuat.Click, AddressOf V_Xem_Lenh
        AddHandler CmdLich_Su.Click, AddressOf V_Lich_Su_So_DH
        '----------------------------------------------------------------------------------------------------------
    End Sub
...
#Region "Valid - Detail - Core"
    ...
    Private Sub V_Tinh_Toan(ByVal iRow As Integer)
        ...
        If Dv_DetailTmp.Item(iRow).Item("So_Luong") * Dv_DetailTmp.Item(iRow).Item("Gia_NT2") <> 0 Then
            ...
            Dv_DetailTmp.Item(iRow).Item("Gia_NT3") = Dv_DetailTmp.Item(iRow).Item("Gia_NT2") + CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("Gia_NT2") * Dv_DetailTmp.Item(iRow).Item("Thue_Suat") / 100, M_R_TIEN_NT)
            Dv_DetailTmp.Item(iRow).EndEdit()
        End If
...
#Region "Xem phiếu xuất kho/Lịch sử lệnh xuất hàng"
    Private Sub V_Xem_Lenh(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim _Cp_name As String = "CP_HDHXemHDL"
    ...
    End Sub
    Private Sub V_Lich_Su_So_DH(ByVal sender As System.Object, ByVal e As System.EventArgs)
