...
#End Region
    Private Sub PXL_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
    ...
    Private Sub V_LoadNew(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If _Para_So_So.Trim = "" Then Exit Sub
        V_New(sender, e)
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_System()
        ...
        AddHandler CmdDanh_Sach_Lenh.Click, AddressOf V_Danh_sach_Lenh
    ...
    Private Sub V_GetNoVoucherAuto()
        ...
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetnoVoucherByNo", M_Mode + "#" + TxtLenh_SO.Text.Trim + "#" + M_Stt_Rec + "#" + _Ngay_Ct.ToString("yyyyMMdd") + "#" + _Ngay_LCt.ToString("yyyyMMdd") + "#" + M_Ma_GD + "#" + M_Ma_CT + "#" + M_Ma_Dvcs + "#" + M_User_Name)
        txtSo_ct.Text = DsTmp.Tables(1).Rows(0).Item("So_CT").ToString
        DsTmp.Dispose()
    End Sub
#End Region
#Region "Valid - Master"
...
#Region "Lenh/SO/Po/Ro/Vt"
    Private Sub L_Lenh_So(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        '---------------------------------------------------------------------------------------------------------------------------------------------------
        Dim _DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetPXLFromHDL", M_Stt_Rec.Trim & "#" & M_Ma_CT & "#" & _Dt.ToString("yyyyMMdd") & "#" & TxtLenh_SO.Text.Trim & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        ...
        If TxtTen_KhVAT.Text.Trim = "" And _DsTmp.Tables(1).Columns.Contains("Ten_khVAT") Then TxtTen_KhVAT.Text = _DsTmp.Tables(1).Rows(0).Item("Ten_khVAT")
        If TxtDia_ChiVAT.Text.Trim = "" And _DsTmp.Tables(1).Columns.Contains("Dia_ChiVAT") Then TxtDia_ChiVAT.Text = _DsTmp.Tables(1).Rows(0).Item("Dia_ChiVAT")
        ...
        If TxtMa_So_Thue.Text.Trim = "" And _DsTmp.Tables(1).Columns.Contains("Ma_So_Thue") Then TxtMa_So_Thue.Text = _DsTmp.Tables(1).Rows(0).Item("Ma_So_Thue")
...
#End Region
#Region "Xem lịch sử"
    Private Sub V_Danh_sach_Lenh(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim str As String
        Dim dt As Date = TxtNgay_Ct.Value
        str = CyberSupport.V_GetStrSelectList(AppConn, osysvar, M_Para, "CP_GetListPXLGetSo_So", dt.ToString("yyyyMMdd") & "#" & TxtMa_Kh.Text & "#" & M_Ma_Dvcs & "#" & M_User_Name, M_LAN)
        If str Is Nothing Then Exit Sub
        TxtLenh_SO.Text = str.ToString.Trim
        L_Lenh_So(sender, e)
    End Sub
#End Region
#End Region
...
#Region "Ngay ct, ngay lap chung tu,so chung tu"
    ...
    Private Sub V_So_Ct(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        txtSo_ct.Text = CyberSupport.V_GetNoVoucher(M_Mode, txtSo_ct.Text, M_Stt_Rec, _Ngay_Ct, _Ngay_LCt, M_Ma_CT, M_Ma_Dvcs, M_User_Name, AppConn, CyberSmlib)
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetnoVoucherByNo", M_Mode + "#" + TxtLenh_SO.Text.Trim + "#" + txtSo_ct.Text.Trim + "#" + M_Stt_Rec + "#" + _Ngay_Ct + "#" + _Ngay_LCt + "#" + M_Ma_CT + "#" + M_Ma_Dvcs + "#" + M_User_Name)
        CyberSmodb.SetNotNullTable(DsTmp.Tables(0))
        txtSo_ct.Text = DsTmp.Tables(0).Rows(0).Item("So_CT").ToString
        DsTmp.Dispose()
    End Sub
#End Region
...
#Region "Button"
    Private Sub V_Save(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Not CyberSmodb.V_SysCheckSaveVoucher(AppConn, osysvar, {Dt_DetailTmp, CyberSmodb.V_ConvertDrToTb(drMaster)}, {M_Ct, M_Ph}, M_Mode, CbbMa_Post.SelectedValue.ToString.Trim, CbbMa_GD.SelectedValue, M_Ma_CT, M_Stt_Rec, M_LAN, TxtMa_Dvcs.Text, M_User_Name, CyberSmlib, CyberSupport, DsSave) Then Return
        '---------------------------------------------------
        '---Update Head
    ...
    Private Function ChkDa_Xuat(ByVal _Mode) As Boolean
        ...
        For i As Integer = 0 To nCount - 1
            strSo_So = strSo_So + IIf(i = 0, "", "!~!") + Dt_DetailTmp.Rows(i).Item("So_So").ToString.Trim
        ...
        Next
        Dim _So_SO As String = TxtLenh_SO.Text
        DsTmp = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_ChkPXLDaXuat", nCount.ToString.Trim & "#" & _Mode & "#" & _Dt.ToString("yyyyMMdd") & "#" & _So_SO & "#" & strSo_So & "#" & strMa_vt & "#" & strMa_kho & "#" & strMa_Db & "#" & strSo_Luong & "#" & M_Stt_Rec & "#" & M_Ma_Dvcs & "#" & M_User_Name)
    ...
    Private Function ChkVsave() As Boolean
        ...
        For iRow = nCount - 1 To 0 Step -1
            If Dt_DetailTmp.Rows(iRow).Item("Ma_VT").ToString.Trim = "" Or Dt_DetailTmp.Rows(iRow).Item("So_Luong") = 0 Then
