...
#End Region
#Region "Columns Edit"
    Dim EditMa_bh, EditTen_Bh, EditSo_quyenBH As New Cyber.Fill.CyberColumnGridView
    Dim EditSo_Luong, EditSeri_dau, EditSeri_Cuoi As New Cyber.Fill.CyberColumnGridView 'DevExpress.XtraEditors.Repository.RepositoryItemTextEdit
#End Region
...
#End Region
    Private Sub NBH_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#Region "Load And Set And Default"
    Private Sub V_Load()
        ...
        'M_Ma_Post = M_Para(M_VT_PARA + 3).Trim
        '-----
    ...
    Private Sub V_GetColumn()
        ...
        EditSo_quyenBH.GetColumn(DetailGRV, "So_quyenBH")
...
#Region "Valid - Detail - Core"
    Private Sub UpdateList()
        ...
        Dim Seri_dau As Decimal = 0
        Dim Seri_Cuoi As Decimal = 0
        Dim SO_Luong As Decimal = 0

        SO_Luong = Seri_Cuoi - Seri_dau + 1
    ...
    Private Sub V_Tinh_Toan(ByVal iRow As Integer)
        ...
        If Dv_DetailTmp.Item(iRow).Item("So_Luong") * Dv_DetailTmp.Item(iRow).Item("Gia_NT") <> 0 Then
            ...
            Dv_DetailTmp.Item(iRow).Item("So_Luong") = CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("Seri_Cuoi") - Dv_DetailTmp.Item(iRow).Item("Seri_dau") + 1)
        ...
        Dv_DetailTmp.Item(iRow).Item("So_Luong") = Dv_DetailTmp.Item(iRow).Item("Seri_Cuoi") - Dv_DetailTmp.Item(iRow).Item("Seri_dau") + 1
...
#Region "ma_bh"
    ...
    Private Sub L_Ma_BH(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        drRow = DetailGRV.GetFocusedDataRow
        ...
        If drReturn Is Nothing Then
            ...
            Exit Sub
        End If
        drRow("Ma_BH") = drReturn("Ma_BH")
        drRow("Ten_BH") = drReturn("Ten_BH")
        'drRow("DVT") = drReturn("DVT")
    End Sub
...
#Region "Button"
    ...
    Private Function ChkVsave() As Boolean
        ...
        For iRow = nCount - 1 To 0 Step -1
            If Dt_DetailTmp.Rows(iRow).Item("Ma_BH").ToString.Trim = "" Then
