...
#Region "Columns Edit"
    ...
    Dim EditSo_Seri, EditDien_Giai As New Cyber.Fill.CyberColumnGridView 'DevExpress.XtraEditors.Repository.RepositoryItemTextEdit
#End Region
...
#End Region
    Private Sub XBH_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#Region "Load And Set And Default"
    ...
    Private Sub V_GetColumn()
        ...
        EditSo_Seri.GetColumn(DetailGRV, "So_Seri")
        EditDien_Giai.GetColumn(DetailGRV, "Dien_Giai")
    ...
    Private Sub V_SetFocus(ByVal _Loai As String)
        ...
        Select Case _Loai
            ...
            Case "S"
                If DrDmct.Item("M_Ngay_CT").ToString.Trim <> "1" Then TxtNgay_Ct.Focus()
            Case "L"
                CmdPrint.Select()
        End Select
    End Sub
