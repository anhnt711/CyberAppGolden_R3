...
#Region "Khai bao bien Private"
    ...
    Dim DtPost, DtMaGD, DtMaXe As DataTable
...
#Region "Load And Set And Default"
    Private Sub V_Load()
        ...
        DetailGRV.ViewCaption = "Danh sách xe làm phiếu phân loại dịch vụ"
    End Sub
    Private Sub V_Getdefault()
        ...
        DtMaXe = CyberSmodb.OpenTableKey(AppConn, Nothing, "DMKX", "MA_KX", "1=1", CyberSmlib)
        ...
        CyberFill.V_FillComBoxValue(Me.CbbMa_KX, DtMaXe, "MA_KX", If(M_LAN = "V", "TEN_KX", "TEN_KX2"), M_Ma_Post)
        '---------------------------------------------------------------------------------------------'
        V_LoadDefault()
        '---------------------------------------------------------------------------------------------'
    End Sub
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Master()
        ...
        '------------------------------------------------------
        AddHandler TxtDt_LX.Leave, AddressOf V_DT_LX
...
#End Region
    ...
    Sub V_Ma_Xe(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Dr Is Nothing Then
            TxtE_Mail.Text = "" ' Dr.Item("E_Mail").ToString.Trim            
            TxtTen_kh.Text = "" 'Dr.Item("Ten_Kh").ToString.Trim
            TxtDia_Chi.Text = "" 'Dr.Item("Dia_Chi").ToString.Trim
            TxtTen_khVAT.Text = "" 'Dr.Item("Ten_KhVat").ToString.Trim
            TxtDia_ChiVAT.Text = "" 'Dr.Item("Dia_ChiVat").ToString.Trim
            TxtTen_Lx.Text = "" 'Dr.Item("Ten_Lx").ToString.Trim
            TxtDien_Thoai.Text = "" 'Dr.Item("Dien_Thoai").ToString.Trim
            TxtDt_LX.Text = "" 'Dr.Item("DT_LX").ToString.Trim
            Exit Sub
        End If
        TxtE_Mail.Text = Dr.Item("E_Mail").ToString.Trim
        CbbMa_KX.SelectedValue = Dr.Item("Ma_Kx").ToString.Trim
        TxtTen_kh.Text = Dr.Item("Ten_Kh").ToString.Trim
        TxtDia_Chi.Text = Dr.Item("Dia_Chi").ToString.Trim
        TxtTen_khVAT.Text = Dr.Item("Ten_KhVat").ToString.Trim
        TxtDia_ChiVAT.Text = Dr.Item("Dia_ChiVat").ToString.Trim
    ...
    Private Sub V_Dat_Lich(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim Dt_Return As DataTable = CyberWork.V_Lich_Hen(M_Ma_TTCP_H, "DLH", "M", "HEN", _Loai_SC, "", "", "", "", TxtMa_Xe.Text, "", "", _Date, _Date, AppConn, SysVar, M_LAN, Me.Para, M_Ma_Dvcs, M_User_Name, CyberSmlib, CyberSupport, CyberFill, CyberSmlistSys, CyberSmodb, CyberExport, CyberLoading)
    End Sub
#End Region
#Region "Valid - Detail"
...
#Region "Button"
    ...
    Private Function ChkVsave() As Boolean
        ...
        '    Dt_DetailTmp.Rows(iRow).Item("Ma_Xe") = TxtMa_Xe.Text.Trim
        '    Dt_DetailTmp.Rows(iRow).Item("Ma_Kx") = CbbMa_KX.SelectedValue.ToString.Trim
        '    Dt_DetailTmp.Rows(iRow).Item("Ma_GD") = CbbMa_GD.SelectedValue.ToString.Trim
        '    Dt_DetailTmp.Rows(iRow).Item("Ten_GD") = CbbMa_GD.SelectedText.ToString.Trim
        '    Dt_DetailTmp.Rows(iRow).Item("Ten_Post") = CbbMa_Post.SelectedText.ToString.Trim
        ...
        '    Dt_DetailTmp.Rows(iRow).Item("Time") = TxtGio_CT.Text
    ...
    Private Function ChkSaveDelete(ByVal _Mode As String) As Boolean
        ...
        Dim Dstmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_ChkSaveDeleteRYC", strField & "#" & strValue & "#" & _
