...
#Region "Button"
    ...
    Private Sub V_Save_Luu(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        For i As Integer = 0 To Dt_DetailTmp.Rows.Count - 1
            ...
            If Dt_DetailTmp.Columns.Contains("So_Yc") Then Dt_DetailTmp.Rows(i).Item("So_Yc") = txtSo_ct.Text.Trim
    ...
    Private Function ChkDa_Xuat(ByVal _Mode) As Boolean
        ...
        Next
        DsTmp = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_ChkPYCDaXuat", nCount.ToString.Trim & "#" & _Mode & "#" & _Dt.ToString("yyyyMMdd") & "#" & _So & "#" & strMa_vt & "#" & strMa_kho & "#" & strMa_Db & "#" & strSo_Luong & "#" & M_Stt_Rec & "#" & M_Ma_Dvcs & "#" & M_User_Name)
