...
#End Region
    Private Sub PXY_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Master()
        ...
        AddHandler TxtLenh_YC.Leave, AddressOf L_Lenh_YC
    ...
    Private Sub V_Setstatus()
        ...
        If M_Mode = "S" Then TxtLenh_YC.Enabled = False
...
#Region "Lenh/SO/Po/Ro/Vt"
    Private Sub L_Lenh_YC(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M") Then Exit Sub
        Dim _Dt As Date = TxtNgay_Ct.Value

        TxtLenh_YC.Text = CyberVoucher.V_GetSo_YC(M_Ma_CT, CbbMa_GD.SelectedValue, CbbMa_Post.SelectedValue, _Dt, TxtLenh_YC.Text, TxtMa_Dvcs.Text)
        '---------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        '---------------------------------------------------------------------------------------------------------------------------------------------------
        Dim _DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetPXYFromPYC", M_Stt_Rec.Trim & "#" & M_Ma_CT & "#" & _Dt.ToString("yyyyMMdd") & "#" & TxtLenh_YC.Text.Trim & "#" & M_Ma_Dvcs & "#" & M_User_Name)
...
#Region "Button"
    ...
    Private Function ChkDa_Xuat(ByVal _Mode) As Boolean
        ...
        For i As Integer = 0 To nCount - 1
            strSo_Yc = strSo_Yc + IIf(i = 0, "", "!~!") + Dt_DetailTmp.Rows(i).Item("So_Yc").ToString.Trim
        ...
        Next
        Dim _So_YC As String = TxtLenh_YC.Text
        DsTmp = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_ChkPXYDaXuat", nCount.ToString.Trim & "#" & _Mode & "#" & _Dt.ToString("yyyyMMdd") & "#" & _So_YC & "#" & strSo_Yc & "#" & strMa_vt & "#" & strMa_kho & "#" & strMa_Db & "#" & strSo_Luong & "#" & M_Stt_Rec & "#" & M_Ma_Dvcs & "#" & M_User_Name)
    ...
    Private Function ChkVsave() As Boolean
        ...
        For iRow = 0 To Dt_DetailTmp.Rows.Count - 1
            ...
            If Dt_DetailTmp.Columns.Contains("So_YC") Then Dt_DetailTmp.Rows(iRow).Item("So_YC") = TxtLenh_YC.Text.Trim
