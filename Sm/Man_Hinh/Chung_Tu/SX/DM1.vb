...
#Region "Columns Edit"
    ...
    '--MANHBH
    Dim Edit2Ma_CD_I, Edit2Ten_CD_I As New Cyber.Fill.CyberColumnGridView
    Dim Edit2So_Luong, Edit2Gia_NT, Edit2Gia, Edit2Tien_NT, Edit2Tien As New Cyber.Fill.CyberColumnGridView
    Dim Edit2Ma_Vv_I, Edit2Ma_phi_i, Edit2Ma_HD_I, Edit2Ma_Sp_I, Edit2Ma_ku_I, Edit2Ma_TTLN_i, Edit2Ma_TTCP_i, Edit2Ma_BP_I, Edit2Ma_HS_I, Edit2Ma_TD1_I, Edit2Ma_TD2_I, Edit2Ma_TD3_I, Edit2Ma_TD4_I, Edit2Ma_TD5_I As New Cyber.Fill.CyberColumnGridView 'Cyber.SmLists.EditLookUp
#End Region
#Region "Khai bao bien Private"
    ...
    Dim Dt_Detail2, Dt_DetailTmp2 As DataTable
    Dim Dv_Detail2, Dv_DetailTmp2 As DataView

#End Region
    Private Sub DM1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#Region "Load And Set And Default"
    Private Sub V_Load()
        ...
        CyberFill.V_FillVoucher(DetailGRV2, M_LAN, New DataView(M_DsHead.Tables(M_DsHead.Tables.Count - 1)), Dv_DetailTmp2, Me.DrDmct)
    ...
    Private Sub V_GetColumn()
        ...
        '-- DetailGRV2
        Edit2Ma_CD_I.GetColumn(DetailGRV2, "Ma_CD_I")
        Edit2Ten_CD_I.GetColumn(DetailGRV2, "Ten_CD_I")

        Edit2So_Luong.GetColumn(DetailGRV2, "So_Luong")
        Edit2Gia_NT.GetColumn(DetailGRV2, "Gia_NT")
        Edit2Gia.GetColumn(DetailGRV2, "Gia")
        Edit2Tien_NT.GetColumn(DetailGRV2, "TIEN_NT")
        Edit2Tien.GetColumn(DetailGRV2, "TIEN")

        Edit2Ma_TD1_I.GetColumn(DetailGRV2, "Ma_TD1_I")
        Edit2Ma_TD2_I.GetColumn(DetailGRV2, "Ma_TD2_I")
        Edit2Ma_TD3_I.GetColumn(DetailGRV2, "Ma_TD3_I")
        Edit2Ma_TD4_I.GetColumn(DetailGRV2, "Ma_TD4_I")
        Edit2Ma_TD5_I.GetColumn(DetailGRV2, "Ma_TD5_I")

        Edit2Ma_Vv_I.GetColumn(DetailGRV2, "Ma_Vv_I")
        Edit2Ma_phi_i.GetColumn(DetailGRV2, "Ma_Phi_I")
        Edit2Ma_HD_I.GetColumn(DetailGRV2, "Ma_HD_I")
        Edit2Ma_Sp_I.GetColumn(DetailGRV2, "Ma_SP_I")
        Edit2Ma_ku_I.GetColumn(DetailGRV2, "Ma_KU_I")
        Edit2Ma_TTLN_i.GetColumn(DetailGRV2, "Ma_TTLN_I")
        Edit2Ma_TTCP_i.GetColumn(DetailGRV2, "Ma_TTCP_I")
        Edit2Ma_BP_I.GetColumn(DetailGRV2, "Ma_BP_I")
        Edit2Ma_HS_I.GetColumn(DetailGRV2, "Ma_Hs_I")
    End Sub
    Private Sub V_SetFocus(ByVal _Loai As String)
        _Loai = _Loai.Trim.ToUpper
        Select Case _Loai
            Case "M"
                If DrDmct.Item("M_Ngay_CT").ToString.Trim <> "1" Then TxtNgay_Ct.Focus() Else TxtMa_Sp_H.Focus()
            Case "S"
                If DrDmct.Item("M_Ngay_CT").ToString.Trim <> "1" Then TxtNgay_Ct.Focus() Else TxtSL_SP.Focus()
            Case "L"
                CmdPrint.Select()
        End Select
    End Sub
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_System()
        ...
        '--- MANHBH
        AddHandler DetailGRV2.PopupMenuShowing, AddressOf MasterGRV2_PopupMenuShowing
        AddHandler DetailGRV2.KeyDown, AddressOf MasterGRV2_KeyDown
    End Sub
    ...
    Private Sub V_AddHandler_Master()
        ...
        '--MANHBH: SP
        AddHandler TxtMa_Sp_H.CyberValiting, AddressOf V_Ma_SP
        AddHandler TxtMa_Sp_H.CyberLeave, AddressOf L_Ma_SP
    End Sub
    Private Sub V_AddHandler_Detail()
        ...
        '--
        Edit2Ma_Vv_I.V_ActiLookUpColumn(AddressOf V_Ma_Vv_i2, AddressOf L_Ma_Vv_i2)
        Edit2Ma_phi_i.V_ActiLookUpColumn(AddressOf V_Ma_Phi_i2, AddressOf L_Ma_Phi_i2)
        Edit2Ma_HD_I.V_ActiLookUpColumn(AddressOf V_Ma_HD_i2, AddressOf L_Ma_HD_i2)
        Edit2Ma_Sp_I.V_ActiLookUpColumn(AddressOf V_Ma_SP_i2, AddressOf L_Ma_SP_i2)
        Edit2Ma_ku_I.V_ActiLookUpColumn(AddressOf V_Ma_KU_i2, AddressOf L_Ma_KU_i2)
        Edit2Ma_TTLN_i.V_ActiLookUpColumn(AddressOf V_Ma_TTLN_i2, AddressOf L_Ma_TTLN_i2)
        Edit2Ma_TTCP_i.V_ActiLookUpColumn(AddressOf V_Ma_TTCP_i2, AddressOf L_Ma_TTCP_i2)
        Edit2Ma_BP_I.V_ActiLookUpColumn(AddressOf V_Ma_Bp_i2, AddressOf L_Ma_Bp_i2)
        Edit2Ma_HS_I.V_ActiLookUpColumn(AddressOf V_Ma_HS_i2, AddressOf L_Ma_HS_i2)
        Edit2Ma_CD_I.V_ActiLookUpColumn(AddressOf V_Ma_CD_i2, AddressOf L_Ma_CD_i2)
        Edit2Ma_TD1_I.V_ActiLookUpColumn(AddressOf V_Ma_TD1_i2, AddressOf L_Ma_TD1_i2)
        Edit2Ma_TD2_I.V_ActiLookUpColumn(AddressOf V_Ma_TD2_i2, AddressOf L_Ma_TD2_i2)
        Edit2Ma_TD3_I.V_ActiLookUpColumn(AddressOf V_Ma_TD3_i2, AddressOf L_Ma_TD3_i2)
        Edit2Ma_TD4_I.V_ActiLookUpColumn(AddressOf V_Ma_TD4_i2, AddressOf L_Ma_TD4_i2)
        Edit2Ma_TD5_I.V_ActiLookUpColumn(AddressOf V_Ma_TD5_i2, AddressOf L_Ma_TD5_i2)
        ...
        AddHandler DetailGRV2.RowCellStyle, AddressOf DetailGRV2_RowCellStyle
    End Sub
    ...
    End Sub
    Private Sub DetailGRV2_RowCellStyle(ByVal sender As System.Object, ByVal e As DevExpress.XtraGrid.Views.Grid.RowCellStyleEventArgs)
        CyberSupport.DetailGRV_RowCellStyle2(sender, e, DetailGRV2, Dt_DetailTmp2, Me.Font, "Bold", "BackColor", "BackColor2", "Forecolor", "Underline", "Italic", CyberColor)
    End Sub
    ...
    Private Sub VisibleColumnMa_NT()
        If TxtMa_NT.Text.Trim = "" Or TxtMa_NT.Text.Trim.ToUpper = osysvar("M_Ma_NT0").ToString.Trim.ToUpper Then
            ...
            '--
            Edit2Tien.Visible = False
            Edit2Gia.Visible = False
        Else
            EditTien.Visible = True
            EditGia.Visible = True
            TxtT_Tien.Visible = True
            '--
            Edit2Tien.Visible = True
            Edit2Gia.Visible = True
        End If
    ...
    Protected Overrides Sub V_Databing()
        ...
        '--Detail2
        Dt_DetailTmp2.Clear()
        Dt_DetailTmp2.AcceptChanges()

        For i = 0 To Dt_Detail2.Select("Stt_Rec ='" + M_Stt_Rec.Trim + "'").Length - 1
            Dt_DetailTmp2.ImportRow(Dt_Detail2.Select("Stt_Rec ='" + M_Stt_Rec.Trim + "'")(i))
        Next
    ...
    Private Sub V_Setstatus()
        If (M_Mode = "M" Or M_Mode = "S") Then
            ...
            DetailGRV2.OptionsBehavior.Editable = True
        ...
        Else
            ...
            DetailGRV2.OptionsBehavior.Editable = False
        End If
...
#Region "Valid --- Ma_SP"
    Private Sub V_Ma_SP(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        TxtMa_Sp_H.V_LookUp(M_LAN, M_Para, osysvar, AppConn, DsLookup, "Ma_VT", "DmVT", "1=1", "1=1")
    End Sub
    Private Sub L_Ma_SP(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If TxtMa_Sp_H.Text = "" Then
            TxtTen_SP_H.Text = ""
            Exit Sub
        End If
        DrReturn = TxtMa_Sp_H.GetRowsSelectData(True)
        If Not DrReturn Is Nothing Then
            TxtMa_Sp_H.Text = DrReturn.Item("Ma_VT")
            TxtTen_SP_H.Text = DrReturn.Item("Ten_VT")
...
#Region "Valid - Detail - Core"
    ...
    Private Sub V_Tinh_Toan(ByVal iRow As Integer)
        ...
        If nTy_Gia = 1 Then
            ...
            'Dv_DetailTmp.Item(iRow).Item("Gia3") = Dv_DetailTmp.Item(iRow).Item("Gia_NT3")
        Else
            ...
            'Dv_DetailTmp.Item(iRow).Item("Gia3") = CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("Gia_NT3") * nTy_Gia, M_R_GIA)
        End If
        Dv_DetailTmp.Item(iRow).EndEdit()
    ...
    Private Sub L_Tinh_Toan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        V_Tinh_Toan(iRow)
    End Sub
    Private Sub V_Tinh_Toan_Detail2()
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim iRow As Integer = -1
        DetailGRV2.PostEditor()
        For iRow = 0 To Dv_DetailTmp2.Count - 1
            ...
            Else
                Dv_DetailTmp2.Item(iRow).Item("Tien") = CyberSupport.V_Round(Dv_DetailTmp2.Item(iRow).Item("Tien_NT") * nTy_Gia, M_R_TIEN)
            End If
...
#Region "Valid - Detail - Add On"
    ...
    End Sub
    '-- MANHBH
    Private Sub V_Ma_Vv_i2(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        CyberSupport.V_Ma_Vv_i(M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_Vv_i2(ByVal sender As System.Object, ByVal e As System.EventArgs)
        CyberSupport.L_Ma_Vv_i(M_Mode, M_Ma_CT, sender, DetailGRV2)
    End Sub
    Private Sub V_Ma_Phi_i2(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        CyberSupport.V_Ma_Phi_i(M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
        'CyberSupport.V_Lookup("Ma_Phi", "DMPhi", "1=1", "1=1", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_Phi_i2(ByVal sender As System.Object, ByVal e As System.EventArgs)
        CyberSupport.L_Ma_Phi_i(M_Mode, M_Ma_CT, sender, DetailGRV2)
        'Dim Dr As DataRow
        'Dr = CyberSupport.L_Lookup(M_Mode, M_Ma_CT, sender, True)
        'Dim iRow As Integer = -1
        'If DrReturn Is Nothing Then
        ...
        '    Dv_DetailTmp2.Item(iRow).BeginEdit()
        '    Dv_DetailTmp2.Item(iRow).Item("Ma_Phi_I") = Dr("Ma_Phi").ToString.Trim
        '    Dv_DetailTmp2.Item(iRow).EndEdit()
        'End If

    End Sub
    Private Sub V_Ma_HD_i2(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        CyberSupport.V_Ma_Hd_i(M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_HD_i2(ByVal sender As System.Object, ByVal e As System.EventArgs)
        CyberSupport.L_Ma_Hd_i(M_Mode, M_Ma_CT, sender, DetailGRV2)
    End Sub
    Private Sub V_Ma_SP_i2(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        CyberSupport.V_Ma_Sp_i(M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_SP_i2(ByVal sender As System.Object, ByVal e As System.EventArgs)
        CyberSupport.L_Ma_Sp_i(M_Mode, M_Ma_CT, sender, DetailGRV2)
    End Sub
    Private Sub V_Ma_KU_i2(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        CyberSupport.V_Ma_Ku_i(M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_KU_i2(ByVal sender As System.Object, ByVal e As System.EventArgs)
        CyberSupport.L_Ma_Ku_i(M_Mode, M_Ma_CT, sender, DetailGRV2)
    End Sub
    Private Sub V_Ma_TTLN_i2(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        CyberSupport.V_Ma_TTLN_i(M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_TTLN_i2(ByVal sender As System.Object, ByVal e As System.EventArgs)
        CyberSupport.L_Ma_TTLN_i(M_Mode, M_Ma_CT, sender, DetailGRV2)
    End Sub
    Private Sub V_Ma_TTCP_i2(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        CyberSupport.V_Ma_TTCP_i(M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_TTCP_i2(ByVal sender As System.Object, ByVal e As System.EventArgs)
        CyberSupport.L_Ma_TTCP_i(M_Mode, M_Ma_CT, sender, DetailGRV2)
    End Sub
    Private Sub V_Ma_Bp_i2(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        CyberSupport.V_Ma_Bp_i(M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_Bp_i2(ByVal sender As System.Object, ByVal e As System.EventArgs)
        CyberSupport.L_Ma_Bp_i(M_Mode, M_Ma_CT, sender, DetailGRV2)
    End Sub
    Private Sub V_Ma_HS_i2(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        CyberSupport.V_Ma_Hs_i(M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_HS_i2(ByVal sender As System.Object, ByVal e As System.EventArgs)
        CyberSupport.L_Ma_Hs_i(M_Mode, M_Ma_CT, sender, DetailGRV2)
    End Sub
    Private Sub V_Ma_CD_i2(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        CyberSupport.V_Ma_Cd_i(M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_CD_i2(ByVal sender As System.Object, ByVal e As System.EventArgs)
        CyberSupport.L_Ma_Cd_i(M_Mode, M_Ma_CT, sender, DetailGRV2)
    End Sub
    Private Sub V_Ma_TD1_i2(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        CyberSupport.V_Ma_Td1_i(M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_TD1_i2(ByVal sender As System.Object, ByVal e As System.EventArgs)
        CyberSupport.L_Ma_Td1_i(M_Mode, M_Ma_CT, sender, DetailGRV2)
    End Sub
    Private Sub V_Ma_TD2_i2(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        CyberSupport.V_Ma_TD2_i(M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_TD2_i2(ByVal sender As System.Object, ByVal e As System.EventArgs)
        CyberSupport.L_Ma_TD2_i(M_Mode, M_Ma_CT, sender, DetailGRV2)
    End Sub
    Private Sub V_Ma_TD3_i2(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        CyberSupport.V_Ma_TD3_i(M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_TD3_i2(ByVal sender As System.Object, ByVal e As System.EventArgs)
        CyberSupport.L_Ma_TD3_i(M_Mode, M_Ma_CT, sender, DetailGRV2)
    End Sub
    Private Sub V_Ma_TD4_i2(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        CyberSupport.V_Ma_TD4_i(M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_TD4_i2(ByVal sender As System.Object, ByVal e As System.EventArgs)
        CyberSupport.L_Ma_TD4_i(M_Mode, M_Ma_CT, sender, DetailGRV2)
    End Sub
    Private Sub V_Ma_TD5_i2(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        CyberSupport.V_Ma_TD5_i(M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_TD5_i2(ByVal sender As System.Object, ByVal e As System.EventArgs)
        CyberSupport.L_Ma_TD5_i(M_Mode, M_Ma_CT, sender, DetailGRV2)
    End Sub
#End Region
#End Region
...
#Region "Mainform"
    Private Sub V_MainSystem()
        ...
        Me.Detail.ContextMenu = mnItemsMail

        '--
        Dim mnItems2Mail = New ContextMenu

        Dim mnItems2F4 As New MenuItem(If(M_LAN = "V", "Thêm dòng", "New row"), AddressOf V_ShortAddItem2, Keys.F4)
        Dim mnItems2F8 As New MenuItem(If(M_LAN = "V", "Xóa dòng", "Delete row"), AddressOf V_ShortDeleteItem2, Keys.F8)

        Dim mnItems2Save As New MenuItem(If(M_LAN = "V", "Lưu chứng từ", "Save"), AddressOf V_ShortSAVE, Keys.Control + Keys.Enter)
        Dim mnItems2Print As New MenuItem(If(M_LAN = "V", "In chứng từ", "Print"), AddressOf V_ShortPrint, Keys.Control + Keys.P)

        mnItems2Mail.MenuItems.Add(mnItems2F4)
        mnItems2Mail.MenuItems.Add(mnItems2F8)

        mnItems2Mail.MenuItems.Add(mnItems2Save)
        mnItems2Mail.MenuItems.Add(mnItems2Print)
        Me.Detail2.ContextMenu = mnItems2Mail
    End Sub
    ...
    End Sub
    '-- MANHBH
    Private Sub MasterGRV2_PopupMenuShowing(ByVal sender As System.Object, ByVal e As DevExpress.XtraGrid.Views.Grid.PopupMenuShowingEventArgs)
        Dim rowHandle As Integer = e.HitInfo.RowHandle
        If e.MenuType <> DevExpress.XtraGrid.Views.Grid.GridMenuType.Column Then
            PopupMenuMasterGrid.ItemLinks.Clear()
    ...
    Private Sub V_ShortAddItem2(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        DetailGRV2.Focus()
        DetailGRV2.FocusedRowHandle = iRow
    End Sub
...
#Region "Button"
    Private Sub V_Save(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Not CyberSmodb.V_SysCheckSaveVoucher(AppConn, osysvar, {Dt_DetailTmp, CyberSmodb.V_ConvertDrToTb(drMaster), Dt_DetailTmp2}, {M_Ct, M_Ph, "CTDM2"}, M_Mode, CbbMa_Post.SelectedValue.ToString.Trim, CbbMa_GD.SelectedValue, M_Ma_CT, M_Stt_Rec, M_LAN, TxtMa_Dvcs.Text, M_User_Name, CyberSmlib, CyberSupport, DsSave) Then
    ...
    Private Function ChkVsave() As Boolean
        ...
        For iRow = 0 To Dt_DetailTmp.Rows.Count - 1
            ...
            If Dt_DetailTmp.Columns.Contains("Ma_SP_I") Then If TxtMa_Sp_H.Text.Trim <> "" Then Dt_DetailTmp.Rows(iRow).Item("Ma_SP_I") = TxtMa_Sp_H.Text.Trim
        Next
        Dt_DetailTmp.AcceptChanges()

        '-- MANHBH: Check Detail2
        nCount = Dt_DetailTmp2.Rows.Count
        For iRow = nCount - 1 To 0 Step -1
            If Dt_DetailTmp2.Rows(iRow).Item("Ma_CD_I").ToString.Trim = "" Then
                Dt_DetailTmp2.Rows(iRow).Delete()
                Dt_DetailTmp2.AcceptChanges()
            End If
        Next
        '---------------------------------------------------------------------------------
        V_Tinh_Toan_Detail2()
        For iRow = 0 To Dt_DetailTmp2.Rows.Count - 1
            Dt_DetailTmp2.Rows(iRow).Item("Stt_Rec") = M_Stt_Rec
            Dt_DetailTmp2.Rows(iRow).Item("Ma_Ct") = M_Ma_CT
            Dt_DetailTmp2.Rows(iRow).Item("Ngay_Ct") = TxtNgay_Ct.Value
            Dt_DetailTmp2.Rows(iRow).Item("So_Ct") = CyberSupport.V_soct(txtSo_ct.Text.Trim)
            Dt_DetailTmp2.Rows(iRow).Item("Stt_Rec0") = CyberSupport.GetStt_Rec0(iRow + 1)
            If Dt_DetailTmp2.Columns.Contains("Ma_SP_I") Then If TxtMa_Sp_H.Text.Trim <> "" Then Dt_DetailTmp2.Rows(iRow).Item("Ma_SP_I") = TxtMa_Sp_H.Text.Trim
        Next
        Dt_DetailTmp2.AcceptChanges()
    ...
    Private Function Add2Database() As Boolean
        ...
        '-----------------------------------------------------------------------------------------------------
        '---Xoa trong Detail2
        If M_Mode.Trim = "S" Then CyberSmodb.DeleteDatatable(Dt_Detail2, "Stt_Rec = '" + M_Stt_Rec + "'")
        '+Import To Detail 2
        For i As Integer = 0 To Dt_DetailTmp2.Rows.Count - 1
            Dt_Detail2.ImportRow(Dt_DetailTmp2.Rows(i))
        Next

        Return CyberSmodb.V_Add2Database(AppConn, osysvar, {Dt_DetailTmp, CyberSmodb.V_ConvertDrToTb(drMaster), Dt_DetailTmp2}, {M_Ct, M_Ph, "CTDM2"}, M_Mode, CbbMa_Post.SelectedValue.ToString.Trim, M_Ma_CT, M_Stt_Rec, M_LAN, TxtMa_Dvcs.Text, M_User_Name, CyberSmlib, CyberSupport)
        ...
        'If M_Ct.Trim <> "" Then CyberSmodb.V_CyberSaveToSQL(AppConn, osysvar, M_User_Name, Dt_DetailTmp2, "CTDM2", M_Mode, "Stt_Rec =N'" + M_Stt_Rec + "'")
        ''-----------------------------------------------------------------------------------------------------
        ''---Save: Post
    ...
    Private Sub V_New()
        ...
        If Dt_DetailTmp2.Rows.Count < 1 Then
            Dim DrCurren2 As DataRow
            Dt_DetailTmp2.NewRow()
            DrCurren2 = Dt_DetailTmp2.NewRow
            CyberSmodb.SetValueBlankRow(DrCurren2)
            ...
            DrCurren2.Item("Stt_Rec") = M_Stt_Rec.Trim
            DrCurren2.Item("Ma_Ct") = M_Ma_CT.Trim
            DrCurren2.Item("Ngay_Ct") = TxtNgay_Ct.Value
            DrCurren2.Item("Stt_Rec0") = "0001"

            Dt_DetailTmp2.Rows.Add(DrCurren2)
            Dt_DetailTmp2.AcceptChanges()
        End If
    End Sub
    ...
    Private Sub V_Delete(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        CyberSupport.V_DeleteTableVoucher(Dt_Detail2, M_Stt_Rec)
...
#Region "Add Or Detete Item"
    ...
    End Sub
    Private Sub MasterGRV2_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim iCoumnVisible As Integer = DetailGRV2.VisibleColumns.Count - 1
        Dim iRowVisible As Integer = DetailGRV2.RowCount - 1
        Dim iRowRowFocus As Integer = DetailGRV2.FocusedRowHandle
        Dim iColumnRowFocus As Integer = DetailGRV2.VisibleColumns.IndexOf(DetailGRV2.FocusedColumn)
        Dim iRowOld As Integer = DetailGRV2.GetFocusedDataSourceRowIndex
        'If e.KeyCode = Keys.Enter And iRowVisible = iRowRowFocus And iCoumnVisible = iColumnRowFocus Then V_AddItem(iRowOld) '' Cot cuoi cung them dong
        If iRowVisible <> iRowRowFocus Or iCoumnVisible <> iColumnRowFocus Then Exit Sub
    ...
    Private Sub V_AddItem2(Optional ByVal iRow As Integer = -1)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim DrvOld As DataRowView
        If iRow > 0 Then DrvOld = Dv_DetailTmp2.Item(iRow) Else DrvOld = Nothing
        Dv_DetailTmp2.Table.Rows.Add()
        CyberSmodb.SetValueBlankRow(Dv_DetailTmp2.Table.Rows(Dv_DetailTmp2.Table.Rows.Count - 1))
        CyberSupport.SetCarryOn(DrvOld, Dv_DetailTmp2.Table.Rows(Dv_DetailTmp2.Table.Rows.Count - 1), New DataView(M_DsHead.Tables(M_DsHead.Tables.Count - 1)))
        CarrOn(Dv_DetailTmp2.Table.Rows(Dv_DetailTmp2.Table.Rows.Count - 1))
        UpdateList()
        iRow = Dv_DetailTmp2.Count - 1
...
#Region "Sms - Import"
    ...
    Private Sub SetTxt()
        ...
        TxtT_Ps.Visible = False
        TxtT_Ps_NT.Visible = False
        TxtT_Tien_NT2.Visible = False
        TxtT_Tien2.Visible = False
        TxtT_Tien_NT3.Visible = False
        TxtT_Tien3.Visible = False
    End Sub
#End Region
