...
#End Region
#Region "Columns Edit"
    Dim EditMa_lo, EditTk_Cc, EditMa_Nx_I, EditTk_CP, EditMa_kh_I As New Cyber.Fill.CyberColumnGridView 'Cyber.SmLists.EditLookUp
    ...
    Dim EditTen_Cc, EditTen_Nx_I, EditTen_Tk_Cc, EditTen_Tk_CP, EditTen_kho_i, EditDvt, EditSo_Luong, EditSo_ky_pb, EditGt_Pb_Ky, EditGt_Pb_KyNT, EditGia_NT, EditGia, EditTien_NT, EditTien, EditDien_Giaii, EditSo_So, EditSo_Po, EditSo_Ro, EditSo_VT As New Cyber.Fill.CyberColumnGridView 'DevExpress.XtraEditors.Repository.RepositoryItemTextEdit
#End Region
...
#End Region
    Private Sub PXI_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#Region "Vat tu kho/Vitri - "
    ...
    Private Sub L_Ma_Cc(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        'Dim _Ma_Cc As String = DrReturn.Item("Ma_Cc")

        iRow = DetailGRV.GetFocusedDataSourceRowIndex
        If iRow < 0 Then Exit Sub
        Dim _Tk_Cc As String = DrReturn.Item("Tk_Cc")
        Dim _TK_Cp As String = DrReturn.Item("TK_CP")
        Dim _TK_TT As String = DrReturn.Item("TK_TT")
        Dim _ma_Nx_I As String = _TK_TT
        ...
        Dv_DetailTmp.Item(iRow).Item("TK_CP") = IIf(Dv_DetailTmp.Item(iRow).Item("TK_CP").ToString.Trim = "", _TK_Cp, Dv_DetailTmp.Item(iRow).Item("TK_CP").ToString.Trim)
