...
#Region "Tai khoan No/Co"
    ...
    Private Sub L_Tk_No(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Dv_DetailTmp.Item(iRow).Item("Tk_Co").ToString.Trim = "" Then
            ...
            Dv_DetailTmp.Table.AcceptChanges()
        End If
        CyberSupport.V_SetSD(StatusFooter1, AppConn, "KT", M_Mode, Dv_DetailTmp.Item(iRow).Item("Tk_No"), Dv_DetailTmp.Item(iRow).Item("Ma_KH_N"), "", "", M_Stt_Rec, M_Ma_CT, M_Ma_Dvcs, M_User_Name, CyberSmlib)
    End Sub
    ...
    Private Sub L_Tk_Co(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Dv_DetailTmp.Item(iRow).Item("Tk_No").ToString.Trim = "" Then
            ...
            Dv_DetailTmp.Table.AcceptChanges()
        End If
        CyberSupport.V_SetSD(StatusFooter1, AppConn, "KT", M_Mode, Dv_DetailTmp.Item(iRow).Item("Tk_Co"), Dv_DetailTmp.Item(iRow).Item("Ma_KH_C"), "", "", M_Stt_Rec, M_Ma_CT, M_Ma_Dvcs, M_User_Name, CyberSmlib)
    End Sub
#End Region
