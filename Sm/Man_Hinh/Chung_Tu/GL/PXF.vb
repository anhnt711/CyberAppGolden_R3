...
#Region "Columns Edit"
    ...
    Dim EditTen_Vt, EditDvt, EditTen_Tk_VT, EditTen_kho_i, EditSo_Luong, EditGia, EditGia_NT, EditTien, EditTien_NT, EditDien_Giaii, EditSo_So, EditSo_Po, EditSo_Ro, EditSo_VT As New Cyber.Fill.CyberColumnGridView 'DevExpress.XtraEditors.Repository.RepositoryItemTextEdit
#End Region
...
#End Region
    Private Sub PXF_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#Region "Valid - Detail - Core"
    ...
    Private Sub V_Tinh_Tien()
        ...
        Dim nT_Thue_Nt As Decimal = TxtT_thue_NT.Double
        Dim nT_Thue As Decimal = TxtT_Thue.Double
        If nTy_Gia = 1 Then nT_Thue = nT_Thue_Nt
        If nTy_Gia = 1 Then nT_Tien = nT_Tien_Nt

        If ChkSua_Thue.Checked Then '--- Sua Thue
            If Not ChkE_Thue.Checked Then
                If nTy_Gia = 1 Then nT_Thue = nT_Thue_Nt Else nT_Thue = CyberSupport.V_Round(nT_Thue_Nt * nTy_Gia, M_R_TIEN)
            End If
        Else
            nT_Thue_Nt = CyberSupport.V_Round(nT_Tien_Nt * nThue_Suat / 100, M_R_TIEN)
            If nTy_Gia = 1 Then nT_Thue = nT_Thue_Nt Else nT_Thue = CyberSupport.V_Round(nT_Thue_Nt * nTy_Gia, M_R_TIEN)
        End If
...
#Region "Vat tu kho/Vitri - "
    ...
    Private Sub V_SetPriceSales(ByVal iRow As Integer)
        ...
        'If DsgetPrice.Tables(0).Rows.Count <= 0 Then Exit Sub
