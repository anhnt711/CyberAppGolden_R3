...
#Region "Columns Edit"
    Dim EditMa_lo, EditTk_VT, EditMa_Nx_I As New Cyber.Fill.CyberColumnGridView 'Cyber.SmLists.EditLookUp
    ...
    Dim EditSo_Luong, EditGia_NT0, EditGia0, EditGia_NT, EditTien_NT0, EditTien0, EditCP_NT, EditCP, EditGia, EditTien_NT, EditTien, EditDien_Giaii, EditSo_So, EditSo_Po, EditSo_Ro, EditSo_VT As New Cyber.Fill.CyberColumnGridView 'DevExpress.XtraEditors.Repository.RepositoryItemTextEdit
    Dim EditTen_Vt, EditDvt, EditTen_kho_i, EditTen_Tk_VT, EditTen_Nx_i As New Cyber.Fill.CyberColumnGridView 'Cyber.SmLists.EditLookUp
#End Region
...
#End Region
    Private Sub PNG_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#Region "Valid - Detail - Core"
    ...
    Private Sub V_Tinh_Tien()
        ...
        Else
            nT_Thue_Nt = 0
            nT_Thue = 0
            For i = 0 To Dt_DetailVaTTmp.Rows.Count - 1
