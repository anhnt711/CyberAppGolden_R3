...
#End Region
#Region "Columns Edit"
    Dim EditMa_lo, EditTk_CC, EditTk_DT, EditTK_CP, EditTk_CK As New Cyber.Fill.CyberColumnGridView 'Cyber.SmLists.EditLookUp
    ...
    Dim EditTen_Vt, EditDvt, EditTen_kho_i, EditTen_Tk_CC, EditTen_Tk_DT, EditTen_Tk_CK, EditTen_TK_CP, EditTien As New Cyber.Fill.CyberColumnGridView 'Cyber.SmLists.EditLookUp
#End Region
...
#End Region
    Private Sub HDT_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#Region "Mainform"
    ...
    Private Sub V_ShortF5(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Dt_DetailTmp.Columns.Contains("Ma_CC") Then _Ma_Vt = Dv_DetailTmp.Item(iRow).Item("Ma_CC")
