...
#End Region
#Region "Columns Edit"
    Dim EditTk_No, EditTk_Co, EditTk_Thue_Co, EditMa_KH_N, EditMa_KH_C As New Cyber.Fill.CyberColumnGridView 'Cyber.SmLists.EditLookUp
    ...
    Dim EditT_Tien_NT2, EditT_Tien2, EditT_Thue_NT, EditT_Thue, EditDien_Giaii, EditSo_So, EditSo_Po, EditSo_Ro, EditSo_VT As New Cyber.Fill.CyberColumnGridView 'New DevExpress.XtraEditors.Repository.RepositoryItemTextEdit
    Dim EditTen_Tk_No, EditTen_Tk_Co, EditTen_KH_N, EditTen_KH_C As New Cyber.Fill.CyberColumnGridView
    Dim EditMau_bc, EditMa_kh, EditMa_kho, EditMa_thue, EditThue_Suat, EditTk_du As New Cyber.Fill.CyberColumnGridView
...
#End Region
    Private Sub T02_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#Region "Load And Set And Default"
    Private Sub V_Load()
        ...
        'Dt_DetailVat = M_DsData.Tables(1)
    ...
    Private Sub V_GetColumn()
        ...
        EditTk_Thue_Co.GetColumn(DetailGRV, "Tk_Thue_Co")
        ...
        EditT_Tien_NT2.GetColumn(DetailGRV, "T_Tien_NT2")
        EditT_Tien2.GetColumn(DetailGRV, "T_TIEN2")
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Detail()
        ...
        If Not EditT_Tien_NT2.Column Is Nothing Then AddHandler EditT_Tien_NT2.EditColumn.Leave, AddressOf L_Tinh_Toan
        If Not EditT_Tien2.Column Is Nothing Then AddHandler EditT_Tien2.EditColumn.Leave, AddressOf L_Tinh_Toan
        ...
        EditTk_Thue_Co.V_ActiLookUpColumn(AddressOf V_Tk_Thue_Co, AddressOf L_Tk_Thue_Co)
        '--
    ...
    Private Sub VisibleColumnMa_NT()
        If TxtMa_NT.Text.Trim = "" Or TxtMa_NT.Text.Trim.ToUpper = osysvar("M_Ma_NT0").ToString.Trim.ToUpper Then
            ...
            If Not EditT_Tien2 Is Nothing Then EditT_Tien2.Visible = False
...
#Region "VAT"
    ...
    Private Sub V_AddVat(ByRef _DtVat As DataTable, ByVal _Ma_Post As String, ByVal _Ngay_Ct As Date, ByVal _Ngay_LCt As Date, ByVal _Ma_NT As String, ByVal _Ty_GIa As Decimal)
        ...
        Dim _T_Tien_NT2 As Decimal = TxtT_Tien_NT2.Double
        Dim _T_Tien As Decimal = TxtT_Tien2.Double
        ...
        For iRow As Integer = 0 To nCountSo_Detail - 1
            ...
            _T_Tien_NT2 = Dt_DetailTmp.Rows(iRow).Item("T_Tien_NT2")
            ...
            _DrVat.Item("T_Tien_NT2") = _T_Tien_NT2
            _DrVat.Item("T_Tien") = _T_Tien
            _DrVat.Item("T_TT_NT") = _T_Tien_NT2
...
#Region "Valid - Detail - Core"
    Private Sub UpdateList()
        ...
        For iRow = 0 To Dv_DetailTmp.Count - 1
            nT_Tien_NT2 = nT_Tien_NT2 + Dv_DetailTmp.Item(iRow).Item("T_Tien_NT2")
            nT_Tien2 = nT_Tien2 + Dv_DetailTmp.Item(iRow).Item("T_Tien2")
    ...
    Private Sub V_Tinh_Toan(ByVal iRow As Integer)
        ...
        If Dv_DetailTmp.Item(iRow).Item("T_Thue_nt") = 0 Then
            ...
            Dv_DetailTmp.Item(iRow).Item("T_Thue_nt") = CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("T_Tien_NT2") * Dv_DetailTmp.Item(iRow).Item("Thue_Suat") / 100, M_R_TIEN_NT)
            Dv_DetailTmp.Item(iRow).EndEdit()
        End If

        Dv_DetailTmp.Item(iRow).BeginEdit()
        If nTy_Gia <> 1 Then
            Dv_DetailTmp.Item(iRow).Item("T_Tien2") = CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("T_Tien_NT2") * nTy_Gia, M_R_TIEN)
            Dv_DetailTmp.Item(iRow).Item("T_Thue") = CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("T_Thue_NT") * nTy_Gia, M_R_TIEN)
        Else
            Dv_DetailTmp.Item(iRow).Item("T_Tien2") = Dv_DetailTmp.Item(iRow).Item("T_Tien_NT2")
...
#Region "Mau_bc , Ma_kh"
    ...
    Private Sub L_Ma_thue(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Else
            ...
            Dt_DetailTmp.Rows(iRow).Item("thue_suat") = DrReturn("thue_suat" + IIf(M_LAN = "V", "", "2")).ToString.Trim
            Dt_DetailTmp.Rows(iRow).Item("Tk_Thue_Co") = DrReturn("Tk_Thue_Co").ToString.Trim
        End If
        Dt_DetailTmp.AcceptChanges()
        L_Tinh_Toan(sender, e)
        DetailGRV.UpdateCurrentRow()
    End Sub
    Private Sub V_tk_Thue_Co(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    Private Sub L_tk_Thue_Co(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If DrReturn Is Nothing Then
            Dt_DetailTmp.Rows(iRow).BeginEdit()
            Dt_DetailTmp.Rows(iRow).Item("tk_Thue_Co") = ""
            Dt_DetailTmp.Rows(iRow).EndEdit()
            Exit Sub
        Else
            Dt_DetailTmp.Rows(iRow).BeginEdit()
            Dt_DetailTmp.Rows(iRow).Item("tk_Thue_Co") = DrReturn("tk").ToString.Trim
            Dt_DetailTmp.Rows(iRow).EndEdit()
        End If
        Dt_DetailTmp.AcceptChanges()
...
#Region "Button"
    ...
    Private Sub V_Save_LUU(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        '----------------------------------------------------------------------------------------------------------------------
        'If Not CyberSupport.ChkVoucherInputVat(Me, AppConn, osysvar, M_LAN, DrDmct, IIf(Me.C.Checked, "1", "0"), M_Mode, M_Ma_CT, _Ngay_Ct, CbbMa_GD.SelectedValue, M_Stt_Rec, CbbMa_Post.SelectedValue, M_Ma_Dvcs, M_User_Name, Dt_DetailVaTTmp, "", CyberSmlib, CyberSupport, CyberSmodb, CyberLoading) Then Exit Sub
    ...
    Private Function ChkVsave() As Boolean
        ...
        For iRow = nCount - 1 To 0 Step -1
            If Dt_DetailTmp.Rows(iRow).Item("So_Seri").ToString.Trim = "" Then
        ...
        For iRow = 0 To Dt_DetailTmp.Rows.Count - 1
            If Dt_DetailTmp.Rows(iRow).Item("Tk_Thue_Co").ToString.Trim = "" Then
    ...
    Private Function Add2Database() As Boolean
        ...
        ''CyberSmodb.V_SaveToSQL(AppConn, osysvar, M_User_Name, Dt_DetailTmp, "CTGT20", M_Mode, "Stt_Rec = N'" + M_Stt_Rec + "'")
        ''-----------------------------------------------------------------------------------------------------
        ''---Save: Post
