...
#Region "Columns Edit"
    ...
    Dim EditCP_NT, EditCP, EditDien_Giaii, EditSo_So, EditSo_Po, EditSo_Ro, EditSo_VT As New Cyber.Fill.CyberColumnGridView 'DevExpress.XtraEditors.Repository.RepositoryItemTextEdit
    Dim EDitSo_Luong_Hg, Eitma_Db_I, EDitTien_Hg_NT, EDitTien_Hg, EDitSo_Pn, EDitNgay_PN, EDitTen_Vt, EDitDvt, EDitTen_kho_i, EDitTen_Tk_VT As New Cyber.Fill.CyberColumnGridView
#End Region
...
#End Region
    Private Sub PNC_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#Region "Chon phieu nhap kho"
    Private Sub V_Chon_PN(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If Not CyberVoucher.V_Loc_PN_Chiphimua(AppConn, osysvar, Me.DsLookup, M_LAN, M_Para, DrDmct, Dt_DetailTmp, M_Mode, M_Stt_Rec, M_Ma_CT, M_Ma_Dvcs, M_User_Name) Then Exit Sub
        GetSo_PN()
    End Sub
