...
#End Region
#Region "Columns Edit"
    Dim EditMa_lo, EditTk_Cc, EditTk_TT, EditTk_CP As New Cyber.Fill.CyberColumnGridView 'Cyber.SmLists.EditLookUp
...
#End Region
    Private Sub PNT_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#Region "Load And Set And Default"
    ...
    Private Sub V_GetColumn()
        ...
        EditTk_TT.GetColumn(DetailGRV, "Tk_TT")
        EditTen_Tk_TT.GetColumn(DetailGRV, "TEN_Tk_TT")

        EditTk_CP.GetColumn(DetailGRV, "Tk_CP")
        EditTen_Tk_CP.GetColumn(DetailGRV, "TEN_Tk_CP")
        ...
        EditSo_ky_pb.GetColumn(DetailGRV, "So_ky_pb")
        EditGt_Pb_Ky.GetColumn(DetailGRV, "Gt_Pb_Ky")
        EditGt_Pb_KyNT.GetColumn(DetailGRV, "Gt_Pb_KyNT")
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Detail()
        ...
        '----------------------------------------------------------------------------------------------------------
        If Not EditSo_ky_pb.Column Is Nothing Then AddHandler EditSo_ky_pb.EditColumn.Leave, AddressOf L_Tinh_Toan
        If Not EditGt_Pb_Ky.Column Is Nothing Then AddHandler EditGt_Pb_Ky.EditColumn.Leave, AddressOf L_Tinh_Toan
        If Not EditGt_Pb_KyNT.Column Is Nothing Then AddHandler EditGt_Pb_KyNT.EditColumn.Leave, AddressOf L_Tinh_Toan
        '----------------------------------------------------------------------------------------------------------
        ...
        EditTk_CP.V_ActiLookUpColumn(AddressOf V_Tk_CP, AddressOf L_Tk_CP)
        EditTk_TT.V_ActiLookUpColumn(AddressOf V_Tk_TT, AddressOf L_Tk_TT)
...
#Region "Valid - Detail - Core"
    ...
    Private Sub V_Tinh_Toan(ByVal iRow As Integer)
        ...
        'Phan Bo 
        Dv_DetailTmp.Item(iRow).BeginEdit()
        If Dv_DetailTmp.Item(iRow).Item("So_ky_Pb") <> 0 Then Dv_DetailTmp.Item(iRow).Item("Gt_Pb_ky") = CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("Tien") / Dv_DetailTmp.Item(iRow).Item("So_ky_Pb"), M_R_TIEN)
        If Dv_DetailTmp.Item(iRow).Item("So_ky_Pb") <> 0 Then Dv_DetailTmp.Item(iRow).Item("Gt_Pb_kyNT") = CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("Tien_NT") / Dv_DetailTmp.Item(iRow).Item("So_ky_Pb"), M_R_TIEN)
        Dv_DetailTmp.Item(iRow).EndEdit()
        Dv_DetailTmp.Table.AcceptChanges()

        If nTy_Gia = 1 Then
            Dv_DetailTmp.Item(iRow).BeginEdit()
            Dv_DetailTmp.Item(iRow).Item("Gt_Pb_ky") = Dv_DetailTmp.Item(iRow).Item("Gt_Pb_kyNT")
            Dv_DetailTmp.Item(iRow).EndEdit()
            Dv_DetailTmp.Table.AcceptChanges()
        Else
            Dv_DetailTmp.Item(iRow).BeginEdit()
            Dv_DetailTmp.Item(iRow).Item("Gt_Pb_ky") = CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("Gt_Pb_kyNT") * nTy_Gia, M_R_TIEN)
            Dv_DetailTmp.Item(iRow).EndEdit()
            Dv_DetailTmp.Table.AcceptChanges()
        End If
        '---------------------------------------------------------------------------------------------------------------------------------------------
...
#Region "Vat tu kho/Vitri - "
    ...
    Private Sub V_SetSD(ByVal iRow As Integer)
        ...
        Dim _Return As DataRow = CyberSupport.V_SetSD(StatusFooter1, AppConn, "VT", M_Mode, _Ma_Cc, _Ma_kho, _Ma_Vitri, _Ma_Lo, M_Stt_Rec, M_Ma_CT, M_Ma_Dvcs, M_User_Name, CyberSmlib)
...
#End Region
#Region "Tai khoan TT"
    Private Sub V_Tk_TT(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
    ...
    Private Sub L_Tk_TT(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If drvCurren("TK_TT").ToString.Trim = "" Then
            CyberSupport.V_UpdateValueField(drvCurren, "Ten_TK_TT", "")
            Exit Sub
        End If
        Dim DrReturn As DataRow = sender.GetRowsSelectData(True)
        If Not DrReturn Is Nothing Then
            drvCurren("TK_TT") = DrReturn("TK")
            CyberSupport.V_UpdateValueField(drvCurren, "Ten_TK_TT", DrReturn("Ten_TK"))
        Else
            drvCurren("TK_TT") = ""
            CyberSupport.V_UpdateValueField(drvCurren, "Ten_TK_TT", "")
        End If
    End Sub
    'Private Sub V_Tk_TT(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    '    CyberSupport.V_Tk_TT(M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    'End Sub
    'Private Sub L_Tk_TT(ByVal sender As System.Object, ByVal e As System.EventArgs)
    '    CyberSupport.L_Tk_TT(M_Mode, M_Ma_CT, sender, DetailGRV)
    'End Sub
#End Region
#Region "Tai khoan CP"
    Private Sub V_Tk_CP(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        CyberSupport.V_Tk_CP(M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Tk_CP(ByVal sender As System.Object, ByVal e As System.EventArgs)
        CyberSupport.L_Tk_CP(M_Mode, M_Ma_CT, sender, DetailGRV)
    End Sub
#End Region
...
#Region "Button"
    ...
    Private Sub V_New()
        If Dt_DetailTmp.Rows.Count < 1 Then
            ...
            DrCurren.Item("Ngay_PB") = TxtNgay_Ct.Value
