...
#End Region
    Private Sub PN7_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#Region "Lenh/SO/Po/Ro/Vt"
    ...
    Private Sub L_Lenh_Po(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Not TxtLenh_PO.Text = "" Then L_GetPN7FromPDX()
    End Sub
    Private Sub L_GetPN7FromPDX()
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim _Lenh_PO As String = TxtLenh_PO.Text
        Dim Dstmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetPN7FromPDX", "1#" + M_Mode + "#" + _Lenh_PO + "#" + M_Ma_Dvcs + "#" + M_User_Name)
    ...
    Private Sub L_Lenh_Ro(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim _Dt As Date = TxtNgay_Ct.Value
        TxtLenh_RO.Text = CyberVoucher.V_FormatSo_Ro(AppConn, osysvar, M_Ma_CT, CmbMa_GD.SelectedValue, M_Mode, _Dt, TxtLenh_RO.Text, CbbMa_TTCP_H, TxtMa_Dvcs.Text, M_User_Name, CyberSmlib)
    End Sub
