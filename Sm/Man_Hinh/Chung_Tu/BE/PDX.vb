...
#End Region
#Region "Columns Edit"    
    Dim EditMa_Kx, EditTen_Kx, EditMa_Mau, EditTen_Mau, EditSo_Khung, EditSo_May, EditMa_Vitri, EditMa_Kho_I, EditMa_Vv_I, EditMa_Phi_i, EditMa_HD_I, EditMa_SP_I, EditMa_Ku_I, EditMa_TTLN_i, EditMa_TTCP_i, EditMa_BP_I, EditMa_Hs_I, EditMa_CD_I, EditMa_TD1_I, EditMa_TD2_I, EditMa_TD3_I, EditMa_TD4_I, EditMa_TD5_I As New Cyber.Fill.CyberColumnGridView
    Dim EditMa_lo, Editma_Db_I, EditMa_Xe_I, EditMa_Kx_I, EditMa_Tuyen_I, EditMa_Ts, EditMa_Cc As New Cyber.Fill.CyberColumnGridView
    Dim EditSo_Luong, EditGia_Nt0, EditGia0, EditGia_Nt, EditTien_Nt0, EditTien0, EditCP_Nt, EditCP, EditGia, EditTien_Nt, EditTien, EditDien_Giaii, EditSo_So, EditSo_Po, EditSo_Ro, EditSo_VT As New Cyber.Fill.CyberColumnGridView
    Dim EditThue_Suat, EditTien_Nt3, EditTien3, EditThue, EditThue_Nt As New Cyber.Fill.CyberColumnGridView
#End Region
...
#End Region
    Private Sub PDX_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Detail()
        ...
        'EditThue_Suat.V_ActiLookUpColumn(AddressOf V_Thue_suat, AddressOf L_Thue_suat)
...
#Region "Vat tu kho/Vitri - "
    ...
    'Private Sub V_Thue_suat(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    '    CyberSupport.V_Lookup("Ma_Thue", "DmThue", "1=1", "1=1", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    'End Sub
    'Private Sub L_Thue_suat(ByVal sender As System.Object, ByVal e As System.EventArgs)
    '    Dim iRow As Integer = -1
    '    iRow = DetailGRV.GetFocusedDataSourceRowIndex
    '    If iRow < 0 Then Exit Sub
    '    DrReturn = CyberSupport.L_Lookup(M_Mode, M_Ma_CT, sender, True)
    ...
    Private Sub V_SetPricePurChase(ByVal iRow As Integer)
        ...
        Dim _Ma_Kh As String = TxtMa_Kh.Text
        Dim _ngay_Ct As Date = TxtNgay_Ct.Value
        Dim DsgetPrice As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetPricePurchase", _Ma_Kx.Trim + "#" + _Ma_Kho.Trim + "#" + _Ma_Kh + "#" + _
        _ngay_Ct.ToString("yyyyMMdd") + "#" + _So_Luong.ToString.Trim.Replace(",", ".") + "#" + _Gia_Nt.ToString.Trim.Replace(",", ".") + "#" + _Tien_Nt.ToString.Trim.Replace(",", ".") + "#" + _
         M_Mode.Trim + "#" + M_Stt_Rec + "#" + M_Ma_CT.Trim + "#" + TxtMa_Dvcs.Text.Trim + "#" + M_User_Name.Trim)
...
#Region "Button"
    Private Sub V_Save(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Not CyberInput.SysGetNoBE(AppConn, osysvar, "L", _So_Ct, TxtStt_Rec.Text, _Ngay_Ct, _Ngay_LCt, CmbMa_GD.SelectedValue.ToString.Trim, M_Ma_CT, M_Ma_Dvcs, M_User_Name) Then Exit Sub
    ...
    Private Function ChkDa_Nhap(ByVal _Mode) As Boolean
        ...
        Next
        DsTmp = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_ChkPODDaNhap", nCount.ToString.Trim & "#" & _Mode & "#" & _Dt.ToString("yyyyMMdd") & "#" & _So & "#" & strMa_Kx & "#" & strMa_Kho & "#" & strSo_Luong & "#" & M_Stt_Rec & "#" & M_Ma_Dvcs & "#" & M_User_Name)
