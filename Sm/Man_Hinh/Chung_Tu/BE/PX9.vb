...
#Region "Columns Edit"
    ...
    Dim EditTen_Kx, EditTen_Mau, EditDvt, EditTen_Tk_VT, EditTen_Kho_i, EditSo_Luong, EditGia, EditGia_NT, EditTien, EditTien_NT, EditDien_Giaii, EditSo_So, EditSo_Po, EditSo_Ro, EditSo_VT As New Cyber.Fill.CyberColumnGridView
#End Region
...
#End Region
    Private Sub PX9_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
        ...
        GetRound()
        CmdNew.Select()
        DetailGRV.OptionsFilter.AllowFilterEditor = False
        DetailGRV.OptionsView.ShowFilterPanelMode = DevExpress.XtraGrid.Views.Base.ShowFilterPanelMode.Never
        DetailGRV.OptionsFind.AlwaysVisible = False
    End Sub
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Master()
        ...
        AddHandler ChkE_Thue.CheckedChanged, AddressOf V_E_Thue
        '---
        AddHandler TxtT_Thue_NT.Leave, AddressOf L_T_Thue_NT
        AddHandler TxtT_Thue.Leave, AddressOf L_T_Thue
        '----------------------------------------------------------------------------------------------------------
    ...
    Private Sub V_AddHandler_Detail()
        If Not EditSo_Luong Is Nothing Then AddHandler EditSo_Luong.EditColumn.Leave, AddressOf L_Tinh_Toan
...
#Region "Valid --- Tk_Thue_Co"
    ...
    End Sub
#End Region
#Region "Sua/HT thue/Tien thue/Chiet khau"
    ...
    Private Sub L_T_Thue_NT(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        UpdateList()
    End Sub
    Private Sub L_T_Thue(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        V_Tinh_Tien()
        UpdateList()
...
#Region "Valid - Detail - Core"
    ...
    Private Sub V_Tinh_Tien()
        ...
        Dim nT_Tien_Nt As Decimal = TxtT_Tien_NT.Double
        Dim nT_Tien As Decimal = TxtT_Tien.Double

        Dim nT_Thue_Nt As Decimal = 0
        Dim nT_Thue As Decimal = 0

        If Not ChkSua_Thue.Checked Then           
            nT_Thue_Nt = CyberSupport.V_Round(nT_Tien_Nt * nThue_Suat / 100, M_R_TIEN_NT)
            nT_Thue = CyberSupport.V_Round(nT_Tien * nThue_Suat / 100, M_R_TIEN_NT)           
        Else
            nT_Thue_Nt = 0
            nT_Thue = 0
...
#Region "Kieu xe kho/Vitri - "
    ...
    Private Sub V_GetTTXe(ByVal iRow As Integer, ByVal Loai As String)
        ...
        If _DsTTXe.Tables(0).Columns.Contains("Gia_Nt") Then Dv_DetailTmp.Item(iRow).Item("Gia_Nt") = _DsTTXe.Tables(0).Rows(0).Item("Gia_Nt")
    ...
    Private Sub V_SetPriceXePurChase(ByVal iRow As Integer)
        ...
        If _DtGia.Columns.Contains("Gia_NT0") Then Dv_DetailTmp.Item(iRow).Item("Gia_NT") = _DtGia.Rows(0).Item("Gia_NT0")
        If _DtGia.Columns.Contains("Tien_Nt0") Then Dv_DetailTmp.Item(iRow).Item("Tien_Nt") = _DtGia.Rows(0).Item("Tien_Nt0")
        Dv_DetailTmp.Item(iRow).EndEdit()
        Dv_DetailTmp.Table.AcceptChanges()
        DsgetPrice.Dispose()
        V_Tinh_Toan(iRow)
