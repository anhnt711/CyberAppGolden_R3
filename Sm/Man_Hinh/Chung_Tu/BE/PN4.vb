...
#End Region
#Region "Columns Edit"
    Dim EditMa_lo, EditTk_VT As New Cyber.Fill.CyberColumnGridView
    ...
    Dim EditTen_Kx, EditTen_Mau, EditDvt, EditTen_Kho_i, EditTen_Tk_VT, Editma_Db_I, EditMa_Xe_I, EditMa_Kx_I, EditMa_Tuyen_I, EditMa_Ts, EditMa_Cc As New Cyber.Fill.CyberColumnGridView
    Dim EditSo_Luong, EditGia_Nt0, EditGia0, EditGia_Nt, EditTien_Nt0, EditTien0, EditCP_Nt, EditCP, EditNK_Nt, EditNK, EditGia, EditTien_Nt, EditTien, EditThue_Nt, EditThue, EditDien_Giaii, EditSo_So, EditSo_Po, EditSo_Ro, EditSo_VT As New Cyber.Fill.CyberColumnGridView
#End Region
...
#End Region
    Private Sub PN4_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#Region "Load And Set And Default"
    Private Sub V_Load()
        ...
        TxtT_NK_NT.InputMask = IIf(DrDmct.Item("M_IP_MK_Tien_Nt").ToString.Trim <> "", DrDmct.Item("M_IP_MK_Tien_Nt").ToString.Trim, TxtT_NK_NT.InputMask)
        TxtT_NK.InputMask = IIf(DrDmct.Item("M_IP_MK_Tien").ToString.Trim <> "", DrDmct.Item("M_IP_MK_Tien").ToString.Trim, TxtT_NK.InputMask)
        ...
        TxtT_TC_NT.InputMask = IIf(DrDmct.Item("M_IP_MK_Tien_Nt").ToString.Trim <> "", DrDmct.Item("M_IP_MK_Tien_Nt").ToString.Trim, TxtT_TC_NT.InputMask)
        TxtT_TC.InputMask = IIf(DrDmct.Item("M_IP_MK_Tien").ToString.Trim <> "", DrDmct.Item("M_IP_MK_Tien").ToString.Trim, TxtT_TC.InputMask)
    End Sub
    ...
    Private Sub V_GetColumn()
        ...
        EditNK_Nt.GetColumn(DetailGRV, "NK_Nt")
        EditNK.GetColumn(DetailGRV, "NK")
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Master()
        ...
        'NK
        AddHandler TxtT_NK_NT.Leave, AddressOf L_T_NK_Nt
        'Mau_BC
        ...
        'TK_Thue_Nk
        AddHandler TxtTk_Thue_NK.CyberValiting, AddressOf V_Tk_Thue_NK
        AddHandler TxtTk_Thue_NK.CyberLeave, AddressOf L_Tk_Thue_NK
        '----------------------------------------------------------------------------------------------------------
        ...
        AddHandler ChkSua_Thue_NK.CheckedChanged, AddressOf V_Sua_Thue_NK
        '----------------------------------------------------------------------------------------------------------
        AddHandler TxtT_Tien0.Leave, AddressOf L_Tien0
        AddHandler TxtT_CP.Leave, AddressOf L_CP
        AddHandler TxtT_NK.Leave, AddressOf L_NK
        AddHandler TxtT_Thue.Leave, AddressOf L_Thue
        AddHandler ChkE_Tien0.CheckedChanged, AddressOf Chk_E_Tien0
        AddHandler ChkE_CP.CheckedChanged, AddressOf Chk_E_CP
        AddHandler ChkE_NK.CheckedChanged, AddressOf Chk_E_NK
        AddHandler ChkE_Thue.CheckedChanged, AddressOf Chk_E_Thue
        '----------------------------------------------------------------------------------------------------------
        ...
        '----------------------------------------------------------------------------------------------------------
        AddHandler ChkSua_NK.CheckedChanged, AddressOf V_Sua_NK
        AddHandler ChkPB_NK_SL.CheckedChanged, AddressOf V_PB_NK_SL
        AddHandler ChkPB_NK_Tien.CheckedChanged, AddressOf V_PB_NK_Tien
        '----------------------------------------------------------------------------------------------------------
    ...
    Private Sub V_AddHandler_Detail()
        ...
        '----------------------------------------------------------------------------------------------------------
        If Not EditNK_Nt.Column Is Nothing Then AddHandler EditNK_Nt.EditColumn.Leave, AddressOf L_Tinh_Toan
        If Not EditNK.Column Is Nothing Then AddHandler EditNK.EditColumn.Leave, AddressOf L_Tinh_Toan
        '----------------------------------------------------------------------------------------------------------
    ...
    Private Sub VisibleColumnMa_Nt()
        If TxtMa_NT.Text.Trim = "" Or TxtMa_NT.Text.Trim.ToUpper = osysvar("M_Ma_Nt0").ToString.Trim.ToUpper Then
            ...
            EditCP.Visible = False
            EditNK.Visible = False

            TxtT_Tien0.Visible = False
            TxtT_CP.Visible = False
            TxtT_TT.Visible = False
            TxtT_NK.Visible = False
            TxtT_TC.Visible = False
            TxtT_Thue.Visible = False

            ChkE_Tien0.Visible = False
            ChkE_CP.Visible = False
            ChkE_NK.Visible = False
            ChkE_Thue.Visible = False

            ChkE_Tien0.Checked = False
            ChkE_CP.Checked = False
            ChkE_NK.Checked = False
            ChkE_Thue.Checked = False
        Else
            ...
            TxtT_NK.Visible = True
            TxtT_TC.Visible = True
            TxtT_Thue.Visible = True

            ChkE_Tien0.Visible = True
            ChkE_CP.Visible = True
            ChkE_NK.Visible = True
            ChkE_Thue.Visible = True
        End If
        SetFoCusGRV()
    End Sub
    ...
    Protected Overrides Sub V_Databing()
        ...
        V_SetThue_CP_NK()
    End Sub
    Private Sub V_SetThue_CP_NK()
        ChkE_Thue.Checked = Not ChkSua_Thue.Checked
        ChkE_Thue.Visible = Not ChkSua_Thue.Checked
        If (M_Mode = "M" Or M_Mode = "S") Then
            TxtT_Tien0.ReadOnly = Not ChkE_Tien0.Checked
            TxtT_CP.ReadOnly = Not ChkE_CP.Checked
            TxtT_NK.ReadOnly = Not ChkE_NK.Checked
            TxtT_Thue.ReadOnly = Not ChkE_Thue.Checked
        End If
    End Sub
    ...
    Private Sub SetFoCusGRV()
        ...
        Dim _Chk_NK As Boolean = ChkSua_NK.Checked

        ChkPB_CP_SL.Visible = _Chk
        ChkPB_CP_Tien.Visible = _Chk
        LabPb_CP_SL_Tien.Visible = _Chk

        ChkPB_NK_SL.Visible = _Chk_NK
        ChkPB_NK_Tien.Visible = _Chk_NK
        LabPb_NK_SL_Tien.Visible = _Chk_NK
        If Not (M_Mode = "S" Or M_Mode = "M") Then Exit Sub

        EditCP.ColumnReadOnly = _Chk
        EditCP_Nt.ColumnReadOnly = _Chk

        EditNK.ColumnReadOnly = _Chk_NK
        EditNK_Nt.ColumnReadOnly = _Chk_NK

        CyberFill.SetFoCusGRV(DetailGRV, "CP", _Chk)
        CyberFill.SetFoCusGRV(DetailGRV, "CP_Nt", _Chk)

        CyberFill.SetFoCusGRV(DetailGRV, "NK", _Chk_NK)
        CyberFill.SetFoCusGRV(DetailGRV, "NK_Nt", _Chk_NK)
    End Sub
...
#Region "Valid --- Tk_Thue_Co"
    ...
    End Sub
#End Region
#Region "Valid --- Tk_Thue_NK"
    Private Sub V_Tk_Thue_NK(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If TxtTk_Thue_NK.ReadOnly Then Exit Sub
        TxtTk_Thue_NK.V_LookUp(M_LAN, M_Para, osysvar, AppConn, DsLookup, "Tk", "DmTk", "1=1", "1=1")
    End Sub
    Private Sub L_Tk_Thue_NK(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If TxtTk_Thue_NK.Text = "" Then Exit Sub
        DrReturn = TxtTk_Thue_NK.GetRowsSelectData(True)
        If Not DrReturn Is Nothing Then TxtTk_Thue_NK.Text = DrReturn.Item("Tk")
    End Sub
#End Region
    ...
    Private Sub V_Sua_Thue_CP(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        UpdateList()
    End Sub
    Private Sub V_Sua_Thue_NK(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        V_Tinh_Tien()
        UpdateList()
    End Sub
    Private Sub V_GetTk_Thue_No_CO()
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If Not ChkSua_TkThue.Checked Or TxtTk_Thue_No.Text.Trim = "" Or TxtTk_Thue_Co.Text.Trim = "" Then
            ...
            If Not ChkSua_TkThue.Checked Or TxtTk_Thue_No.Text = "" Then TxtTk_Thue_No.Text = DrReturn.Item("Tk_Thue_No")
            If Not ChkSua_TkThue.Checked Or TxtTk_Thue_Co.Text = "" Then TxtTk_Thue_Co.Text = DrReturn.Item("Tk_Thue_Co")
            TxtThue_Suat.Double = DrReturn.Item("Thue_Suat")
            V_Tinh_Tien()
            UpdateList()
        End If
...
#Region "VAT"
    ...
    Private Sub V_AddVat(ByRef _DtVat As DataTable, ByVal _Ma_Post As String, ByVal _Ngay_Ct As Date, ByVal _Ngay_LCt As Date, ByVal _Ma_Nt As String, ByVal _Ty_GIa As Decimal)
        ...
        Dim _T_Tien_Nt As Decimal = If(ChkSua_Thue_CP.Checked, TxtT_TT_NT.Double, TxtT_Tien_NT0.Double)
        Dim _T_Tien As Decimal = If(ChkSua_Thue_CP.Checked, TxtT_TT.Double, TxtT_Tien0.Double)
...
#End Region
#End Region
#Region "Edit Tien0/Cp/NK/Thue"
    '---------Sua Tien0
    Private Sub L_Tien0(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If ChkE_Tien0.Checked Then V_Phan_Bo_Tien0()
        ...
        UpdateList()
    End Sub
    Private Sub Chk_E_Tien0(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If ChkE_Tien0.Checked Then
            TxtT_Tien0.ReadOnly = False
            TxtT_Tien0.Focus()
        Else
    ...
    End Sub
    '---------Sua Cp
    Private Sub L_CP(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If ChkE_CP.Checked Then V_Phan_Bo_CP()
        For iRow As Integer = 0 To Dv_DetailTmp.Count - 1
            V_Tinh_Toan(iRow)
        Next
        V_Tinh_Tien()
        UpdateList()
    End Sub
    Private Sub Chk_E_CP(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If ChkE_CP.Checked Then
            TxtT_CP.Focus()
            TxtT_CP.ReadOnly = False
        Else
    ...
    End Sub
    '---------Sua NK
    Private Sub L_NK(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If ChkE_NK.Checked Then V_Phan_Bo_NK()
        For iRow As Integer = 0 To Dv_DetailTmp.Count - 1
            V_Tinh_Toan(iRow)
        Next
        V_Tinh_Tien()
        UpdateList()
    End Sub
    Private Sub Chk_E_NK(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If ChkE_NK.Checked Then
            TxtT_NK.Focus()
            TxtT_NK.ReadOnly = False
        Else
            TxtT_NK.ReadOnly = True
        End If
        L_NK(sender, e)
    End Sub
    '---------Sua Thue
    Private Sub L_Thue(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If ChkE_Thue.Checked Then V_Phan_Bo_Thue()
        For iRow As Integer = 0 To Dv_DetailTmp.Count - 1
            V_Tinh_Toan(iRow)
        Next
        V_Tinh_Tien()
        UpdateList()
    End Sub
    Private Sub Chk_E_Thue(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If ChkE_Thue.Checked Then
            TxtT_Thue.Focus()
            TxtT_Thue.ReadOnly = False
        Else
...
#End Region
#Region "Thue NK"
    Private Sub L_T_NK_Nt(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        V_Phan_Bo_NK()
        UpdateList()
        V_Tinh_Tien()
    End Sub
    Private Sub V_Sua_NK(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        SetFoCusGRV()
        If ChkSua_NK.Checked Then
            TxtT_NK_NT.ReadOnly = False
            TxtT_NK_NT.Focus()
        Else
            TxtT_NK_NT.ReadOnly = True
            For iRow As Integer = 0 To Dv_DetailTmp.Count - 1
                V_Tinh_Toan(iRow)
            Next
        End If
        ...
        V_Tinh_Tien()
    End Sub
    Private Sub V_PB_NK_SL(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If ChkPB_NK_SL.Checked = True Then ChkPB_NK_Tien.Checked = False Else ChkPB_NK_Tien.Checked = True
        If Not ChkSua_NK.Checked Then
            For iRow As Integer = 0 To Dv_DetailTmp.Count - 1
                V_Tinh_Toan(iRow)
            Next
        End If
        ...
        V_Tinh_Tien()
    End Sub
    Private Sub V_PB_NK_Tien(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If ChkPB_NK_Tien.Checked = True Then ChkPB_NK_SL.Checked = False Else ChkPB_NK_SL.Checked = True
        If Not ChkSua_NK.Checked Then
            For iRow As Integer = 0 To Dv_DetailTmp.Count - 1
                V_Tinh_Toan(iRow)
            Next
...
#End Region
#Region "Phan bo"
    Private Sub V_Phan_Bo_Tien0()
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If ChkE_Tien0.Checked Then
            CyberSupport.Phan_Bo(Dt_DetailTmp, "Tien_Nt0", "Tien0", TxtT_Tien0.Double, M_R_TIEN_NT)
        End If
    End Sub
    Private Sub V_Phan_Bo_CP()
        ...
        End If
    End Sub
    Private Sub V_Phan_Bo_NK()
        If ChkSua_NK.Checked Then
            If ChkPB_NK_SL.Checked Then
                CyberSupport.Phan_Bo(Dt_DetailTmp, "So_Luong", "NK_Nt", TxtT_NK_NT.Double, M_R_TIEN_NT)
                CyberSupport.Phan_Bo(Dt_DetailTmp, "So_Luong", "NK", TxtT_NK.Double, M_R_TIEN)
            Else
                CyberSupport.Phan_Bo(Dt_DetailTmp, "Tien_Nt0", "NK_Nt", TxtT_NK_NT.Double, M_R_TIEN_NT)
                CyberSupport.Phan_Bo(Dt_DetailTmp, "Tien_Nt0", "NK", TxtT_NK.Double, M_R_TIEN)
            End If
        End If
    End Sub
    ...
    Private Sub V_Phan_Bo_Tien()
        ...
        For iRow As Integer = 0 To Dv_DetailTmp.Count - 1
            ...
            Dv_DetailTmp.Item(iRow).Item("Tien_Nt") = Dv_DetailTmp.Item(iRow).Item("Tien_Nt0") + Dv_DetailTmp.Item(iRow).Item("CP_Nt") + Dt_DetailTmp.Rows(iRow).Item("NK_Nt")
            Dv_DetailTmp.Item(iRow).Item("Tien") = Dv_DetailTmp.Item(iRow).Item("Tien0") + Dv_DetailTmp.Item(iRow).Item("CP") + Dt_DetailTmp.Rows(iRow).Item("NK")
...
#Region "Valid - Detail - Core"
    Private Sub UpdateList()
        ...
        Dim nT_NK_Nt As Decimal = 0
        Dim nT_NK As Decimal = 0

        Dim nT_TC_Nt As Decimal = 0
        Dim nT_TC As Decimal = 0
        ...
        For iRow As Integer = 0 To Dv_DetailTmp.Count - 1
            ...
            nT_NK_Nt = nT_NK_Nt + Dv_DetailTmp.Item(iRow).Item("NK_Nt")
            nT_NK = nT_NK + Dv_DetailTmp.Item(iRow).Item("NK")

            nT_So_Luong = nT_So_Luong + Dv_DetailTmp.Item(iRow).Item("So_Luong")
        Next

        If ChkSua_CP.Checked Then nT_CP_Nt = TxtT_CP_NT.Double
        If ChkSua_CP.Checked Or ChkE_CP.Checked Then nT_CP = TxtT_CP.Double
        If ChkSua_NK.Checked Then nT_NK_Nt = TxtT_NK_NT.Double
        If ChkSua_NK.Checked Or ChkE_NK.Checked Then nT_NK = TxtT_NK.Double
        '------------------------------------------------------------------------------------------------------
        If ChkSua_Thue.Checked Then
            For irow As Integer = 0 To Dv_DetailVaTTmp.Count - 1
        ...
        '----------------------------------------------------------------------
        nT_TT_Nt = nT_Tien_Nt0 + nT_CP_Nt
        nT_TT = nT_Tien0 + nT_CP
        TxtT_TT_NT.Double = nT_TT_Nt
        TxtT_TT.Double = nT_TT
        '----------------------------------------------------------------------
        TxtT_NK_NT.Double = nT_NK_Nt
        TxtT_NK.Double = nT_NK
        '----------------------------------------------------------------------
        nT_TC_Nt = nT_TT_Nt + nT_NK_Nt
        nT_TC = nT_TT + nT_NK
        TxtT_TC_NT.Double = nT_TC_Nt
        TxtT_TC.Double = nT_TC
    End Sub
    Private Sub V_Tinh_Tien()
        ...
        '--------------------------------Tinh 
        If ChkSua_NK.Checked Then
            If Not ChkE_NK.Checked Then TxtT_NK.Double = CyberSupport.V_Round(TxtT_NK_NT.Double * nTy_Gia, M_R_TIEN)
        End If
        If ChkSua_CP.Checked Then
            If Not ChkE_CP.Checked Then TxtT_CP.Double = CyberSupport.V_Round(TxtT_CP_NT.Double * nTy_Gia, M_R_TIEN)
        End If
        V_Phan_Bo_CP()
        V_Phan_Bo_NK()
        '--------------------------------Tinh Thue
        If Not ChkSua_Thue.Checked Then
            ...
            If ChkSua_Thue_NK.Checked Then nTien_Hang_Nt = nTien_Hang_Nt + TxtT_NK_NT.Text
            If ChkSua_Thue_NK.Checked Then nTien_Hang = nTien_Hang + TxtT_NK.Text

            nT_Thue_Nt = CyberSupport.V_Round(nTien_Hang_Nt * nThue_Suat / 100, M_R_TIEN_NT)
            If Not ChkE_Thue.Checked Then nT_Thue = CyberSupport.V_Round(nTien_Hang * nThue_Suat / 100, M_R_TIEN_NT) Else nT_Thue = TxtT_Thue.Double
    ...
    Private Sub V_Tinh_Toan(ByVal iRow As Integer)
        ...
        If nTy_Gia = 1 Then
            ...
            Dv_DetailTmp.Item(iRow).Item("NK") = Dv_DetailTmp.Item(iRow).Item("NK_Nt")
            Dv_DetailTmp.Item(iRow).Item("Gia") = Dv_DetailTmp.Item(iRow).Item("Gia_Nt")
        Else

            If Not ChkE_Tien0.Checked Then
            ...
            If Not ChkSua_CP.Checked Then Dv_DetailTmp.Item(iRow).Item("CP") = CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("CP_Nt") * nTy_Gia, M_R_TIEN)
            If Not ChkSua_NK.Checked Then Dv_DetailTmp.Item(iRow).Item("NK") = CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("NK_Nt") * nTy_Gia, M_R_TIEN)
        ...
        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("Tien_Nt") = Dv_DetailTmp.Item(iRow).Item("Tien_Nt0") + Dv_DetailTmp.Item(iRow).Item("CP_Nt") + Dv_DetailTmp.Item(iRow).Item("NK_Nt")
        Dv_DetailTmp.Item(iRow).Item("Tien") = Dv_DetailTmp.Item(iRow).Item("Tien0") + Dv_DetailTmp.Item(iRow).Item("CP") + Dv_DetailTmp.Item(iRow).Item("NK")
...
#Region "Button"
    Private Sub V_Save(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        V_Sua_NK(sender, e)
        V_PB_NK_SL(sender, e)
        V_PB_NK_Tien(sender, e)
        V_Phan_Bo_Tien()

        For iRow = 0 To Dt_DetailTmp.Rows.Count - 1
            Dt_DetailTmp.Rows(iRow).BeginEdit()
            Dt_DetailTmp.Rows(iRow).Item("Tien_Nt") = Dt_DetailTmp.Rows(iRow).Item("Tien_Nt0") + Dt_DetailTmp.Rows(iRow).Item("CP_Nt") + Dt_DetailTmp.Rows(iRow).Item("NK_Nt")
            Dt_DetailTmp.Rows(iRow).Item("Tien") = Dt_DetailTmp.Rows(iRow).Item("Tien0") + Dt_DetailTmp.Rows(iRow).Item("CP") + Dt_DetailTmp.Rows(iRow).Item("NK")
    ...
    Private Function ChkPN3PN4(ByVal _Mode) As Boolean
        ...
        Next
        DsTmp = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_ChkPN3PN4", nCount.ToString.Trim & "#" & _Mode & "#" & _Dt.ToString("yyyyMMdd") & "#" & _So & "#" & strMa_Kx & "#" & strMa_Mau & "#" & strSo_khung & "#" & strSo_May & "#" & strSo_Po & "#" & M_Ma_Dvcs & "#" & M_User_Name)
    ...
    Private Sub V_CreateVAT()
        ...
        If ChkSua_Thue_CP.Checked Then
            ...
            drMaster.Item("T_Tien_Nt") = TxtT_TT_NT.Double
            drMaster.Item("T_Tien") = TxtT_TT.Double
    ...
    Private Sub V_New(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If TxtTk_Thue_NK.Text.Trim = "" Then TxtTk_Thue_NK.Text = M_Tk_Thue
        If TxtMa_Nx.Text.Trim = "" Then
        ...
        ChkSua_NK.Checked = True
        ChkPB_NK_SL.Checked = False
        ChkPB_NK_Tien.Checked = True

        ChkSua_Thue_NK.Checked = True
...
#Region "Sms - Import"
    ...
    Private Sub SetTxt()
        ...
        TxtT_TC_NT.ReadOnly = True
        TxtT_TC.ReadOnly = True
        SetReadOnlyTk_Thue_No_Co()
    End Sub
    Private Sub SetReadOnlyTk_Thue_No_Co()
