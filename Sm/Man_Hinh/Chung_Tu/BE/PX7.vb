...
#End Region
    Private Sub PX7_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#Region "Vat tu kho/Vitri - "
    ...
    Private Sub V_GetTTXe(ByVal iRow As Integer, ByVal Loai As String)
        ...
        Dim _DsTTXe As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_BEGetTTXeX", Loai & "#" & _So_Khung.Trim & "#" & _So_May.Trim & "#" & _Ma_Kx.Trim & "#" & _Ma_Mau.Trim _
