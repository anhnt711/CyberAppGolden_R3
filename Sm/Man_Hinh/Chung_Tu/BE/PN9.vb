...
#End Region
#Region "Columns Edit"
    Dim EditMa_Lo, EditTk_VT, EditTk_TL, EditTk_GV As New Cyber.Fill.CyberColumnGridView
    Dim EditMa_Kx, EditMa_Mau, EditSo_Khung, EditSo_may, EditMa_Vitri, EditMa_Kho_I, EditMa_Vv_I, EditMa_Phi_i, EditMa_HD_I, EditMa_SP_I, EditMa_Ku_I, EditMa_TTLN_i, EditMa_TTCP_i, EditMa_BP_I, EditMa_Hs_I, EditMa_CD_I, EditMa_TD1_I, EditMa_TD2_I, EditMa_TD3_I, EditMa_TD4_I, EditMa_TD5_I As New Cyber.Fill.CyberColumnGridView
    Dim Editma_Db_I, EditMa_Xe_I, EditMa_Kx_I, EditMa_Tuyen_I, EditMa_Ts, EditMa_Cc As New Cyber.Fill.CyberColumnGridView
    Dim EditSo_Luong, EditTen_Kx, EditTen_Mau, EditTen_Tk_TL, EditTen_Tk_GV, EditDvt, EditTen_Kho_i, EditTen_Tk_VT, EditGia_NT2, EditGia2, EditGia_NT, EditTien_NT2, EditTien2, EditGia, EditTien_NT, EditTien, EditDien_Giaii, EditSo_So, EditSo_Po, EditSo_Ro, EditSo_VT As New Cyber.Fill.CyberColumnGridView
#End Region
...
#End Region
    Private Sub PN9_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#Region "Load And Set And Default"
    ...
    Private Sub V_GetColumn()
        ...
        EditTk_TL.GetColumn(DetailGRV, "Tk_TL")
        EditTen_Tk_TL.GetColumn(DetailGRV, "Ten_Tk_TL")
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Master()
        ...
        '---------
        AddHandler ChkPN_Gia_TB.CheckedChanged, AddressOf V_PN_Gia_TB
    ...
    Private Sub V_AddHandler_Detail()
        ...
        EditTk_TL.V_ActiLookUpColumn(AddressOf V_Tk_TL, AddressOf L_Tk_TL)
    ...
    Private Sub L_Ma_Thue(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Else
            ...
            If ChkSua_TkThue.Checked Then
                If TxtTk_Thue_No.Text.Trim = "" Then TxtTk_Thue_No.Text = DrReturn.Item("Tk_Thue_No")
            Else
...
#Region "Phieu xuat gia dich danh Sua/HT thue/Tien thue/Chiet khau"
    Private Sub V_PN_Gia_TB(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim _Chk As Boolean = ChkPN_Gia_TB.Checked
        EditGia.ColumnReadOnly = Not _Chk
        EditGia_NT.ColumnReadOnly = Not _Chk
        EditTien.ColumnReadOnly = Not _Chk
        EditTien_NT.ColumnReadOnly = Not _Chk
        CyberFill.SetFoCusGRV(DetailGRV, M_Mode)
    End Sub
    ...
    Private Sub V_GetTk_Thue_No()
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If Not ChkSua_TkThue.Checked Or TxtTk_Thue_No.Text.Trim = "" Then
...
#Region "Ma_Kx/Ma_Mau/Vitri - "
    ...
    Private Sub L_Ma_Kx(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim _Tk_TL As String = DrReturn.Item("Tk_TL")
        ...
        Dv_DetailTmp.Item(iRow).Item("Tk_TL") = IIf(Dv_DetailTmp.Item(iRow).Item("Tk_TL").ToString.Trim = "", _Tk_TL, Dv_DetailTmp.Item(iRow).Item("Tk_TL").ToString.Trim)
    ...
    Private Sub L_Ma_Vitri(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        '  V_SetSD(iRow)
    End Sub
    Private Sub V_GetTTXe(ByVal iRow As Integer, ByVal Loai As String)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If iRow < 0 Then Exit Sub
        ...
        Dim _Ma_TTCP As String = CmbMa_TTCP_H.SelectedValue.ToString.Trim

        Dim _DsTTXe As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_BEGetTTXe", Loai & "#" & _So_Khung.Trim & "#" & _So_May.Trim & "#" & _Ma_Kx.Trim & "#" & _Ma_Mau.Trim _
                                                                    & "#" & M_Ma_CT.Trim & "#" & M_Stt_Rec.Trim & "#" & _Dt.ToString("yyyyMMdd") & "#" & _Ma_Kho.Trim & "#" & _Ma_Vitri.Trim _
                                                                    & "#" & _Ma_TTCP.Trim & "#" & M_Ma_Dvcs.Trim & "#" & M_User_Name.Trim)
        ...
        'Gán giá trị
        If _DsTTXe.Tables(0).Columns.Contains("So_Khung") Then Dv_DetailTmp.Item(iRow).Item("So_Khung") = _DsTTXe.Tables(0).Rows(0).Item("So_Khung")
        If _DsTTXe.Tables(0).Columns.Contains("So_May") Then Dv_DetailTmp.Item(iRow).Item("So_May") = _DsTTXe.Tables(0).Rows(0).Item("So_May")
        If _DsTTXe.Tables(0).Columns.Contains("Ma_Kx") Then Dv_DetailTmp.Item(iRow).Item("Ma_Kx") = _DsTTXe.Tables(0).Rows(0).Item("Ma_Kx")
        If _DsTTXe.Tables(0).Columns.Contains("Ten_Kx") Then Dv_DetailTmp.Item(iRow).Item("Ten_Kx") = _DsTTXe.Tables(0).Rows(0).Item("Ten_Kx")
        If _DsTTXe.Tables(0).Columns.Contains("Ma_Mau") Then Dv_DetailTmp.Item(iRow).Item("Ma_Mau") = _DsTTXe.Tables(0).Rows(0).Item("Ma_Mau")
        If _DsTTXe.Tables(0).Columns.Contains("Ten_Mau") Then Dv_DetailTmp.Item(iRow).Item("Ten_Mau") = _DsTTXe.Tables(0).Rows(0).Item("Ten_Mau")
        If _DsTTXe.Tables(0).Columns.Contains("Ton13") Then Dv_DetailTmp.Item(iRow).Item("Ton13") = _DsTTXe.Tables(0).Rows(0).Item("Ton13")
...
#Region "Tai khoan "
    ...
    End Sub
    Private Sub V_Tk_TL(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        CyberSupport.V_Tk_TL(M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Tk_TL(ByVal sender As System.Object, ByVal e As System.EventArgs)
        CyberSupport.L_Tk_TL(M_Mode, M_Ma_CT, sender, DetailGRV)
    End Sub
...
#Region "Sms - Import"
    ...
    Private Sub SetTxt()
        ...
        If M_Mode = "M" Or M_Mode = "S" Then If ChkSua_Thue.Checked Then TxtT_Thue_NT.ReadOnly = False
    End Sub
#End Region
