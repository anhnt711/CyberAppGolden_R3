...
#Region "Columns Edit"
    ...
    Dim EditNh_CSBH1, EditMa_Kx, EditMa_Mau, EditTien_NT, EditDien_Giaii, EditSo_So, EditSo_Po, EditSo_Ro, EditSo_BG, EditSo_VT As New Cyber.Fill.CyberColumnGridView
#End Region
...
#End Region
    Private Sub CSB_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load       
        V_Load()
        V_GetColumn()
        V_AddHandler()
        V_Databing()
...
#Region "Load And Set And Default"
    ...
    Private Sub V_GetColumn()
        EditNh_CSBH1.GetColumn(DetailGRV, "Nh_CSBH1")
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Detail()
        ...
        '----------------------------------------------------------------------------------------------------------
        'Nh_CSBH,Ma_Kx,Ma_Mau
        EditNh_CSBH1.V_ActiLookUpColumn(AddressOf V_Nh_CSBH1, AddressOf L_Nh_CSBH1)
...
#Region "Lenh/SO/Po/Ro/Vt"
    Private Sub L_Lenh_So(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim _Dt As Date = TxtNgay_Ct.Value
        TxtSo_Ct.Text = CyberVoucher.V_FormatSo_So(AppConn, osysvar, M_Ma_CT, CmbMa_GD.SelectedValue, M_Mode, _Dt, TxtSo_Ct.Text, CbbMa_TTCP_H, M_Ma_Dvcs, M_User_Name, CyberSmlib)
    End Sub
    Private Sub L_Lenh_Po(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        TxtSo_Ct.Text = CyberVoucher.V_FormatSo_PO(AppConn, osysvar, M_Ma_CT, CmbMa_GD.SelectedValue, M_Mode, _Dt, TxtSo_Ct.Text, CbbMa_TTCP_H, M_Ma_Dvcs, M_User_Name, CyberSmlib)
    End Sub
...
#Region "So_So/So_PO/So_RO/So_VT"
    ...
    Private Sub L_So_BG(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If iRow < 0 Then Exit Sub
        Dim _Ngay_Ct As Date = TxtNgay_Ct.Value
        CyberVoucher.V_GetSo_BG(Dv_DetailTmp, iRow, M_Ma_CT, CmbMa_GD.SelectedValue, M_Mode, _Ngay_Ct, TxtMa_Dvcs.Text)
    End Sub
    ...
    End Sub
#End Region
#Region "Nh_CSBH1,Ma_Kx,Ma_Mau"
    Private Sub V_Nh_CSBH1(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        CyberSupport.V_Lookup("Ma_Nh", "DmNhCSBH", "Loai_Nh = '1'", "1=1", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Nh_CSBH1(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If DrReturn Is Nothing Then
            Dv_DetailTmp.Item(iRow).BeginEdit()
            Dv_DetailTmp.Item(iRow).Item("Nh_CSBH1") = ""           
            Dv_DetailTmp.Item(iRow).EndEdit()
            Exit Sub
        Else
            Dv_DetailTmp.Item(iRow).BeginEdit()
            Dv_DetailTmp.Item(iRow).Item("Nh_CSBH1") = DrReturn("Ma_Nh").ToString.Trim            
            Dv_DetailTmp.Item(iRow).EndEdit()
        End If
        Dv_DetailTmp.Table.AcceptChanges()
...
#Region "Button"
    Private Sub V_Save(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Not CyberInput.SysGetNo(AppConn, osysvar, "L", _So_Ct, TxtStt_Rec.Text, _Ngay_Ct, _Ngay_LCt, CmbMa_GD.SelectedValue.ToString.Trim, M_Ma_CT, M_Ma_Dvcs, M_User_Name) Then Exit Sub
