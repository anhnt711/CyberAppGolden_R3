...
#End Region
    Private Sub KH4_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        CreateTableMonth()
        V_Load()
        V_GetColumn()
        V_AddHandler()
...
#Region "Valid - Detail - Core"
    ...
    Private Sub V_Tinh_Toan(ByVal iRow As Integer)
        ...
        '--------------------------------------------------------------------------------
        If Dv_DetailTmp.Table.Columns.Contains("Gia_NT") And Dv_DetailTmp.Table.Columns.Contains("Tien_NT") Then
