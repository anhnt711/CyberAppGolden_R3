...
#Region "Khai bao bien Dll"
    Dim CyberInput As New Cyber.InputCustom.Sys
    Dim CyberMe As New Cyber.From.Frmvoucher
    Dim CyberFrom As New Cyber.From.Sys

#End Region
#Region "Columns Edit"
    Dim EditMa_Vitri, EditMa_Vv_I, EditMa_phi_i, EditMa_HD_I, EditMa_Sp_I, EditMa_ku_I, EditMa_TTLN_i, EditMa_TTCP_i, EditMa_BP_I, EditMa_HS_I, EditMa_CD_I, EditMa_TD1_I, EditMa_TD2_I, EditMa_TD3_I, EditMa_TD4_I, EditMa_TD5_I As New Cyber.Fill.CyberColumnGridView 'Cyber.SmLists.EditLookUp
    Dim EditTk_No, EditTk_Co, Editke_hoach, EditMa_ChiTieu, EditDien_Giaii, EditSo_So, EditSo_Po, EditSo_Ro, EditSo_VT, EditNh_Cv1, EditNh_Cv2, EditNh_Cv3, EditNh_VT1, EditNh_VT2, EditNh_VT3, EditNh_KH1, EditNh_KH2, EditNh_KH3 As New Cyber.Fill.CyberColumnGridView 'DevExpress.XtraEditors.Repository.RepositoryItemTextEdit
#End Region
#Region "Khai bao bien Private"
    Dim M_Ct, M_Ph As String
    Dim DrReturn As DataRow
    Dim M_Count As Integer = 1
    Dim DtPost, DtMaGD, Dt_DmTTLN As DataTable
...
#End Region
    Private Sub KH7_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
        V_GetColumn()
        V_AddHandler()
...
#Region "Load And Set And Default"
    Private Sub V_Load()
        ...
        TxtT_Ke_Hoach.InputMask = IIf(DrDmct.Item("M_IP_MK_TIEN_NT").ToString.Trim <> "", DrDmct.Item("M_IP_MK_TIEN_NT").ToString.Trim, TxtT_Ke_Hoach.InputMask)
    End Sub
    ...
    Private Sub V_GetColumn()
        Editke_hoach.GetColumn(DetailGRV, "Ke_Hoach")
        ...
        EditMa_ChiTieu.GetColumn(DetailGRV, "Ma_ChiTieu")
        EditNh_Cv1.GetColumn(DetailGRV, "Nh_Cv1")
        EditNh_Cv2.GetColumn(DetailGRV, "Nh_Cv2")
        EditNh_Cv3.GetColumn(DetailGRV, "Nh_Cv3")
        EditNh_VT1.GetColumn(DetailGRV, "Nh_Vt1")
        EditNh_VT2.GetColumn(DetailGRV, "Nh_VT2")
        EditNh_VT3.GetColumn(DetailGRV, "Nh_Vt3")
        EditNh_KH1.GetColumn(DetailGRV, "Nh_KH1")
        EditNh_KH2.GetColumn(DetailGRV, "Nh_Kh2")
        EditNh_KH3.GetColumn(DetailGRV, "Nh_Kh3")
...
#Region "V_AddHandler"
    Private Sub V_AddHandler()
        ...
        'Tô màu dòng đậm
        CyberFill.V_GridviewRowCellStyle(DetailGRV)
    End Sub
    Private Sub V_AddHandler_System()
        ...
        AddHandler CmdLoc_KH7.Click, AddressOf V_GetDetail
    ...
    Private Sub V_AddHandler_Detail()
        If Not Editke_hoach.Column Is Nothing Then AddHandler Editke_hoach.EditColumn.Leave, AddressOf L_Tinh_Toan

        AddHandler EditTk_No.EditColumn.Click, AddressOf V_Click_List_Tk_No
        AddHandler EditTk_Co.EditColumn.Click, AddressOf V_Click_List_Tk_Co
        AddHandler EditMa_phi_i.EditColumn.Click, AddressOf V_Click_List_Ma_Phi
        AddHandler EditMa_Vv_I.EditColumn.Click, AddressOf V_Click_List_Ma_Vv
        AddHandler EditMa_TTLN_i.EditColumn.Click, AddressOf V_Click_List_Ma_TTLN
        AddHandler EditMa_ChiTieu.EditColumn.Click, AddressOf V_Click_List_Ma_Chitieu
        AddHandler EditNh_CV1.EditColumn.Click, AddressOf V_Click_List_Nh_CV1
        AddHandler EditNh_CV2.EditColumn.Click, AddressOf V_Click_List_Nh_CV2
        AddHandler EditNh_CV3.EditColumn.Click, AddressOf V_Click_List_Nh_CV3
        AddHandler EditNh_VT1.EditColumn.Click, AddressOf V_Click_List_Nh_Vt1
        AddHandler EditNh_VT2.EditColumn.Click, AddressOf V_Click_List_Nh_Vt2
        AddHandler EditNh_Vt3.EditColumn.Click, AddressOf V_Click_List_Nh_Vt3
        AddHandler EditNh_Kh1.EditColumn.Click, AddressOf V_Click_List_Nh_kH1
        AddHandler EditNh_Kh2.EditColumn.Click, AddressOf V_Click_List_Nh_kH2
        AddHandler EditNh_KH3.EditColumn.Click, AddressOf V_Click_List_Nh_kH3
...
#Region "Valid - Detail - Core"
    Private Sub UpdateList()
        Dim nT_Ke_Hoach As Decimal = 0

        For iRow As Integer = 0 To Dv_DetailTmp.Count - 1
            nT_Ke_Hoach = nT_Ke_Hoach + Dv_DetailTmp.Item(iRow).Item("Ke_Hoach")
        Next

        TxtT_Ke_Hoach.Double = nT_Ke_Hoach
        TxtT_Ke_Hoach.Refresh()
    End Sub
...
#Region "Click_Detail"
#Region "Tk_No"
    Private Sub V_Click_List_Tk_No(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If Not Dt_DetailTmp.Columns.Contains("Tk_No") Then Exit Sub
        Dim _iRow As Integer = -1
        _iRow = DetailGRV.GetFocusedDataSourceRowIndex
        If _iRow < 0 Then Exit Sub

        Dim str As String
        Dim _Ten_Dm As String = "DMTK0"
        Dim _Tk_No As String = Dv_DetailTmp.Item(_iRow).Item("Tk_No")
        Dim strTen As String = ""
        str = GetList(_Ten_Dm, _Tk_No, strTen)

        If str Is Nothing Then Exit Sub
        If str Is Nothing Then str = ""

        Dv_DetailTmp.Item(_iRow).BeginEdit()
        Dv_DetailTmp.Item(_iRow).Item("Tk_No") = str
...
#End Region
#Region "Tk_Co"
    Private Sub V_Click_List_Tk_Co(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If Not Dt_DetailTmp.Columns.Contains("Tk_Co") Then Exit Sub
        Dim _iRow As Integer = -1
        _iRow = DetailGRV.GetFocusedDataSourceRowIndex
        If _iRow < 0 Then Exit Sub
        ...
        Dim str As String
        Dim _Ten_Dm As String = "DMTK0"
        Dim _Tk_Co As String = Dv_DetailTmp.Item(_iRow).Item("Tk_Co")
        Dim strTen As String = ""
        str = GetList(_Ten_Dm, _Tk_Co, strTen)

        If str Is Nothing Then Exit Sub
        If str Is Nothing Then str = ""

        Dv_DetailTmp.Item(_iRow).BeginEdit()
        Dv_DetailTmp.Item(_iRow).Item("Tk_Co") = str
        Dv_DetailTmp.Item(_iRow).EndEdit()
...
#End Region
#Region "Ma_Phi_i"
    Private Sub V_Click_List_Ma_Phi(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If Not Dt_DetailTmp.Columns.Contains("Ma_Phi_i") Then Exit Sub
        Dim _iRow As Integer = -1
        _iRow = DetailGRV.GetFocusedDataSourceRowIndex
        If _iRow < 0 Then Exit Sub

        Dim str As String
        Dim _Ten_Dm As String = "DMPHI"
        Dim _Ma_Phi As String = Dv_DetailTmp.Item(_iRow).Item("Ma_Phi_i")
        Dim strTen As String = ""
        str = GetList(_Ten_Dm, _Ma_Phi, strTen)

        If str Is Nothing Then Exit Sub
        If str Is Nothing Then str = ""

        Dv_DetailTmp.Item(_iRow).BeginEdit()
        Dv_DetailTmp.Item(_iRow).Item("Ma_Phi_i") = str
        Dv_DetailTmp.Item(_iRow).EndEdit()
...
#End Region
#Region "Ma_ChiTieu"
    Private Sub V_Click_List_Ma_ChiTieu(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If Not Dt_DetailTmp.Columns.Contains("Ma_ChiTieu") Then Exit Sub
        Dim _iRow As Integer = -1
        _iRow = DetailGRV.GetFocusedDataSourceRowIndex
        If _iRow < 0 Then Exit Sub

        Dim str As String
        Dim _Ten_Dm As String = "DMCHITIEU"
        Dim _Ma_Chitieu As String = Dv_DetailTmp.Item(_iRow).Item("Ma_ChiTieu")
        Dim strTen As String = ""
        str = GetList(_Ten_Dm, _Ma_Chitieu, strTen)

        If str Is Nothing Then Exit Sub
        If str Is Nothing Then str = ""

        Dv_DetailTmp.Item(_iRow).BeginEdit()
        Dv_DetailTmp.Item(_iRow).Item("Ma_ChiTieu") = str
        Dv_DetailTmp.Item(_iRow).EndEdit()
...
#End Region
#Region "Nh_CV1"
    Private Sub V_Click_List_Nh_CV1(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If Not Dt_DetailTmp.Columns.Contains("Nh_CV1") Then Exit Sub
        Dim _iRow As Integer = -1
        _iRow = DetailGRV.GetFocusedDataSourceRowIndex
        If _iRow < 0 Then Exit Sub

        Dim str As String
        Dim _Ten_Dm As String = "DMNhCV1"
        Dim _Nh_CV1 As String = Dv_DetailTmp.Item(_iRow).Item("Nh_Cv1")
        Dim strTen As String = ""
        str = GetList(_Ten_Dm, _Nh_CV1, strTen)

        If str Is Nothing Then Exit Sub
        If str Is Nothing Then str = ""

        Dv_DetailTmp.Item(_iRow).BeginEdit()
        Dv_DetailTmp.Item(_iRow).Item("Nh_CV1") = str
        Dv_DetailTmp.Item(_iRow).EndEdit()
...
#End Region
#Region "Nh_CV2"
    Private Sub V_Click_List_Nh_CV2(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If Not Dt_DetailTmp.Columns.Contains("Nh_CV2") Then Exit Sub
        Dim _iRow As Integer = -1
        _iRow = DetailGRV.GetFocusedDataSourceRowIndex
        If _iRow < 0 Then Exit Sub

        Dim str As String
        Dim _Ten_Dm As String = "DMNhCV2"
        Dim _Nh_CV2 As String = Dv_DetailTmp.Item(_iRow).Item("Nh_CV2")
        Dim strTen As String = ""
        str = GetList(_Ten_Dm, _Nh_CV2, strTen)

        If str Is Nothing Then Exit Sub
        If str Is Nothing Then str = ""

        Dv_DetailTmp.Item(_iRow).BeginEdit()
        Dv_DetailTmp.Item(_iRow).Item("Nh_CV2") = str
        Dv_DetailTmp.Item(_iRow).EndEdit()
...
#End Region
#Region "Nh_CV3"
    Private Sub V_Click_List_Nh_CV3(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If Not Dt_DetailTmp.Columns.Contains("Nh_CV3") Then Exit Sub
        Dim _iRow As Integer = -1
        _iRow = DetailGRV.GetFocusedDataSourceRowIndex
        If _iRow < 0 Then Exit Sub

        Dim str As String
        Dim _Ten_Dm As String = "DMNhCV3"
        Dim _Nh_CV3 As String = Dv_DetailTmp.Item(_iRow).Item("Nh_CV3")
        Dim strTen As String = ""
        str = GetList(_Ten_Dm, _Nh_CV3, strTen)

        If str Is Nothing Then Exit Sub
        If str Is Nothing Then str = ""

        Dv_DetailTmp.Item(_iRow).BeginEdit()
        Dv_DetailTmp.Item(_iRow).Item("Nh_CV3") = str
        Dv_DetailTmp.Item(_iRow).EndEdit()
...
#End Region
#Region "Nh_Vt1"
    Private Sub V_Click_List_Nh_Vt1(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If Not Dt_DetailTmp.Columns.Contains("Nh_Vt1") Then Exit Sub
        Dim _iRow As Integer = -1
        _iRow = DetailGRV.GetFocusedDataSourceRowIndex
        If _iRow < 0 Then Exit Sub

        Dim str As String
        Dim _Ten_Dm As String = "DMNhVT1"
        Dim _Nh_Vt1 As String = Dv_DetailTmp.Item(_iRow).Item("Nh_VT1")
        Dim strTen As String = ""
        str = GetList(_Ten_Dm, _Nh_Vt1, strTen)

        If str Is Nothing Then Exit Sub
        If str Is Nothing Then str = ""

        Dv_DetailTmp.Item(_iRow).BeginEdit()
        Dv_DetailTmp.Item(_iRow).Item("Nh_Vt1") = str
        Dv_DetailTmp.Item(_iRow).EndEdit()
...
#End Region
#Region "Nh_Vt2"
    Private Sub V_Click_List_Nh_Vt2(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If Not Dt_DetailTmp.Columns.Contains("Nh_Vt2") Then Exit Sub
        Dim _iRow As Integer = -1
        _iRow = DetailGRV.GetFocusedDataSourceRowIndex
        If _iRow < 0 Then Exit Sub

        Dim str As String
        Dim _Ten_Dm As String = "DMNhVT2"
        Dim _Nh_Vt2 As String = Dv_DetailTmp.Item(_iRow).Item("Nh_VT2")
        Dim strTen As String = ""
        str = GetList(_Ten_Dm, _Nh_Vt2, strTen)

        If str Is Nothing Then Exit Sub
        If str Is Nothing Then str = ""

        Dv_DetailTmp.Item(_iRow).BeginEdit()
        Dv_DetailTmp.Item(_iRow).Item("Nh_Vt2") = str
        Dv_DetailTmp.Item(_iRow).EndEdit()
...
#End Region
#Region "Nh_Vt3"
    Private Sub V_Click_List_Nh_Vt3(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If Not Dt_DetailTmp.Columns.Contains("Nh_Vt3") Then Exit Sub
        Dim _iRow As Integer = -1
        _iRow = DetailGRV.GetFocusedDataSourceRowIndex
        If _iRow < 0 Then Exit Sub

        Dim str As String
        Dim _Ten_Dm As String = "DMNhVT3"
        Dim _Nh_Vt3 As String = Dv_DetailTmp.Item(_iRow).Item("Nh_VT3")
        Dim strTen As String = ""
        str = GetList(_Ten_Dm, _Nh_Vt3, strTen)

        If str Is Nothing Then Exit Sub
        If str Is Nothing Then str = ""

        Dv_DetailTmp.Item(_iRow).BeginEdit()
        Dv_DetailTmp.Item(_iRow).Item("Nh_Vt3") = str
        Dv_DetailTmp.Item(_iRow).EndEdit()
...
#End Region
#Region "Nh_KH1"
    Private Sub V_Click_List_Nh_KH1(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If Not Dt_DetailTmp.Columns.Contains("Nh_KH1") Then Exit Sub
        Dim _iRow As Integer = -1
        _iRow = DetailGRV.GetFocusedDataSourceRowIndex
        If _iRow < 0 Then Exit Sub

        Dim str As String
        Dim _Ten_Dm As String = "DMNhKH1"
        Dim _Nh_KH1 As String = Dv_DetailTmp.Item(_iRow).Item("Nh_Kh1")
        Dim strTen As String = ""
        str = GetList(_Ten_Dm, _Nh_KH1, strTen)

        If str Is Nothing Then Exit Sub
        If str Is Nothing Then str = ""

        Dv_DetailTmp.Item(_iRow).BeginEdit()
        Dv_DetailTmp.Item(_iRow).Item("Nh_KH1") = str
        Dv_DetailTmp.Item(_iRow).EndEdit()
...
#End Region
#Region "Nh_KH2"
    Private Sub V_Click_List_Nh_KH2(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If Not Dt_DetailTmp.Columns.Contains("Nh_KH2") Then Exit Sub
        Dim _iRow As Integer = -1
        _iRow = DetailGRV.GetFocusedDataSourceRowIndex
        If _iRow < 0 Then Exit Sub

        Dim str As String
        Dim _Ten_Dm As String = "DMNhKH2"
        Dim _Nh_KH2 As String = Dv_DetailTmp.Item(_iRow).Item("Nh_Kh2")
        Dim strTen As String = ""
        str = GetList(_Ten_Dm, _Nh_KH2, strTen)

        If str Is Nothing Then Exit Sub
        If str Is Nothing Then str = ""

        Dv_DetailTmp.Item(_iRow).BeginEdit()
        Dv_DetailTmp.Item(_iRow).Item("Nh_KH2") = str
        Dv_DetailTmp.Item(_iRow).EndEdit()
...
#End Region
#Region "Nh_KH3"
    Private Sub V_Click_List_Nh_KH3(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If Not Dt_DetailTmp.Columns.Contains("Nh_KH3") Then Exit Sub
        Dim _iRow As Integer = -1
        _iRow = DetailGRV.GetFocusedDataSourceRowIndex
        If _iRow < 0 Then Exit Sub

        Dim str As String
        Dim _Ten_Dm As String = "DMNhKH3"
        Dim _Nh_KH3 As String = Dv_DetailTmp.Item(_iRow).Item("Nh_Kh3")
        Dim strTen As String = ""
        str = GetList(_Ten_Dm, _Nh_KH3, strTen)

        If str Is Nothing Then Exit Sub
        If str Is Nothing Then str = ""

        Dv_DetailTmp.Item(_iRow).BeginEdit()
        Dv_DetailTmp.Item(_iRow).Item("Nh_KH3") = str
        Dv_DetailTmp.Item(_iRow).EndEdit()
...
#End Region
#Region "Ma_Vv_i"
    Private Sub V_Click_List_Ma_Vv(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If Not Dt_DetailTmp.Columns.Contains("Ma_Vv_i") Then Exit Sub
        Dim _iRow As Integer = -1
        _iRow = DetailGRV.GetFocusedDataSourceRowIndex
        If _iRow < 0 Then Exit Sub

        Dim str As String
        Dim _Ten_Dm As String = "DMVV"
        Dim _Ma_Vv As String = Dv_DetailTmp.Item(_iRow).Item("Ma_Vv_i")
        Dim strTen As String = ""
        str = GetList(_Ten_Dm, _Ma_Vv, strTen)

        If str Is Nothing Then Exit Sub
        If str Is Nothing Then str = ""

        Dv_DetailTmp.Item(_iRow).BeginEdit()
        Dv_DetailTmp.Item(_iRow).Item("Ma_Vv_i") = str
        Dv_DetailTmp.Item(_iRow).EndEdit()
...
#End Region
#Region "Ma_TTLN_i"
    Private Sub V_Click_List_Ma_TTLN(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If Not Dt_DetailTmp.Columns.Contains("Ma_TTLN_i") Then Exit Sub
        Dim _iRow As Integer = -1
        _iRow = DetailGRV.GetFocusedDataSourceRowIndex
        If _iRow < 0 Then Exit Sub

        Dim str As String
        Dim _Ten_Dm As String = "DMTTLN"
        Dim _Ma_TTLN As String = Dv_DetailTmp.Item(_iRow).Item("Ma_TTLN_i")
        Dim strTen As String = ""
        str = GetList(_Ten_Dm, _Ma_TTLN, strTen)

        If str Is Nothing Then Exit Sub
        If str Is Nothing Then str = ""

        Dv_DetailTmp.Item(_iRow).BeginEdit()
        Dv_DetailTmp.Item(_iRow).Item("Ma_TTLN_i") = str
        Dv_DetailTmp.Item(_iRow).EndEdit()
...
#End Region
    Private Function GetList(ByVal Ten_DM As String, ByVal _List As String, ByRef _Ten As String) As String
        GetList = CyberSupport.V_GetStrSelectList(AppConn, osysvar, M_Para, "CP_GetListSelect", Ten_DM & "#" & _List & "#" & M_Ma_CT & "#" & M_Ma_Dvcs & "#" & M_User_Name, M_LAN, _Ten)
    End Function
#End Region
#Region "Vitri - "
...
#Region "Button"
    ...
    Private Sub V_Save_Luu(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        '----------------------------------------------------------------------------------------------------------------------
        ''If Not CyberSupport.V_ChkExistNovoucher(AppConn, osysvar, M_LAN, DrDmct, M_Mode, M_Stt_Rec, M_Ma_CT, _Ngay_Ct, _Ngay_LCt, M_Ma_Dvcs, M_User_Name, Cyber.SmLib.Sys) Then Exit Sub '---Kiem tra trung so chung tu
        '----------------------------------------------------------------------------------------------------------------------
    ...
    Private Function ChkVsave() As Boolean
        ...
        For iRow = nCount - 1 To 0 Step -1
            If Dt_DetailTmp.Rows(iRow).Item("Ma_So").ToString.Trim = "" Then
    ...
    End Function
    Private Sub V_tinhtoan(ByVal sender As System.Object, ByVal e As System.EventArgs)
...
#End Region
#Region "GetDetail"
    Private Sub V_GetDetail(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode.Trim = "M" Or M_Mode.Trim = "S") Then Exit Sub

        Dim nCount As Integer = 0
        Dim _Dt As Date = TxtNgay_Ct.Value
        Dim _Ma_GD As String = CbbMa_GD.SelectedValue.ToString.Trim
        Dim DsDetail As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetDetailKH7", M_Stt_Rec & "#" & M_Ma_CT & "#" & M_Mode & "#" & _Ma_GD.Trim & "##" & _Dt.ToString("yyyyMMdd") & "#" & M_Ma_Dvcs.Trim & "#" & M_User_Name.Trim)

        nCount = DsDetail.Tables.Count
        For i = 0 To nCount - 1
            CyberSmodb.SetNotNullTable(DsDetail.Tables(i))
        Next

        If Not CyberSupport.V_MsgChk(DsDetail.Tables(DsDetail.Tables.Count - 1), Me.SysVar, Me.Lan) Then
            DsDetail.Dispose()
        ...
        ' Insert vào detail
        Dt_DetailTmp.Rows.Clear()
        CyberSmodb.SQLTbToTb(DsDetail.Tables(0), Dt_DetailTmp)
        UpdateList()
