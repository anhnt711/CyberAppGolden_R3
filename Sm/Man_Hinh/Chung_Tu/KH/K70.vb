...
#End Region
    ...
    Private Sub K70_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        CreateTableMonth()
        V_Load()
        V_GetColumn()
        V_AddHandler()
...
#Region "Button"
    ...
    Private Function ChkDa_KH(ByVal _Mode) As Boolean
        ...
        Dim _Ma_GD As String = CbbMa_GD.SelectedValue
        Dim _Ngay_Ct As Date = TxtNgay_Ct.Value

        DsTmp = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_Chkkhns_K70", _Ma_GD & "#" & _StrDetail & "#" & _Mode & "#" & _ThangKh & "#" & _NamKh & "#" & M_Stt_Rec & "#" & TxtMa_Dvcs.Text & "#" & M_User_Name)
