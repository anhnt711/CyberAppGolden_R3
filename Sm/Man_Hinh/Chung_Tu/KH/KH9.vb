...
#Region "Columns Edit"
    ...
    Dim EditMa_Kx, EditTen_kx, EditMa_Mau, EditTen_Mau As New Cyber.Fill.CyberColumnGridView
    Dim EditTk_No, EditTk_Co, EditMa_Kh_N, EditMa_Kh_C As New Cyber.Fill.CyberColumnGridView
#End Region
...
#End Region
    Private Sub KH9_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        CreateTableMonth()
        V_Load()
        V_GetColumn()
        V_AddHandler()
...
#Region "V_AddHandler"
    ...
    Private Sub VisibleColumnMa_NT()
        If TxtMa_NT.Text.Trim = "" Or TxtMa_NT.Text.Trim.ToUpper = osysvar("M_Ma_NT0").ToString.Trim.ToUpper Then
            EditPs.Visible = False
            TxtT_Ps.Visible = False
        Else
            EditPs.Visible = True
            TxtT_Ps.Visible = True
        End If
...
#Region "Valid - Detail - Add On"
    ...
    Private Sub L_Ma_Kx(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If drReturn Is Nothing Then
            ...
            If iRows < 0 Then Exit Sub
            If Dt_DetailTmp.Rows(iRows)("Ma_kx") = "" Then
                If Not CyberSupport.V_NhapTiep(osysvar, M_LAN) Then
                    Dv_DetailTmp.Item(iRows).Delete()
                    Dv_DetailTmp.Table.AcceptChanges()
                    UpdateList()
                    SendKeys.Send("^{TAB}")
                End If
            ...
            Exit Sub
        End If
        Dt_DetailTmp.Rows(iRows)("Ma_kx") = drReturn("Ma_kx").ToString.Trim
        Dt_DetailTmp.Rows(iRows)("Ten_kx") = drReturn("Ten_kx").ToString.Trim
        Dt_DetailTmp.AcceptChanges()
    ...
    Private Sub L_Tk_No(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If drReturn Is Nothing Then
            iRows = DetailGRV.GetFocusedDataSourceRowIndex
            If iRows < 0 Then Exit Sub
            If Dt_DetailTmp.Rows(iRows)("Tk_No") = "" Then
                If Not CyberSupport.V_NhapTiep(osysvar, M_LAN) Then
                    Dv_DetailTmp.Item(iRows).Delete()
                    Dv_DetailTmp.Table.AcceptChanges()
                    UpdateList()
            ...
            Exit Sub
        End If
        Dt_DetailTmp.Rows(iRows)("Tk_No") = drReturn("Tk").ToString.Trim
        Dt_DetailTmp.Rows(iRows)("Ten_Tk_N") = drReturn("Ten_Tk").ToString.Trim
        Dt_DetailTmp.AcceptChanges()
        DetailGRV.UpdateCurrentRow()
    End Sub
    ...
    Private Sub L_Tk_Co(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        drReturn = CyberSupport.L_Lookup(M_Mode, M_Ma_CT, sender, True)
        If drReturn Is Nothing Then
            Dt_DetailTmp.Rows(iRows)("Tk_Co") = ""
            Dt_DetailTmp.AcceptChanges()
            Exit Sub
        End If
        Dt_DetailTmp.Rows(iRows)("Tk_Co") = drReturn("Tk").ToString.Trim
        Dt_DetailTmp.Rows(iRows)("Ten_Tk_C") = drReturn("Ten_Tk").ToString.Trim
        Dt_DetailTmp.AcceptChanges()
        DetailGRV.UpdateCurrentRow()
    End Sub
    ...
    Private Sub L_Ma_Kh_N(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        drReturn = CyberSupport.L_Lookup(M_Mode, M_Ma_CT, sender, True)
        If drReturn Is Nothing Then
            Dt_DetailTmp.Rows(iRows)("Ma_Kh_N") = ""
            Dt_DetailTmp.AcceptChanges()
            Exit Sub
        End If
        Dt_DetailTmp.Rows(iRows)("Ma_Kh_N") = drReturn("Ma_Kh").ToString.Trim
        Dt_DetailTmp.Rows(iRows)("Ten_Kh_N") = drReturn("Ten_Kh").ToString.Trim
        Dt_DetailTmp.AcceptChanges()
        DetailGRV.UpdateCurrentRow()
    End Sub
    ...
    Private Sub L_Ma_Kh_C(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        drReturn = CyberSupport.L_Lookup(M_Mode, M_Ma_CT, sender, True)
        If drReturn Is Nothing Then
            Dt_DetailTmp.Rows(iRows)("Ma_Kh_C") = ""
            Dt_DetailTmp.AcceptChanges()
            Exit Sub
        End If
        Dt_DetailTmp.Rows(iRows)("Ma_Kh_C") = drReturn("Ma_Kh").ToString.Trim
        Dt_DetailTmp.Rows(iRows)("Ten_Kh_C") = drReturn("Ten_Kh").ToString.Trim
        Dt_DetailTmp.AcceptChanges()
        DetailGRV.UpdateCurrentRow()
    End Sub
...
#Region "Button"
    ...
    Private Function ChkVsave() As Boolean
        ...
        For iRow = nCount - 1 To 0 Step -1
            If Dt_DetailTmp.Rows(iRow).Item("Tk_No").ToString.Trim = "" Then
    ...
    Private Sub V_View(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        'CyberSmlib.SQLExcuteStoreProcedure 
        V_Databing()
        V_SetEnabled(Me, M_Mode, Dt_Master)
        V_Setstatus()
    End Sub
