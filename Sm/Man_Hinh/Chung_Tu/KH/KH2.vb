...
#End Region
    Private Sub KH2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        CreateTableMonth()
        V_Load()
        V_GetColumn()
        V_AddHandler()
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_System()
        ...
        AddHandler CmdLoc_VT.Click, AddressOf V_Loc_VT
    End Sub
...
#Region "Valid - Detail - Core"
    Private Sub V_Loc_VT(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim _Ma_GD As String = CbbMa_GD.SelectedValue.ToString.Trim
        Dim _Thang As String = CbbThang.SelectedValue.ToString.Trim
        Dim _Nam As String = CbbNam.SelectedValue.ToString.Trim

        Dim Dstmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetKH2FromKH1PLS", _Ma_GD + "#" + _Thang + "#" + _Nam + "#" + M_Mode + "#" + M_Stt_Rec + "#" + M_Ma_CT + "#" + M_Ma_Dvcs + "#" + M_User_Name)
...
#Region "Sms - Import"
    ...
    Private Sub SetTxt()
        ...
        CmdLoc_VT.Enabled = M_Mode.Trim = "M"
    End Sub
#End Region
