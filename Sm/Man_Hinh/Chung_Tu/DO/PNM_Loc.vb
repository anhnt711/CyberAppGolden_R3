...
Public Class PNM_Loc
    ...
    Private Sub PNM_Loc_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Save_OK = False
        ...
        RemoveHandler CmdLoc_PNO.Click, AddressOf V_Loc
        ...
        AddHandler CmdLoc_PNO.Click, AddressOf V_Loc
        '------------------------------------------------------------------------------------
    ...
    Sub V_Loaddatatabase(ByVal _Type As String)
        ...
        Dim _DsTmp As DataSet = CyberInput.V_GetPNMFromPNO(AppConn, CyberSmlib, _Type, _Dt1.ToString("yyyyMMdd"), _Dt2.ToString("yyyyMMdd"), TxtLenh_PO.Text, TxtMa_Kh.Text, M_Stt_rec, M_ma_Ct, M_Ma_Dvcs, M_User_Name)
...
#Region "Grid..."
    ...
    Private Sub V_BilldtingRo(ByVal MasterGRV As DevExpress.XtraGrid.Views.Grid.GridView, ByVal Dv_Master As DataView, ByVal Dv_DetailTmp As DataView)
        ...
        If Not Dv_DetailTmp.Table.Columns.Contains("Stt_Rec_PNO") Then Exit Sub
        If Not Dv_Master.Table.Columns.Contains("Stt_Rec_PNO") Then Exit Sub
        ...
        Try
            ...
            If (Not String.IsNullOrEmpty(selectedRow("Stt_Rec_PNO").ToString)) Then
                filter = "Stt_Rec_PNO='" + selectedRow("Stt_Rec_PNO").ToString() + "'"
    ...
    Private Sub V_Master_Tag(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        _Stt_Rec = DvTable1.Item(iRow).Item("Stt_Rec_PNO")
    ...
    Private Sub V_Detail(ByVal status As Boolean, ByVal SttRec As String)
        ...
        For i = 0 To DtTable2.Rows.Count - 1
            If DtTable2.Rows(i).Item("Stt_Rec_PNO").ToString.Trim = SttRec.Trim Then
        ...
        For iRow = 0 To DvTable1.Count - 1
            If DvTable1.Item(iRow).Item("Tag").ToString.Trim = "True" Then
                For i = 0 To DvTable2.Count - 1
                    If DvTable2.Item(i).Item("Tag").ToString.Trim = "True" And DvTable2.Item(i).Item("Stt_Rec_PNO").ToString.Trim = DvTable1.Item(iRow).Item("Stt_Rec_PNO").ToString.Trim Then
        ...
        For i As Integer = 0 To DtTable1.Rows.Count - 1
            If DtTable1.Rows(i).Item("Tag").ToString.Trim.ToUpper = "1" Or DtTable1.Rows(i).Item("Tag").ToString.Trim.ToUpper = "TRUE" Then
                For j As Integer = 0 To DtTable2.Rows.Count - 1
                    If (DtTable2.Rows(j).Item("Tag").ToString.Trim.ToUpper = "1" Or DtTable2.Rows(j).Item("Tag").ToString.Trim.ToUpper = "TRUE") And DtTable2.Rows(j).Item("Stt_Rec_PNO").ToString.Trim = DtTable1.Rows(i).Item("Stt_Rec_PNO").ToString Then
