...
Public Class PNO_Loc
    ...
    Sub V_Loaddatatabase(ByVal _Type As String)
        ...
        Dim _DsTmp As DataSet = CyberInput.V_GetPNOFromPOD(AppConn, CyberSmlib, _Type, _Dt1.ToString("yyyyMMdd"), _Dt2.ToString("yyyyMMdd"), TxtLenh_PO.Text, TxtMa_Kh.Text, M_Stt_rec, M_ma_Ct, M_Ma_Dvcs, M_User_Name)
