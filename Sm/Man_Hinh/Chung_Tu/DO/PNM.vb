...
#End Region
    Private Sub PNM_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Master()
        ...
        AddHandler CmdLoc_PNO.Click, AddressOf V_Loc_POD
    End Sub
    ...
    Private Sub VisibleColumnMa_GD()
        If CbbMa_GD.SelectedValue.ToString.ToUpper = "1" Then
            ...
            CmdLoc_PNO.Enabled = False
        Else
            TxtLenh_PO.Enabled = False
            CmdLoc_PNO.Enabled = True
        End If
    End Sub
...
#Region "Lenh/SO/Po/Ro/Vt"
    ...
    Private Sub L_Lenh_Po(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim _DsTmp As DataSet = CyberInput.V_GetPNMFromPNO(AppConn, CyberSmlib, "1", "19000101", "19000101", TxtLenh_PO.Text, TxtMa_Kh.Text, M_Stt_Rec, M_Ma_CT, M_Ma_Dvcs, M_User_Name)
