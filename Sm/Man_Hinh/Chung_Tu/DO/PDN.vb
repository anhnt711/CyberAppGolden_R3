...
#Region "Columns Edit"
    ...
    Dim EditTen_Vt, EditDvt, EditTen_kho_i As New Cyber.Fill.CyberColumnGridView
#End Region
...
#Region "Lenh/SO/Po/Ro/Vt"
    ...
    Private Sub V_GetDetail(ByVal _Loai As String, ByVal _So As String)
        ...
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_RoGetPDN", _Loai & "#" & _So & "#" & M_Stt_Rec & "#" & M_Ma_Dvcs & "#" & M_User_Name)
