...
#Region "Columns Edit"
    ...
    Dim EditMa_ChucVu, EditTen_ChucVu, EditLoai_Duyet, EditTen_LoaiDuyet, EditLevel, EditDien_Giai As New Cyber.Fill.CyberColumnGridView
#End Region
...
#End Region
    Private Sub HMD_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#Region "Load And Set And Default"
    ...
    Private Sub V_LoadDmmaGD()
        ...
        Try
            M_Ma_GD = Dstmp.Tables(1).Rows(0).Item("Ma_GD")
    ...
    Private Sub V_GetColumn()
        EditLoai_Duyet.GetColumn(DetailGRV, "Loai_Duyet")
        EditMa_ChucVu.GetColumn(DetailGRV, "Ma_ChucVu")
        EditLevel.GetColumn(DetailGRV, "Level")
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Detail()
        ...
        EditLoai_Duyet.V_ActiLookUpColumn(AddressOf V_LoaiDuyet, AddressOf L_LoaiDuyet)
        If Not EditTen_ChucVu.Column Is Nothing Then EditTen_ChucVu.EditColumn.ReadOnly = True
        If Not EditTen_LoaiDuyet.Column Is Nothing Then EditTen_LoaiDuyet.EditColumn.ReadOnly = True
...
#Region "Loai DUyet"
    ...
    Private Sub L_LoaiDuyet(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If DrReturn Is Nothing Then
            Dv_DetailTmp.Item(iRow).BeginEdit()
            Dv_DetailTmp.Item(iRow).Item("Loai_Duyet") = ""
            Dv_DetailTmp.Item(iRow).Item("Ten_LoaiDuyet") = ""
            Dv_DetailTmp.Item(iRow).EndEdit()
            Exit Sub
        Else
            Dv_DetailTmp.Item(iRow).BeginEdit()
            Dv_DetailTmp.Item(iRow).Item("Loai_Duyet") = DrReturn("Ma_LoaiDuyet").ToString.Trim
            Dv_DetailTmp.Item(iRow).Item("Ten_LoaiDuyet") = DrReturn("Ten_LoaiDuyet").ToString.Trim
            Dv_DetailTmp.Item(iRow).EndEdit()
        End If
        Dv_DetailTmp.Table.AcceptChanges()
        DetailGRV.UpdateCurrentRow()
...
#Region "Button"
    ...
    Private Function ChkVsave() As Boolean
        ...
        For iRow = nCount - 1 To 0 Step -1
            If Dt_DetailTmp.Rows(iRow).Item("Ma_ChucVu").ToString.Trim = "" Then
