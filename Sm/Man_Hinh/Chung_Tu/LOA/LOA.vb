...
#Region "Khai bao bien Property----------------------"
    ...
    Dim Dt_Detail_Appro, Dt_Detail_ApproTmp, Dt_Detail_Attach, Dt_Detail_AttachTmp As New DataTable
    Dim Dv_Detail_Appro, Dv_Detail_ApproTmp, Dv_Detail_Attach, Dv_Detail_AttachTmp As New DataView
#End Region
...
#Region "Columns Edit"
    ...
    Dim EditTen_Vt, EditDvt, EditTen_Vt3, EditTen_kho_i, EditTen_Tk_VT, EditTen_Nx_I As New Cyber.Fill.CyberColumnGridView
    Dim EditGia_NT2, EditGia2, EditTien_NT2, EditTien2, EditTL_LN As New Cyber.Fill.CyberColumnGridView
    Dim EditAppMa_ChucVu, EditAppTen_ChucVu, EditAppMa_HS, EditAppTen_Hs, EditAppMa_HS_UQ, EditAppTen_HS_UQ, EditAppMa_Hs_Support, EditAppTen_Hs_Support, EditAppLoai_Duyet, EditAppTen_LoaiDuyet, EditAppLevel As New Cyber.Fill.CyberColumnGridView
    Dim EditAttFile_Name As New Cyber.Fill.CyberColumnGridView
#End Region
...
#End Region
    Private Sub LOA_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#Region "Load And Set And Default"
    Private Sub V_Load()
        ...
        'Appro
        Dt_Detail_Appro = M_DsData.Tables(2)
        Dt_Detail_ApproTmp = Dt_Detail_Appro.Clone
        'Attach
        Dt_Detail_Attach = M_DsData.Tables(3)
        Dt_Detail_AttachTmp = Dt_Detail_Attach.Clone
        ...
        'Appro
        Dv_Detail_Appro = New DataView(Dt_Detail_Appro)
        Dv_Detail_ApproTmp = New DataView(Dt_Detail_ApproTmp)
        'Attach
        Dv_Detail_Attach = New DataView(Dt_Detail_Attach)
        Dv_Detail_AttachTmp = New DataView(Dt_Detail_AttachTmp)
        ...
        Detail_Appro.DataSource = Dv_Detail_ApproTmp
        Me.DetailGRV_Appro.GridControl = Me.Detail_Appro
        CyberFill.V_FillVoucher(DetailGRV_Appro, M_LAN, New DataView(M_DsHead.Tables(2)), Dv_Detail_ApproTmp, Me.DrDmct)

        Detail_Attach.DataSource = Dv_Detail_AttachTmp
        Me.DetailGRV_Attach.GridControl = Me.Detail_Attach
        CyberFill.V_FillVoucher(DetailGRV_Attach, M_LAN, New DataView(M_DsHead.Tables(3)), Dv_Detail_AttachTmp, Me.DrDmct)
    ...
    Private Sub V_LoadDmmaGD()
        Dim Dstmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_LOALoadMa_GD", M_Ma_GD + "#" + M_Ma_CT + "#" + M_Ma_Dvcs + "#" + M_User_Name)
    ...
    Private Sub V_SetProperty()
        ...
        DetailGRV_Appro.OptionsNavigation.EnterMoveNextColumn = True
        Me.DetailGRV_Appro.Appearance.SelectedRow.BackColor = System.Drawing.Color.Brown

        DetailGRV_Attach.OptionsNavigation.EnterMoveNextColumn = True
        Me.DetailGRV_Attach.Appearance.SelectedRow.BackColor = System.Drawing.Color.Brown
    End Sub
    Private Sub V_GetColumn()
        EditMa_lo.GetColumn(DetailGRV, "Ma_Lo")
        EditMa_VT.GetColumn(DetailGRV, "Ma_VT")
        EditTen_Vt.GetColumn(DetailGRV, "Ten_VT")
        EditTen_Vt3.GetColumn(DetailGRV, "Ten_VT3")
        ...
        EditTL_LN.GetColumn(DetailGRV, "TL_LN")
        ...
        'Approve
        EditAppMa_ChucVu.GetColumn(DetailGRV_Appro, "Ma_ChucVu")
        EditAppMa_HS.GetColumn(DetailGRV_Appro, "Ma_Hs")
        EditAppMa_HS_UQ.GetColumn(DetailGRV_Appro, "Ma_Hs_UQ")
        EditAppMa_Hs_Support.GetColumn(DetailGRV_Appro, "Ma_Hs_Support")
        EditAppLoai_Duyet.GetColumn(DetailGRV_Appro, "Loai_Duyet")
        EditAppLevel.GetColumn(DetailGRV_Appro, "Level")

        EditAttFile_Name.GetColumn(DetailGRV_Attach, "File_name")
    End Sub
    Private Sub V_SetFocus(ByVal _Loai As String)
        _Loai = _Loai.Trim.ToUpper
        Select Case _Loai
            Case "M"
                If DrDmct.Item("M_Ngay_CT").ToString.Trim <> "1" Then TxtNgay_Ct.Focus() Else TxtSubject.Focus()
            Case "S"
                If DrDmct.Item("M_Ngay_CT").ToString.Trim <> "1" Then TxtNgay_Ct.Focus() Else TxtSubject.Focus()
            Case "L"
                CmdPrint.Select()
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_System()
        ...
        '---
        AddHandler DetailGRV_Appro.PopupMenuShowing, AddressOf MasterGRV_Appro_PopupMenuShowing
        AddHandler DetailGRV_Appro.KeyDown, AddressOf MasterGRV_Appro_KeyDown
        '---
        AddHandler DetailGRV_Attach.PopupMenuShowing, AddressOf MasterGRV_Attach_PopupMenuShowing
        AddHandler DetailGRV_Attach.KeyDown, AddressOf MasterGRV_Attach_KeyDown
        '---
        AddHandler CbbMa_GD.SelectedValueChanged, AddressOf L_Ma_GD

        AddHandler ChkIsBuget.CheckedChanged, AddressOf V_IsBuget
    End Sub
    ...
    Private Sub V_AddHandler_Detail()
        ...
        'Approve
        EditAppMa_ChucVu.V_ActiLookUpColumn(AddressOf V_Ma_ChucVu, AddressOf L_Ma_ChucVu)
        EditAppMa_HS.V_ActiLookUpColumn(AddressOf V_Ma_Hs, AddressOf L_Ma_Hs)
        EditAppMa_HS_UQ.V_ActiLookUpColumn(AddressOf V_Ma_Hs_UQ, AddressOf L_Ma_Hs_UQ)
        EditAppMa_Hs_Support.V_ActiLookUpColumn(AddressOf V_Ma_Hs_Support, AddressOf L_Ma_Hs_Support)
        EditAppLoai_Duyet.V_ActiLookUpColumn(AddressOf V_LoaiDuyet, AddressOf L_LoaiDuyet)

        RemoveHandler EditAttFile_Name.EditColumn.Click, AddressOf V_Attach
        AddHandler EditAttFile_Name.EditColumn.Click, AddressOf V_Attach
    End Sub
    ...
    Private Sub VisibleColumnMa_GD()
        If Not CbbMa_GD.SelectedValue.ToString = "04" Then
            Tab_Appro.TabPages.Remove(Tab_DN)
            Tab_Appro.TabPages.Insert(0, Tab_DN)

            TxtT_SO_LUONG.ReadOnly = True
            TxtT_Tien_NT.ReadOnly = True
        Else
            Tab_Appro.TabPages.Remove(Tab_DN)
            TxtT_SO_LUONG.ReadOnly = False
            TxtT_Tien_NT.ReadOnly = False
        End If
    End Sub
    Protected Overrides Sub V_Databing()
        ...
        Dt_Detail_ApproTmp.Clear()
        Dt_Detail_ApproTmp.AcceptChanges()

        For i = 0 To Dt_Detail_Appro.Select("Stt_Rec ='" + M_Stt_Rec.Trim + "'").Length - 1
            Dt_Detail_ApproTmp.ImportRow(Dt_Detail_Appro.Select("Stt_Rec ='" + M_Stt_Rec.Trim + "'")(i))
        Next

        Dt_Detail_AttachTmp.Clear()
        Dt_Detail_AttachTmp.AcceptChanges()

        For i = 0 To Dt_Detail_Attach.Select("Stt_Rec ='" + M_Stt_Rec.Trim + "'").Length - 1
            Dt_Detail_AttachTmp.ImportRow(Dt_Detail_Attach.Select("Stt_Rec ='" + M_Stt_Rec.Trim + "'")(i))
        Next
...
#Region "Lenh/SO/Po/Ro/Vt"
    ...
    End Sub
#End Region
    Private Sub V_IsBuget(ByVal sender As Object, ByVal e As EventArgs)
        V_Buget()
    End Sub
    Private Sub V_Buget()
        If ChkIsBuget.Checked = True Then
            TxtCodeBudget.Enabled = True
            TxtCodeBudget.ReadOnly = False
        Else
            TxtCodeBudget.Text = ""
            TxtCodeBudget.Enabled = False
            TxtCodeBudget.ReadOnly = True
        End If
    End Sub
#End Region
...
#Region "Valid - Detail - Core"
    ...
    Private Sub V_Tinh_Toan(ByVal iRow As Integer)
        ...
        If Dv_DetailTmp.Item(iRow).Item("Tien_NT") * Dv_DetailTmp.Item(iRow).Item("Tien_NT2") <> 0 Then
            Dv_DetailTmp.Item(iRow).BeginEdit()
            Dv_DetailTmp.Item(iRow).Item("TL_LN") = CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("Tien_NT2") / Dv_DetailTmp.Item(iRow).Item("Tien_NT") * 100, M_R_TIEN_NT)
            Dv_DetailTmp.Item(iRow).EndEdit()
        End If
        Dv_DetailTmp.Item(iRow).BeginEdit()
        '----------------
    ...
    Private Sub E_Dien_Giaii(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Dv_DetailTmp.Item(iRow).Item("Dien_Giaii").ToString.Trim = "" Then
            Dv_DetailTmp.Item(iRow).BeginEdit()
            Dv_DetailTmp.Item(iRow).Item("Dien_Giaii") = TxtBody.Text
            Dv_DetailTmp.Item(iRow).EndEdit()
        End If
...
#Region "Vat tu kho/Vitri - "
    ...
    Private Sub L_Ma_Vt(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Dv_DetailTmp.Item(iRow).Item("Ten_vt3").ToString.Trim = "" Then
            Dv_DetailTmp.Item(iRow).BeginEdit()
            Dv_DetailTmp.Item(iRow).Item("Ten_vt3") = DrReturn("Ten_VT").ToString.Trim
            Dv_DetailTmp.Item(iRow).EndEdit()
        End If
        Dv_DetailTmp.Table.AcceptChanges()
...
#End Region
#End Region
#Region "Valid - Approve"
#Region "Chuc vu"
    Private Sub V_Ma_ChucVu(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        CyberSupport.V_Lookup("Ma_ChucVu", "DmChucVu", "", "1=1", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_ChucVu(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        End If
        Dim iRow As Integer = -1
        iRow = DetailGRV_Appro.GetFocusedDataSourceRowIndex
        If iRow < 0 Then Exit Sub
        DrReturn = CyberSupport.L_Lookup(M_Mode, M_Ma_CT, sender, True)
        If DrReturn Is Nothing Then
            Dv_Detail_ApproTmp.Item(iRow).BeginEdit()
            Dv_Detail_ApproTmp.Item(iRow).Item("Ma_ChucVu") = ""
            Dv_Detail_ApproTmp.Item(iRow).Item("Ten_ChucVu") = ""
            Dv_Detail_ApproTmp.Item(iRow).EndEdit()
            Exit Sub
        Else
            Dv_Detail_ApproTmp.Item(iRow).BeginEdit()
            Dv_Detail_ApproTmp.Item(iRow).Item("Ma_ChucVu") = DrReturn("Ma_ChucVu").ToString.Trim
            Dv_Detail_ApproTmp.Item(iRow).Item("Ten_ChucVu") = DrReturn("Ten_ChucVu").ToString.Trim
            Dv_Detail_ApproTmp.Item(iRow).EndEdit()
        End If
        Dv_Detail_ApproTmp.Table.AcceptChanges()
        DetailGRV_Appro.UpdateCurrentRow()
...
#Region "Ds Nhan vien"
    Private Sub V_Ma_Hs(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        CyberSupport.V_Lookup("Ma_Hs", "DmHs", "", "1=1", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_Hs(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If DrReturn Is Nothing Then
            Dv_Detail_ApproTmp.Item(iRow).BeginEdit()
            Dv_Detail_ApproTmp.Item(iRow).Item("Ma_Hs") = ""
            Dv_Detail_ApproTmp.Item(iRow).Item("Ten_Hs") = ""
            Dv_Detail_ApproTmp.Item(iRow).Item("Email_Hs") = ""
            Dv_Detail_ApproTmp.Item(iRow).EndEdit()
            Exit Sub
        Else
            Dv_Detail_ApproTmp.Item(iRow).BeginEdit()
            Dv_Detail_ApproTmp.Item(iRow).Item("Ma_Hs") = DrReturn("Ma_Hs").ToString.Trim
            Dv_Detail_ApproTmp.Item(iRow).Item("Ten_Hs") = DrReturn("Ten_Hs").ToString.Trim
            If Dv_Detail_ApproTmp.Item(iRow).Item("Email_Hs").ToString.Trim() <> "" Then Dv_Detail_ApproTmp.Item(iRow).Item("Email_Hs") = DrReturn("Email").ToString.Trim
            Dv_Detail_ApproTmp.Item(iRow).EndEdit()
        End If
        Dv_Detail_ApproTmp.Table.AcceptChanges()
        DetailGRV_Appro.UpdateCurrentRow()
    End Sub
    Private Sub V_Ma_Hs_UQ(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        CyberSupport.V_Lookup("Ma_Hs", "DmHs", "", "1=1", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_Hs_UQ(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then
            Exit Sub
        End If
        ...
        If DrReturn Is Nothing Then
            Dv_Detail_ApproTmp.Item(iRow).BeginEdit()
            Dv_Detail_ApproTmp.Item(iRow).Item("Ma_Hs_UQ") = ""
            Dv_Detail_ApproTmp.Item(iRow).Item("Ten_Hs_UQ") = ""
            Dv_Detail_ApproTmp.Item(iRow).Item("Email_Hs_UQ") = ""
            Dv_Detail_ApproTmp.Item(iRow).EndEdit()
            Exit Sub
        Else
            Dv_Detail_ApproTmp.Item(iRow).BeginEdit()
            Dv_Detail_ApproTmp.Item(iRow).Item("Ma_Hs_UQ") = DrReturn("Ma_Hs").ToString.Trim
            Dv_Detail_ApproTmp.Item(iRow).Item("Ten_Hs_UQ") = DrReturn("Ten_Hs").ToString.Trim
            If Dv_Detail_ApproTmp.Item(iRow).Item("Email_Hs_UQ").ToString.Trim() <> "" Then Dv_Detail_ApproTmp.Item(iRow).Item("Email_Hs_UQ") = DrReturn("Email").ToString.Trim
            Dv_Detail_ApproTmp.Item(iRow).EndEdit()
        End If
        Dv_Detail_ApproTmp.Table.AcceptChanges()
        DetailGRV_Appro.UpdateCurrentRow()
    End Sub
    Private Sub V_Ma_Hs_Support(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        CyberSupport.V_Lookup("Ma_Hs", "DmHs", "", "1=1", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_Hs_Support(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then
            Exit Sub
        End If
        ...
        If DrReturn Is Nothing Then
            Dv_Detail_ApproTmp.Item(iRow).BeginEdit()
            Dv_Detail_ApproTmp.Item(iRow).Item("Ma_Hs_Support") = ""
            Dv_Detail_ApproTmp.Item(iRow).Item("Ten_Hs_Support") = ""
            Dv_Detail_ApproTmp.Item(iRow).Item("Email_Hs_Support") = ""
            Dv_Detail_ApproTmp.Item(iRow).EndEdit()
            Exit Sub
        Else
            Dv_Detail_ApproTmp.Item(iRow).BeginEdit()
            Dv_Detail_ApproTmp.Item(iRow).Item("Ma_Hs_Support") = DrReturn("Ma_Hs").ToString.Trim
            Dv_Detail_ApproTmp.Item(iRow).Item("Ten_Hs_Support") = DrReturn("Ten_Hs").ToString.Trim
            If Dv_Detail_ApproTmp.Item(iRow).Item("Email_Hs_Support").ToString.Trim() <> "" Then Dv_Detail_ApproTmp.Item(iRow).Item("Email_Hs_Support") = DrReturn("Email").ToString.Trim
            Dv_Detail_ApproTmp.Item(iRow).EndEdit()
        End If
        Dv_Detail_ApproTmp.Table.AcceptChanges()
        DetailGRV_Appro.UpdateCurrentRow()
...
#End Region
#Region "Loai DUyet"
    Private Sub V_LoaiDuyet(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        CyberSupport.V_Lookup("Ma_LoaiDuyet", "DmLoaiDuyet", "", "1=1", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_LoaiDuyet(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then
            Exit Sub
        End If
        ...
        If DrReturn Is Nothing Then
            Dv_Detail_ApproTmp.Item(iRow).BeginEdit()
            Dv_Detail_ApproTmp.Item(iRow).Item("Loai_Duyet") = ""
            Dv_Detail_ApproTmp.Item(iRow).Item("Ten_LoaiDuyet") = ""
            Dv_Detail_ApproTmp.Item(iRow).EndEdit()
            Exit Sub
        Else
            Dv_Detail_ApproTmp.Item(iRow).BeginEdit()
            Dv_Detail_ApproTmp.Item(iRow).Item("Loai_Duyet") = DrReturn("Ma_LoaiDuyet").ToString.Trim
            Dv_Detail_ApproTmp.Item(iRow).Item("Ten_LoaiDuyet") = DrReturn("Ten_LoaiDuyet").ToString.Trim
            Dv_Detail_ApproTmp.Item(iRow).EndEdit()
        End If
        Dv_Detail_ApproTmp.Table.AcceptChanges()
        DetailGRV_Appro.UpdateCurrentRow()
...
#Region "Mainform"
    ...
    End Function
#End Region
#Region "Mainform - Approve"
    Private Sub V_MainSystem_Appro()
        Dim mnItemsMail = New ContextMenu

        Dim mnItemsF4 As New MenuItem(If(M_LAN = "V", "Thêm dòng", "New row"), AddressOf V_ShortAddItem_Appro, Keys.F4)
        Dim mnItemsF8 As New MenuItem(If(M_LAN = "V", "Xóa dòng", "Delete row"), AddressOf V_ShortDeleteItem_Appro, Keys.F8)
        ...
        mnItemsMail.MenuItems.Add(mnItemsSave)
        mnItemsMail.MenuItems.Add(mnItemsPrint)
        DetailGRV_Appro.GridControl.ContextMenu = mnItemsMail
    End Sub
    Private Sub MasterGRV_Appro_PopupMenuShowing(ByVal sender As System.Object, ByVal e As DevExpress.XtraGrid.Views.Grid.PopupMenuShowingEventArgs)
        Dim rowHandle As Integer = e.HitInfo.RowHandle
        If e.MenuType <> DevExpress.XtraGrid.Views.Grid.GridMenuType.Column Then
            PopupMenuMasterGrid.ItemLinks.Clear()
            PopupMenuMasterGrid.ItemLinks.Add(New Cyber.SmLib.CyberMenuPopup(sender, rowHandle, IIf(Lan = "V", "Thêm dòng", "Add item"), AddressOf V_ShortAddItem_Appro, Nothing, True, False))
            PopupMenuMasterGrid.ItemLinks.Add(New Cyber.SmLib.CyberMenuPopup(sender, rowHandle, IIf(Lan = "V", "Xóa dòng", "Delete item"), AddressOf V_ShortDeleteItem_Appro, Nothing, True, False))
            PopupMenuMasterGrid.ItemLinks.Add(New Cyber.SmLib.CyberMenuPopup(sender, rowHandle, IIf(Lan = "V", "Import", "Delete item"), AddressOf V_Import, Nothing, True, True))
            PopupMenuMasterGrid.ItemLinks.Add(New Cyber.SmLib.CyberMenuPopup(sender, rowHandle, IIf(Lan = "V", "Lưu chứng từ", "Save"), AddressOf V_ShortSAVE, Nothing, True, True))
            PopupMenuMasterGrid.ShowPopup(Control.MousePosition)
        End If
    End Sub
    Private Sub V_ShortAddItem_Appro(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim iRow As Integer = DetailGRV_Appro.FocusedRowHandle
        V_AddItem_Appro(iRow)
    End Sub
    Private Sub V_ShortDeleteItem_Appro(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim iRow As Integer = DetailGRV_Appro.FocusedRowHandle
        If iRow < 0 Then Exit Sub
        If Not CyberSupport.V_DeleteItemVoucher(osysvar, M_LAN, M_Ma_CT, iRow, Dv_Detail_ApproTmp, AppConn, DetailGRV_Appro) Then Exit Sub
        Dv_Detail_ApproTmp.Delete(iRow)
        Dv_Detail_ApproTmp.Table.AcceptChanges()
        UpdateList()
    End Sub
#End Region
#Region "Mainform - Attach"
    Private Sub V_MainSystem_Attach()
        Dim mnItemsMail = New ContextMenu

        Dim mnItemsF4 As New MenuItem(If(M_LAN = "V", "Thêm dòng", "New row"), AddressOf V_ShortAddItem_Attach, Keys.F4)
        'Dim mnItemsF8 As New MenuItem(If(M_LAN = "V", "Xóa dòng", "Delete row"), AddressOf V_ShortDeleteItem_Attach, Keys.F8)
        ...
        mnItemsMail.MenuItems.Add(mnItemsSave)
        mnItemsMail.MenuItems.Add(mnItemsPrint)
        DetailGRV_Attach.GridControl.ContextMenu = mnItemsMail
    End Sub
    Private Sub MasterGRV_Attach_PopupMenuShowing(ByVal sender As System.Object, ByVal e As DevExpress.XtraGrid.Views.Grid.PopupMenuShowingEventArgs)
        Dim rowHandle As Integer = e.HitInfo.RowHandle
        If e.MenuType <> DevExpress.XtraGrid.Views.Grid.GridMenuType.Column Then
            PopupMenuMasterGrid.ItemLinks.Clear()
            PopupMenuMasterGrid.ItemLinks.Add(New Cyber.SmLib.CyberMenuPopup(sender, rowHandle, IIf(Lan = "V", "Thêm dòng", "Add item"), AddressOf V_ShortAddItem_Attach, Nothing, True, False))
            'PopupMenuMasterGrid.ItemLinks.Add(New Cyber.SmLib.CyberMenuPopup(sender, rowHandle, IIf(Lan = "V", "Xóa dòng", "Delete item"), AddressOf V_ShortDeleteItem_Attach, Nothing, True, False))
            PopupMenuMasterGrid.ItemLinks.Add(New Cyber.SmLib.CyberMenuPopup(sender, rowHandle, IIf(Lan = "V", "Import", "Delete item"), AddressOf V_Import, Nothing, True, True))
            PopupMenuMasterGrid.ItemLinks.Add(New Cyber.SmLib.CyberMenuPopup(sender, rowHandle, IIf(Lan = "V", "Lưu chứng từ", "Save"), AddressOf V_ShortSAVE, Nothing, True, True))
            PopupMenuMasterGrid.ShowPopup(Control.MousePosition)
        End If
    End Sub
    Private Sub V_ShortAddItem_Attach(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If M_Stt_Rec = "" Then Exit Sub
        Dim iRow As Integer = DetailGRV_Attach.FocusedRowHandle
        V_AddItem_Attach(iRow)
    End Sub
    Private Sub V_ShortDeleteItem_Attach(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If M_Stt_Rec = "" Then Exit Sub
        Dim iRow As Integer = DetailGRV_Attach.FocusedRowHandle
        If iRow < 0 Then Exit Sub
        'Check Rights
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_SysAttachRightVoucher", "DELETE" & "#" & M_Ma_CT & "#" & M_Stt_Rec & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        If Not CyberSupport.V_MsgChk(DsTmp.Tables(0), SysVar, M_LAN) Then
            DsTmp.Dispose()
            Exit Sub
        End If
        If Not CyberSupport.V_DeleteItemVoucher(osysvar, M_LAN, M_Ma_CT, iRow, Dv_Detail_AttachTmp, AppConn, DetailGRV_Attach) Then Exit Sub
        Dv_Detail_AttachTmp.Delete(iRow)
        Dv_Detail_AttachTmp.Table.AcceptChanges()
        UpdateList()
    End Sub
#End Region
#Region "Button"
    Private Sub V_Save(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Not CyberSmodb.V_SysCheckSaveVoucher(AppConn, osysvar, {Dt_DetailTmp, CyberSmodb.V_ConvertDrToTb(drMaster), Dt_Detail_ApproTmp}, {M_Ct, M_Ph, "CTLOA_APPRO"}, M_Mode, CbbMa_Post.SelectedValue.ToString.Trim, CbbMa_GD.SelectedValue, M_Ma_CT, M_Stt_Rec, M_LAN, TxtMa_Dvcs.Text, M_User_Name, CyberSmlib, CyberSupport, DsSave) Then
        ...
        '---Update Chi tiet
        If DsSave.Tables.Count >= 2 Then
            For iRow As Integer = 0 To DsSave.Tables(1).Rows.Count - 1
                Try
                    CyberSmodb.V_UpdateRowtoRow(DsSave.Tables(1).Rows(iRow), Dt_DetailTmp, iRow)
                Catch ex As Exception
                End Try
            Next
        End If
        If DsSave.Tables.Count >= 3 Then
            For iRow As Integer = 0 To DsSave.Tables(2).Rows.Count - 1
                If Dt_Detail_ApproTmp.Rows.Count < DsSave.Tables(2).Rows.Count Then
                    V_AddItem_Appro(iRow - 1)
                End If
                Try
                    CyberSmodb.V_UpdateRowtoRow(DsSave.Tables(2).Rows(iRow), Dt_Detail_ApproTmp, iRow)
                Catch ex As Exception
                End Try
            Next
        End If
        ...
        '---Xoa trong Detail
        If M_Mode.Trim = "S" Then CyberSmodb.DeleteDatatable(Dt_Detail_Appro, "Stt_Rec = '" + M_Stt_Rec + "'")
        Dt_Detail_Appro.Load(Dt_Detail_ApproTmp.CreateDataReader)
        '---Xoa trong Detail
        If M_Mode.Trim = "S" Then CyberSmodb.DeleteDatatable(Dt_Detail_Attach, "Stt_Rec = '" + M_Stt_Rec + "'")
        Dt_Detail_Attach.Load(Dt_Detail_AttachTmp.CreateDataReader)
        '----------------------------------------------------------------------------------------------------------------------
        M_Mode = "X"
        M_Count = Dt_Master.Rows.Count
        CyberMe.V_SetEnabled(Me, M_Mode, Dt_Master)
    ...
    Private Function ChkVsave() As Boolean
        ...
        nCount = Dt_Detail_ApproTmp.Rows.Count
        For iRow = nCount - 1 To 0 Step -1
            If Dt_Detail_ApproTmp.Rows(iRow).Item("Ma_HS").ToString.Trim = "" Then
                Dt_Detail_ApproTmp.Rows(iRow).Delete()
                Dt_Detail_ApproTmp.AcceptChanges()
            End If
        Next
        '---------------------------------------------------------------------------------
        ...
        '---------------------------------------------------------------------------------
        For iRow = 0 To Dt_Detail_ApproTmp.Rows.Count - 1
            Dt_Detail_ApproTmp.Rows(iRow).BeginEdit()
            Dt_Detail_ApproTmp.Rows(iRow).Item("Stt_Rec") = M_Stt_Rec
            Dt_Detail_ApproTmp.Rows(iRow).Item("Ma_Ct") = M_Ma_CT
            Dt_Detail_ApproTmp.Rows(iRow).Item("Ngay_Ct") = TxtNgay_Ct.Value
            Dt_Detail_ApproTmp.Rows(iRow).Item("So_Ct") = CyberSupport.V_soct(txtSo_ct.Text.Trim)
            Dt_Detail_ApproTmp.Rows(iRow).Item("Stt_Rec0") = CyberSupport.GetStt_Rec0(iRow + 1)
            Dt_Detail_ApproTmp.Rows(iRow).EndEdit()
        Next
        Dt_Detail_ApproTmp.AcceptChanges()
        'If Not CyberSupport.ChkDetail(Dv_Detail_ApproTmp.Count, M_Ma_CT, M_LAN, osysvar) Then Return False
        '---------------------------------------------------------------------------------
        For iRow = 0 To Dt_Detail_AttachTmp.Rows.Count - 1
            Dt_Detail_AttachTmp.Rows(iRow).BeginEdit()
            Dt_Detail_AttachTmp.Rows(iRow).Item("Stt_Rec") = M_Stt_Rec
            Dt_Detail_AttachTmp.Rows(iRow).Item("Ma_Ct") = M_Ma_CT
            Dt_Detail_AttachTmp.Rows(iRow).EndEdit()
        Next
        Dt_Detail_AttachTmp.AcceptChanges()
        'If Not CyberSupport.ChkDetail(Dv_Detail_AttachTmp.Count, M_Ma_CT, M_LAN, osysvar) Then Return False
    ...
    Private Sub V_New(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If TxtBody.Text.Trim = "" Then TxtBody.Text = M_Dien_Giai
        TxtNgay_Tao.Value = Now
        V_New()
        CyberMe.V_SetEnabled(Me, M_Mode, Dt_Master)
        V_Setstatus()
    ...
    Private Sub V_New()
        ...
        If Dt_Detail_ApproTmp.Rows.Count < 1 Then
            Dim DrCurren As DataRow
            Dt_Detail_ApproTmp.NewRow()
            DrCurren = Dt_Detail_ApproTmp.NewRow
            CyberSmodb.SetValueBlankRow(DrCurren)
            ...
            Dt_Detail_ApproTmp.Rows.Add(DrCurren)
            Dt_Detail_ApproTmp.AcceptChanges()
        End If

        If Dt_Detail_AttachTmp.Rows.Count < 1 Then
            Dim DrCurren As DataRow
            Dt_Detail_AttachTmp.NewRow()
            DrCurren = Dt_Detail_AttachTmp.NewRow
            CyberSmodb.SetValueBlankRow(DrCurren)

            DrCurren.Item("Stt_Rec") = M_Stt_Rec.Trim
            DrCurren.Item("Ma_Ct") = M_Ma_CT.Trim
            Dt_Detail_AttachTmp.Rows.Add(DrCurren)
            Dt_Detail_AttachTmp.AcceptChanges()
        End If
    End Sub
...
#Region "Add Or Detete Item"
    ...
    End Sub
#End Region
#Region "Add Or Detete Item Approve"
    Private Sub MasterGRV_Appro_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim iCoumnVisible As Integer = DetailGRV_Appro.VisibleColumns.Count - 1
        Dim iRowVisible As Integer = DetailGRV_Appro.RowCount - 1
        Dim iRowRowFocus As Integer = DetailGRV_Appro.FocusedRowHandle
        Dim iColumnRowFocus As Integer = DetailGRV_Appro.VisibleColumns.IndexOf(DetailGRV_Appro.FocusedColumn)
        Dim iRowOld As Integer = DetailGRV_Appro.GetFocusedDataSourceRowIndex
        'If e.KeyCode = Keys.Enter And iRowVisible = iRowRowFocus And iCoumnVisible = iColumnRowFocus Then V_AddItem(iRowOld) '' Cot cuoi cung them dong
        If iRowVisible <> iRowRowFocus Or iCoumnVisible <> iColumnRowFocus Then Exit Sub

        If e.KeyCode = Keys.Enter Then
            V_AddItem_Appro(iRowOld) '' Cot cuoi cung them dong
        ElseIf e.KeyCode = Keys.End Then
            SendKeys.Send("^{Tab}")
        End If
    End Sub
    Private Sub V_AddItem_Appro(Optional ByVal iRow As Integer = -1)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim DrvOld As DataRowView
        If iRow >= 0 Then DrvOld = Dv_Detail_ApproTmp.Item(iRow) Else DrvOld = Nothing
        Dv_Detail_ApproTmp.Table.Rows.Add()
        CyberSmodb.SetValueBlankRow(Dv_Detail_ApproTmp.Table.Rows(Dv_Detail_ApproTmp.Table.Rows.Count - 1))
        CyberSupport.SetCarryOn(DrvOld, Dv_Detail_ApproTmp.Table.Rows(Dv_Detail_ApproTmp.Table.Rows.Count - 1), New DataView(M_DsHead.Tables(2)))
        CarrOn(Dv_Detail_ApproTmp.Table.Rows(Dv_Detail_ApproTmp.Table.Rows.Count - 1))
        UpdateList()
        iRow = Dv_Detail_ApproTmp.Count - 1
        CyberFill.V_ForcusCell(DetailGRV_Appro, iRow, 0)
    End Sub
#End Region
#Region "Add Or Detete Item Attach"
    Private Sub MasterGRV_Attach_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim iCoumnVisible As Integer = DetailGRV_Attach.VisibleColumns.Count - 1
        Dim iRowVisible As Integer = DetailGRV_Attach.RowCount - 1
        Dim iRowRowFocus As Integer = DetailGRV_Attach.FocusedRowHandle
        Dim iColumnRowFocus As Integer = DetailGRV_Attach.VisibleColumns.IndexOf(DetailGRV_Attach.FocusedColumn)
        Dim iRowOld As Integer = DetailGRV_Attach.GetFocusedDataSourceRowIndex
        'If e.KeyCode = Keys.Enter And iRowVisible = iRowRowFocus And iCoumnVisible = iColumnRowFocus Then V_AddItem(iRowOld) '' Cot cuoi cung them dong
        If iRowVisible <> iRowRowFocus Or iCoumnVisible <> iColumnRowFocus Then Exit Sub

        If e.KeyCode = Keys.Enter Then
            V_AddItem_Attach(iRowOld) '' Cot cuoi cung them dong
        ElseIf e.KeyCode = Keys.End Then
            SendKeys.Send("^{Tab}")
        End If
    End Sub
    Private Sub V_AddItem_Attach(Optional ByVal iRow As Integer = -1)
        If (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If M_Stt_Rec = "" Then Exit Sub
        Dim DrvOld As DataRowView
        If iRow >= 0 Then DrvOld = Dv_Detail_AttachTmp.Item(iRow) Else DrvOld = Nothing
        Dv_Detail_AttachTmp.Table.Rows.Add()
        CyberSmodb.SetValueBlankRow(Dv_Detail_AttachTmp.Table.Rows(Dv_Detail_AttachTmp.Table.Rows.Count - 1))
        CyberSupport.SetCarryOn(DrvOld, Dv_Detail_AttachTmp.Table.Rows(Dv_Detail_AttachTmp.Table.Rows.Count - 1), New DataView(M_DsHead.Tables(3)))
        'CarrOn(Dv_Detail_AttachTmp.Table.Rows(Dv_Detail_AttachTmp.Table.Rows.Count - 1))
        UpdateList()
        iRow = Dv_Detail_AttachTmp.Count - 1
        CyberFill.V_ForcusCell(DetailGRV_Attach, iRow, 0)
    End Sub
#End Region
#Region "Sms - Import"
...
#End Region
#Region "Get Item Approve"
    Private Sub V_GetItemApprove()
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim iRow As Integer = -1
        iRow = DetailGRV_Appro.GetFocusedDataSourceRowIndex
        If iRow < 0 Then Exit Sub
        Dim _dt As DateTime = TxtNgay_Ct.Value
        Dim _Chuc_Vu As String = Dv_Detail_ApproTmp.Item(iRow).Item("Ma_ChucVu").ToString.Trim
        If _Chuc_Vu.Trim = "" Then Exit Sub
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_LOAGetItemApprove", M_Ma_CT & "#" & M_Mode & "#" & CbbMa_GD.SelectedValue.ToString.Trim & "#" & M_Stt_Rec & "#" & _dt.ToString("yyyyMMdd") & "#" & _Chuc_Vu & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        If Not CyberSupport.V_MsgChk(DsTmp.Tables(0), SysVar, M_LAN) Then
            DsTmp.Dispose()
            Exit Sub
        End If
        ...
        Dv_Detail_ApproTmp.Item(iRow).BeginEdit()
        Dv_Detail_ApproTmp.Item(iRow).Item("Ma_HS") = DsTmp.Tables(1).Rows(0).Item("Ma_HS").ToString.Trim
        Dv_Detail_ApproTmp.Item(iRow).Item("Ten_HS") = DsTmp.Tables(1).Rows(0).Item("Ten_HS").ToString.Trim
        Dv_Detail_ApproTmp.Item(iRow).Item("Email_HS") = DsTmp.Tables(1).Rows(0).Item("Email_HS").ToString.Trim
        Dv_Detail_ApproTmp.Item(iRow).Item("Ma_HS_UQ") = DsTmp.Tables(1).Rows(0).Item("Ma_HS_UQ").ToString.Trim
        Dv_Detail_ApproTmp.Item(iRow).Item("Ten_HS_UQ") = DsTmp.Tables(1).Rows(0).Item("Ten_HS_UQ").ToString.Trim
        Dv_Detail_ApproTmp.Item(iRow).Item("Email_HS_UQ") = DsTmp.Tables(1).Rows(0).Item("Email_HS_UQ").ToString.Trim
        Dv_Detail_ApproTmp.Item(iRow).Item("Ma_HS_Support") = DsTmp.Tables(1).Rows(0).Item("Ma_HS_Support").ToString.Trim
        Dv_Detail_ApproTmp.Item(iRow).Item("Ten_HS_Support") = DsTmp.Tables(1).Rows(0).Item("Ten_HS_Support").ToString.Trim
        Dv_Detail_ApproTmp.Item(iRow).Item("Email_HS_Support") = DsTmp.Tables(1).Rows(0).Item("Email_HS_Support").ToString.Trim
        Dv_Detail_ApproTmp.Item(iRow).EndEdit()
        Dv_Detail_ApproTmp.Table.AcceptChanges()
        DsTmp.Dispose()
    End Sub
...
#Region "Attach File"
    Private Sub V_Attach(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Dv_Detail_AttachTmp.Item(iRow).Item("File_Name").ToString.Trim <> "" Then Exit Sub
        '---------------------------------------------
        Dim Dt_Return As DataTable
        Dim Frm As New FrmAttachFile
        '---------------------------------------------
        Frm.Ma_CT = M_Ma_CT
        Frm.Stt_rec = M_Stt_Rec
        Frm.Row = iRow + 1
        ...
        Dt_Return = Frm.M_Dt_Return
        CyberSmodb.V_UpdateRowtoRow(Dt_Return.Rows(0), Dt_Detail_AttachTmp, iRow)
        Dt_Detail_AttachTmp.AcceptChanges()
    End Sub
#End Region
End Class
