...
#Region "Columns Edit"
    ...
    Dim EditMa_ChucVu, EditTen_ChucVu, EditMa_HS, EditTen_Hs, EditEmail_Hs, EditMa_HS_UQ, EditTen_HS_UQ, EditEmail_Hs_UQ, EditMa_Hs_Support, EditTen_Hs_Support, EditEmail_Hs_Support As New Cyber.Fill.CyberColumnGridView
#End Region
...
#End Region
    Private Sub CDD_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#Region "Load And Set And Default"
    ...
    Private Sub V_GetColumn()
        ...
        EditMa_HS_UQ.GetColumn(DetailGRV, "Ma_Hs_UQ")
        EditMa_Hs_Support.GetColumn(DetailGRV, "Ma_Hs_Support")
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Detail()
        ...
        EditMa_HS_UQ.V_ActiLookUpColumn(AddressOf V_Ma_Hs_UQ, AddressOf L_Ma_Hs_UQ)
        EditMa_Hs_Support.V_ActiLookUpColumn(AddressOf V_Ma_Hs_Support, AddressOf L_Ma_Hs_Support)
        If Not EditTen_ChucVu.Column Is Nothing Then EditTen_ChucVu.EditColumn.ReadOnly = True
        If Not EditTen_Hs.Column Is Nothing Then EditTen_Hs.EditColumn.ReadOnly = True
        'Add on
...
#Region "Chuc vu"
    ...
    Private Sub L_Ma_ChucVu(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If DrReturn Is Nothing Then
            ...
            Dv_DetailTmp.Item(iRow).Item("Ten_ChucVu") = ""
            Dv_DetailTmp.Item(iRow).EndEdit()
            Exit Sub
        Else
            Dv_DetailTmp.Item(iRow).BeginEdit()
            Dv_DetailTmp.Item(iRow).Item("Ma_ChucVu") = DrReturn("Ma_ChucVu").ToString.Trim
            Dv_DetailTmp.Item(iRow).Item("Ten_ChucVu") = DrReturn("Ten_ChucVu").ToString.Trim
            Dv_DetailTmp.Item(iRow).EndEdit()
        End If
...
#Region "Ds Nhan vien"
    ...
    Private Sub L_Ma_Hs(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If DrReturn Is Nothing Then
            Dv_DetailTmp.Item(iRow).BeginEdit()
            Dv_DetailTmp.Item(iRow).Item("Ma_Hs") = ""
            Dv_DetailTmp.Item(iRow).Item("Ten_Hs") = ""
            Dv_DetailTmp.Item(iRow).Item("Email_Hs") = ""
            Dv_DetailTmp.Item(iRow).EndEdit()
            Exit Sub
        Else
            Dv_DetailTmp.Item(iRow).BeginEdit()
            Dv_DetailTmp.Item(iRow).Item("Ma_Hs") = DrReturn("Ma_Hs").ToString.Trim
            Dv_DetailTmp.Item(iRow).Item("Ten_Hs") = DrReturn("Ten_Hs").ToString.Trim
            If Dv_DetailTmp.Item(iRow).Item("Email_Hs").ToString.Trim() <> "" Then Dv_DetailTmp.Item(iRow).Item("Email_Hs") = DrReturn("Email").ToString.Trim
            Dv_DetailTmp.Item(iRow).EndEdit()
        End If
        Dv_DetailTmp.Table.AcceptChanges()
        DetailGRV.UpdateCurrentRow()
    ...
    Private Sub L_Ma_Hs_UQ(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If DrReturn Is Nothing Then
            Dv_DetailTmp.Item(iRow).BeginEdit()
            Dv_DetailTmp.Item(iRow).Item("Ma_Hs_UQ") = ""
            Dv_DetailTmp.Item(iRow).Item("Ten_Hs_UQ") = ""
            Dv_DetailTmp.Item(iRow).Item("Email_Hs_UQ") = ""
            Dv_DetailTmp.Item(iRow).EndEdit()
            Exit Sub
        Else
            Dv_DetailTmp.Item(iRow).BeginEdit()
            Dv_DetailTmp.Item(iRow).Item("Ma_Hs_UQ") = DrReturn("Ma_Hs").ToString.Trim
            Dv_DetailTmp.Item(iRow).Item("Ten_Hs_UQ") = DrReturn("Ten_Hs").ToString.Trim
            If Dv_DetailTmp.Item(iRow).Item("Email_Hs_UQ").ToString.Trim() <> "" Then Dv_DetailTmp.Item(iRow).Item("Email_Hs_UQ") = DrReturn("Email").ToString.Trim
            Dv_DetailTmp.Item(iRow).EndEdit()
        End If
        Dv_DetailTmp.Table.AcceptChanges()
        DetailGRV.UpdateCurrentRow()
    ...
    Private Sub L_Ma_Hs_Support(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If DrReturn Is Nothing Then
            Dv_DetailTmp.Item(iRow).BeginEdit()
            Dv_DetailTmp.Item(iRow).Item("Ma_Hs_Support") = ""
            Dv_DetailTmp.Item(iRow).Item("Ten_Hs_Support") = ""
            Dv_DetailTmp.Item(iRow).Item("Email_Hs_Support") = ""
            Dv_DetailTmp.Item(iRow).EndEdit()
            Exit Sub
        Else
            Dv_DetailTmp.Item(iRow).BeginEdit()
            Dv_DetailTmp.Item(iRow).Item("Ma_Hs_Support") = DrReturn("Ma_Hs").ToString.Trim
            Dv_DetailTmp.Item(iRow).Item("Ten_Hs_Support") = DrReturn("Ten_Hs").ToString.Trim
            If Dv_DetailTmp.Item(iRow).Item("Email_Hs_Support").ToString.Trim() <> "" Then Dv_DetailTmp.Item(iRow).Item("Email_Hs_Support") = DrReturn("Email").ToString.Trim
            Dv_DetailTmp.Item(iRow).EndEdit()
        End If
        Dv_DetailTmp.Table.AcceptChanges()
        DetailGRV.UpdateCurrentRow()
...
#Region "Button"
    Private Sub V_Save(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        TxtNgay_HL.value = TxtNgay_Ct.Value
        '----------------------------------------------------------------------------------------------------------------------
