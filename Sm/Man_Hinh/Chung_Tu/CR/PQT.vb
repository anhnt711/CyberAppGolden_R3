...
#End Region
#Region "Columns Edit"
    Dim EditMa_Lo, EditTk_VT, EditMa_Nx_I As New Cyber.Fill.CyberColumnGridView
    Dim EditMa_Vt, EditMa_Vitri, EditMa_Kho_I, EditMa_Vv_I, EditMa_Phi_i, EditMa_HD_I, EditMa_SP_I, EditMa_Ku_I, EditMa_TTLN_i, EditMa_TTCP_i, EditMa_BP_I, EditMa_Hs_I, EditMa_CD_I, EditMa_TD1_I, EditMa_TD2_I, EditMa_TD3_I, EditMa_TD4_I, EditMa_TD5_I As New Cyber.Fill.CyberColumnGridView
    Dim Editma_Db_I, EditMa_Xe_I, EditMa_KX_I, EditMa_Tuyen_I, EditMa_Ts, EditMa_Cc As New Cyber.Fill.CyberColumnGridView
    Dim EditSo_Luong, EditGia_NT, EditGia, EditTien_NT, EditTien, EditSo_So, EditSo_Po, EditSo_Ro, EditSo_VT As New Cyber.Fill.CyberColumnGridView
#End Region
...
#End Region
    Private Sub PQT_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
        V_GetColumn()
        V_AddHandler()
        V_Databing()
...
#Region "Load And Set And Default"
    ...
    Private Sub V_Getdefault()
        ...
        M_Ma_Kho = M_Para(M_VT_PARA + 4).Trim
    ...
    Private Sub V_SetFocus(ByVal _Loai As String)
        ...
        Select Case _Loai
            Case "M"
                If DrDmct.Item("M_Ngay_CT").ToString.Trim <> "1" Then TxtNgay_Ct.Focus() Else TxtNgay_Ct.Focus()
            Case "S"
                If DrDmct.Item("M_Ngay_CT").ToString.Trim <> "1" Then TxtNgay_Ct.Focus() Else TxtNgay_Ct.Focus()
            Case "L"
                CmdPrint.Select()
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Master()
        ...
        'Ma_Xe
        AddHandler TxtMa_Xe_H.Leave, AddressOf V_Ma_Xe_H
        '----------------------------------------------------------------------------------------------------------
    ...
    Private Sub VisibleColumnMa_GD()
        ...
        If CmbMa_GD.SelectedValue.ToString.Trim = "4" Then
            _Visible = False
        End If
        EditMa_Xe_I.Visible = _Visible
    End Sub
...
#End Region
#Region "Ma_Xe_H"
    Private Sub V_Ma_Xe_H(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If TxtMa_Xe_H.Text.Trim = "" Then
            TxtTen_Lx.Text = ""
            TxtDT_LX.Text = ""
            Exit Sub
        End If
        TxtTen_Lx.Text = CyberSmodb.SQLGetvalue(AppConn, "Ten_Lx", "DmXe", "(Ma_Xe = N'" + TxtMa_Xe_H.Text.Trim + "' AND Ma_Dvcs ='" & M_Ma_Dvcs & "')", CyberSmlib)
        TxtDT_LX.Text = CyberSmodb.SQLGetvalue(AppConn, "Dt_Lx", "DmXe", "(Ma_Xe = N'" + TxtMa_Xe_H.Text.Trim + "' AND Ma_Dvcs ='" & M_Ma_Dvcs & "')", CyberSmlib)

        Dim Dstmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_ROHDKTinhDiem", TxtMa_Xe_H.Text + "#" + "" + "#" + "" + "#" + M_Stt_Rec + "#" + M_Ma_CT + "#" + TxtMa_Dvcs.Text + "#" + M_User_Name)
...
#Region "Lenh/SO/Po/Ro/Vt"
    Private Sub L_Lenh_So(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim _Dt As Date = TxtNgay_Ct.Value
        TxtLenh_SO.Text = CyberVoucher.V_FormatSo_So(AppConn, osysvar, M_Ma_CT, CmbMa_GD.SelectedValue, M_Mode, _Dt, TxtLenh_SO.Text, CbbMa_TTCP_H, M_Ma_Dvcs, M_User_Name, CyberSmlib)
    End Sub
    Private Sub L_Lenh_Po(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim _Dt As Date = TxtNgay_Ct.Value
        TxtLenh_PO.Text = CyberVoucher.V_FormatSo_PO(AppConn, osysvar, M_Ma_CT, CmbMa_GD.SelectedValue, M_Mode, _Dt, TxtLenh_PO.Text, CbbMa_TTCP_H, M_Ma_Dvcs, M_User_Name, CyberSmlib)
    End Sub
    Private Sub L_Lenh_Ro(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim _Dt As Date = TxtNgay_Ct.Value
        Txtlenh_Ro.Text = CyberVoucher.V_FormatSo_Ro(AppConn, SysVar, M_Ma_CT, CmbMa_GD.SelectedValue, M_Mode, _Dt, Txtlenh_Ro.Text, CbbMa_TTCP_H, M_Ma_Dvcs, M_User_Name, CyberSmlib)
    ...
    Private Sub L_Lenh_VT(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim _Dt As Date = TxtNgay_Ct.Value
        TxtLenh_Vt.Text = CyberVoucher.V_FormatSo_VT(AppConn, osysvar, M_Ma_CT, CmbMa_GD.SelectedValue, M_Mode, _Dt, TxtLenh_Vt.Text, CbbMa_TTCP_H, M_Ma_Dvcs, M_User_Name, CyberSmlib)
    End Sub
#End Region
#End Region
#Region "Valid - Detail"
#Region "Valid - Detail - Core"
    ...
    Private Sub V_Tinh_Toan(ByVal iRow As Integer)
        ...
        Dv_DetailTmp.Item(iRow).EndEdit()
        '----------------
        If Dv_DetailTmp.Item(iRow).Item("So_Luong") * Dv_DetailTmp.Item(iRow).Item("He_so1") <> 0 Then
            Dv_DetailTmp.Item(iRow).BeginEdit()
            Dv_DetailTmp.Item(iRow).Item("So_luong1") = Dv_DetailTmp.Item(iRow).Item("So_Luong") * Dv_DetailTmp.Item(iRow).Item("He_so1")
            Dv_DetailTmp.Item(iRow).EndEdit()
        End If
...
#Region "Vat tu kho/Vitri - "
    ...
    Private Sub V_Ma_Vt(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        CyberSupport.V_Lookup("Ma_Vt", "Dmvt", " Acti = 1 AND (Ma_kho LIKE '06%' OR Ma_kho LIKE '07%') ", "1=1", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_Vt(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dv_DetailTmp.Item(iRow).Item("Ma_kho_I") = M_Ma_Kho
        ...
        Dv_DetailTmp.Item(iRow).Item("he_so1") = DrReturn.Item("Hs_Qd")
        ...
        V_SetRowValue(iRow)
        ''---------------------------------------------------------------------------------------
        CyberSupport.V_UpdateTTLN_TTCP(AppConn, osysvar, M_Ma_CT, M_Mode, TxtMa_Dvcs.Text.Trim, M_User_Name, Dv_DetailTmp, iRow, DetailGRV, CyberSmlib, CyberSmodb)
    End Sub
    Private Sub V_SetRowValue(ByVal _i As Integer)
        ...
        CyberSmodb.GetValueData(Dv_DetailTmp.Item(_i), _strF, _strV, "Ten_Kx,Ten_mau")
        Dim Dstmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetDetailPQT", M_Stt_Rec + "#" + M_Ma_CT + "#" + M_Mode + "#" + _Ngay_Ct.ToString("yyyyMMdd") + "#" + _strF + "#" + _strV + "#" + TxtMa_Dvcs.Text + "#" + M_User_Name)
        ...
        CyberSmodb.V_UpdateRowtoRow(Dstmp.Tables(1).Rows(0), Dv_DetailTmp, _i)
        V_Tinh_Toan(_i)
        Dstmp.Dispose()
    End Sub
...
#Region "So_So/So_PO/So_RO/So_VT"
    Private Sub L_So_So(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If iRow < 0 Then Exit Sub
        Dim _Ngay_Ct As Date = TxtNgay_Ct.Value
        CyberVoucher.V_FormatSo_So(Dv_DetailTmp, iRow, AppConn, SysVar, M_Ma_CT, CmbMa_GD.SelectedValue, M_Mode, _Ngay_Ct, CbbMa_TTCP_H, M_Ma_Dvcs, M_User_Name, CyberSmlib)
    ...
    Private Sub L_So_Po(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If iRow < 0 Then Exit Sub
        Dim _Ngay_Ct As Date = TxtNgay_Ct.Value
        CyberVoucher.V_FormatSo_PO(Dv_DetailTmp, iRow, AppConn, SysVar, M_Ma_CT, CmbMa_GD.SelectedValue, M_Mode, _Ngay_Ct, CbbMa_TTCP_H, M_Ma_Dvcs, M_User_Name, CyberSmlib)
    End Sub
    Private Sub L_So_Ro(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If iRow < 0 Then Exit Sub
        Dim _Ngay_Ct As Date = TxtNgay_Ct.Value
        CyberVoucher.V_FormatSo_Ro(Dv_DetailTmp, iRow, AppConn, SysVar, M_Ma_CT, CmbMa_GD.SelectedValue, M_Mode, _Ngay_Ct, CbbMa_TTCP_H, M_Ma_Dvcs, M_User_Name, CyberSmlib)
    ...
    Private Sub L_So_VT(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If iRow < 0 Then Exit Sub
        Dim _Ngay_Ct As Date = TxtNgay_Ct.Value
        CyberVoucher.V_FormatSo_VT(Dv_DetailTmp, iRow, AppConn, SysVar, M_Ma_CT, CmbMa_GD.SelectedValue, M_Mode, _Ngay_Ct, CbbMa_TTCP_H, M_Ma_Dvcs, M_User_Name, CyberSmlib)
    End Sub
#End Region
#Region "Valid - Detail - Add On"
    ...
    Private Sub V_Ma_Xe_i(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        CyberSupport.V_Lookup("Ma_Xe", "DmXe", "1=1", "1=1", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_Xe_i(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If DrReturn Is Nothing Then
            Dv_DetailTmp.Item(iRow)("Ma_Xe_I") = ""
            Exit Sub
        End If

        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("Ma_Xe_I") = DrReturn("Ma_Xe").ToString.Trim        
        Dv_DetailTmp.Item(iRow).EndEdit()
    End Sub
...
#Region "Mainform"
    Private Sub V_MainSystem()
        ...
        Dim mnItemsF5 As New MenuItem("Chọn phiếu nhập", AddressOf V_ShortF5, Keys.F5)
...
#Region "Tích điểm"
    Private Sub V_Tra_Cuu(ByVal sender As System.Object, ByVal e As System.EventArgs)
        CyberSupport.V_Tra_Cuu_Diem(AppConn, Me.Para, osysvar, M_LAN, M_Ma_Dvcs, M_User_Name, TxtMa_Xe_H.Text, CyberSmlib, CyberFill, CyberSupport, CyberSmodb, CyberSmlistSys, CyberLoading)
    End Sub
#End Region
