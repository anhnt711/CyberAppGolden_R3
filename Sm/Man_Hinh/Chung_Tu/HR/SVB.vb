...
#End Region
#Region "Columns Edit"
    Dim EditMa_BP_I, EditMa_HS_I As New Cyber.Fill.CyberColumnGridView
#End Region
...
#Region "Ngay ct, ngay lap chung tu,so chung tu"
    ...
    Private Sub V_Until_Rep(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        V_VisibleUntil_Rep()
    End Sub
    Private Sub V_VisibleUntil_Rep()
        TxtNgay_HL2.Visible = ChkUntil_Rep.Checked
        LabHL2.Visible = ChkUntil_Rep.Checked
    End Sub
#End Region
#Region "Mainform"
...
#Region "Button"
    Private Sub V_Save(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        '----------------------------------------------------------------------------------------------------------------------
        '--- Save Dien_Giai
        Dim _strPara As New Dictionary(Of String, Object)
        _strPara.Clear()
        _strPara.Add("M_Stt_Rec", M_Stt_Rec)
        _strPara.Add("M_Ma_CT", M_Ma_CT)
        _strPara.Add("M_Dien_Giai", TxtDien_Giai.Text)
        _strPara.Add("M_Ma_Dvcs", M_Ma_Dvcs)
        _strPara.Add("M_User_Name", M_User_Name)

        CyberSmlib.SQLExcuteStoreProcedureFile(AppConn, "CP_SVBSaveDien_Giai", _strPara)
