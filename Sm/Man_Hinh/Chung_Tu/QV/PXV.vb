...
#Region "Columns Edit"
    ...
    Dim EditTen_Ve, EditTen_Nx_I, EditTen_Tk_VT, EditTen_kho_i, EditDvt, EditSo_Luong, EditSeri_dau, EditSeri_cuoi, EditGia_NT, EditGia, EditTien_NT, EditTien, EditDien_Giaii, EditSo_So, EditSo_Po, EditSo_Ro, EditSo_VT As New Cyber.Fill.CyberColumnGridView 'DevExpress.XtraEditors.Repository.RepositoryItemTextEdit
#End Region
...
#End Region
    Private Sub PXV_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#Region "Vat tu kho/Vitri - "
    ...
    Private Sub V_SetSD(ByVal iRow As Integer)
        ...
        'Dim _Return As DataRow = CyberSupport.V_SetSD(StatusFooter1, AppConn, "VT", M_Mode, _Ma_Ve, _Ma_kho, _Ma_Lo, M_Stt_Rec, M_Ma_CT, M_Ma_Dvcs, M_User_Name, CyberSmlib)
