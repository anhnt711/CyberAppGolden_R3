Public Class ROBHTHHDI
    Dim CyberMe As New Cyber.Reports.Sys
    Dim DrReturn As DataRow
    Dim DsLookup As DataSet
    Dim _Dt_GD, _Dt_post1, _Dt_post2, _GroupByTH, _GroupByCT As DataTable

    Private Sub ROBHTHHDI_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
#Region "Load"
    Private Sub V_Load()
        ...
        _DsGroup = Nothing
        _DsGroup = CyberSmLib.SQLExcuteStoreProcedure(AppConn, "CP_ROBHSupportTH_BH", "1" + "#" + "" + "#" + "" + "#" + "" + "#" + "" + "#" + Me.Ma_Dvcs + "#" + Me.User_Name)
...
#Region "Valid ---MA_HD_H"
    Private Sub V_Ma_HD_H(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        sender.V_LookUp(Me.LAN, Me.Para, Me.sysvar, AppConn, DsLookup, "Ma_HD", "DmHD", "1=1", "1=1")
    End Sub
...
#End Region
#Region "Valid ---MA_TT"
    Private Sub V_Ma_TT(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        sender.V_LookUp(Me.LAN, Me.Para, Me.sysvar, AppConn, DsLookup, "Ma_TT", "DmTT", "1=1", "1=1")
    End Sub
    Private Sub L_Ma_TT(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        DrReturn = sender.GetRowsSelectData(True)
        If Not DrReturn Is Nothing Then
...
#Region "Vali --- Ma_LHBH"
    ...
    Private Sub L_Ma_LHBH(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        ...
        DrReturn = sender.GetRowsSelectData(False)
        If Not DrReturn Is Nothing Then
            txtMa_LHBH.Text = DrReturn.Item("Ma_BH")
            txtTen_LHBH.Text = DrReturn.Item("Ten_BH")
        Else
            txtMa_LHBH.Text = ""
            txtTen_LHBH.Text = ""
        End If
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        M_strParameterStore = M_strParameterStore & "#" & txtMa_HD_H.Text.Trim
        M_strParameterStore = M_strParameterStore & "#" & txtMa_TT.Text.Trim
