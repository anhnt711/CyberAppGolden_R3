Public Class RO_DT01
    Dim CyberMe As New Cyber.Reports.Sys
    Dim _DtLoai_Phieu, _DtGroup, _DtGroupct, _DtMa_TT, _Dt_post1, _Dt_post2 As DataTable
...
#End Region
    Private Sub V_Load()
        ...
        Dim _DsGroup As DataSet = CyberSmLib.SQLExcuteStoreProcedure(AppConn, "CP_SysGetTHRO", "DT0" + "#" + "" + "#" + "" + "#" + Me.Ma_Dvcs + "#" + Me.User_Name)
