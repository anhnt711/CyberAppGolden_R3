Public Class ROHDKTH1
    Dim CyberMe As New Cyber.ReportsCustom.Sys
    Dim _Dt_GD, _Dt_post1, _Dt_post2, _DtMa_TT, _DtLoai_Phieu, _GroupByTH, _DtGroupct As DataTable
    ...
    Private Sub ROHDKTH1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
#End Region
    Private Sub V_Load()
        ...
        '--------------------------------------------------------------------------------------------------------------------------------------
        Dim _DsGroup As DataSet = CyberSmLib.SQLExcuteStoreProcedure(AppConn, "CP_SysGetTHRO", "ROHDKTH1" + "#" + "" + "#" + "" + "#" + "" + "#" + Me.Ma_Dvcs + "#" + Me.User_Name)
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        M_strParameterStore = M_strParameterStore & "#" & _Ma_CT_Filter + "#" + _Ma_GD_Filter
