Public Class RO_KPI_HQL
    ...
    Private Sub RO_KPI_HQL_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_AddMenuShorcut()
        ...
        ChkTheo_HDS.Checked = True
        ChkTheo_HDK.Checked = False
        V_Visible()
    End Sub
...
#Region "Load"
    ...
    Private Sub V_Addhander()
        ''---------------------------------------------------------------------------------------------------------------
        RemoveHandler ChkTheo_HDS.CheckedChanged, AddressOf V_Theo_HDS
        AddHandler ChkTheo_HDS.CheckedChanged, AddressOf V_Theo_HDS

        RemoveHandler ChkTheo_HDK.CheckedChanged, AddressOf V_Theo_HDK
        AddHandler ChkTheo_HDK.CheckedChanged, AddressOf V_Theo_HDK
    ...
    End Sub
#End Region
#Region "Hiệu quả lênh theo ngayf"
    Private Sub V_Theo_HDS(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ChkTheo_HDK.Checked = Not ChkTheo_HDS.Checked
        V_Visible()
    End Sub
    Private Sub V_Theo_HDK(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ChkTheo_HDS.Checked = Not ChkTheo_HDK.Checked
        V_Visible()
    End Sub
    Private Sub V_Visible()
        LabMa_Post_HDS1.Visible = ChkTheo_HDS.Checked
        LabMa_Post_HDS2.Visible = ChkTheo_HDS.Checked
        CbbMa_Post_HDS1.Visible = ChkTheo_HDS.Checked
        CbbMa_Post_HDS2.Visible = ChkTheo_HDS.Checked

        LabMa_Post_HDK1.Visible = Not ChkTheo_HDS.Checked
        LabMa_Post_HDK1.Visible = Not ChkTheo_HDS.Checked
        CbbMa_Post_HDK1.Visible = Not ChkTheo_HDS.Checked
        CbbMa_Post_HDK2.Visible = Not ChkTheo_HDS.Checked
    End Sub
#End Region
