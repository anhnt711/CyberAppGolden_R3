Public Class RO_HDK_KPI
    ...
    Private Sub RO_HDK_KPI_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_AddMenuShorcut()
...
#Region "Vali --- NH_VT4"
    ...
    Private Sub L_NH_VT4(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        ...
        If Not DrReturn Is Nothing Then
            ...
            TxtTen_nh_vt4.Text = DrReturn.Item("Ten_Nh")
        Else
            TxtNh_vt4.Text = ""
            TxtTen_nh_vt4.Text = ""
        End If
...
#Region "Vali --- NH_VT5"
    ...
    Private Sub L_NH_VT5(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        ...
        If Not DrReturn Is Nothing Then
            ...
            Txtten_nh_vt5.Text = DrReturn.Item("Ten_Nh")
        Else
            TxtNh_vt5.Text = ""
            Txtten_nh_vt5.Text = ""
        End If
...
#Region "Vali --- NH_cv1"
    Private Sub V_NH_cv1(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        sender.V_LookUp(Me.LAN, Me.Para, Me.sysvar, AppConn, DsLookup, "Ma_nh", "DmNhcv", "1=1", "Loai_Nh='1'")
    End Sub
...
#Region "Vali --- NH_cv2"
    Private Sub V_NH_cv2(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        sender.V_LookUp(Me.LAN, Me.Para, Me.sysvar, AppConn, DsLookup, "Ma_nh", "DmNhcv", "1=1", "Loai_Nh='2'")
    End Sub
...
#End Region
#Region "Vali --- NH_cv4"
    Private Sub V_NH_cv4(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        TxtNh_Cv4.V_LookUp(Me.LAN, Me.Para, Me.sysvar, AppConn, DsLookup, "Ma_NH", "DmNhcv", "1=1", "Loai_Nh='4'")
    End Sub
    Private Sub L_NH_cv4(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        ...
        If Not DrReturn Is Nothing Then
            ...
            TxtTen_nh_cv4.Text = DrReturn.Item("Ten_Nh")
        Else
            TxtNh_Cv4.Text = ""
            TxtTen_nh_cv4.Text = ""
        End If
...
#End Region
#Region "Vali --- NH_cv5"
    Private Sub V_NH_cv5(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        TxtNh_Cv5.V_LookUp(Me.LAN, Me.Para, Me.sysvar, AppConn, DsLookup, "Ma_NH", "DmNhcv", "1=1", "Loai_Nh='5'")
    End Sub
    Private Sub L_NH_cv5(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        ...
        If Not DrReturn Is Nothing Then
            ...
            TxtTen_nh_cv5.Text = DrReturn.Item("Ten_Nh")
        Else
            TxtNh_Cv5.Text = ""
            TxtTen_nh_cv5.Text = ""
        End If
