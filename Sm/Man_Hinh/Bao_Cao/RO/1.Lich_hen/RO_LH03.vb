...
#Region "Load"
    Private Sub V_Load()
        ...
        '--- Load CVDV
        Dim _DsCVDV As DataSet
        _DsCVDV = CyberSmLib.SQLExcuteStoreProcedure(AppConn, "CP_LoadCVDV", Me.Ma_Dvcs.Trim + "#" + Me.User_Name.Trim)
        For i As Integer = 0 To _DsCVDV.Tables.Count - 1
            CyberSmodb.SetNotNullTable(_DsCVDV.Tables(i))
        Next
        _DtCVDV = _DsCVDV.Tables(0)
        CyberFill.V_FillComBoxDefaul(Me.CmbMa_hs, _DtCVDV, "Ma_hs", "Ten_hs", "Ngam_Dinh")
        '----
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim M_Ma_CVDV_Filter As String = Me.CmbMa_hs.SelectedValue.ToString.Trim
        ...
        M_strParameterStore = M_strParameterStore & "#" & M_Ma_CVDV_Filter
