Public Class CRM_VOC01
    ...
    Private Sub CRM_VOC01_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_AddMenuShorcut()
        V_Load()
        V_GetData()
        V_Addhander()
...
#Region "Load"
    Private Sub V_Load()
        ...
        Dim _Str As String = "	SELECT * FROM (SELECT '' as Ma_GD,N'Toàn bộ' as ten_GD,N'Toàn bộ' as ten_GD2,'1' as Ngam_Dinh	UNION ALL(SELECT Ma_GD,Ten_GD,Ten_GD2,'0' as Ngam_Dinh FROM dbo.DmMaGD WHERE ma_ct = 'VOC')) as a ORDER BY a.ma_GD"
        ...
        CyberFill.V_FillComBoxDefaul(Me.CbbMa_GD, DtMaGD, "ma_GD", "Ten_GD", "Ngam_Dinh")
