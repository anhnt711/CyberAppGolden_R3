Public Class ARTTBK1
    Dim CyberMe As New Cyber.Reports.Sys
    Dim DrReturn As DataRow
    Dim DsLookup As DataSet
    Private Sub ARTTBK1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
        V_Addhander()
    End Sub
#Region "Load"
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim M_strParameterStore As String = Me.Para(Me.VT_PARA + 1) & "#" & TxtM_Tk_CN.Text.Trim.Replace("#", "")
        ...
        M_strParameterStore = M_strParameterStore & "#" & If(ChkIn_TT.Checked, "1", "0")
        M_strParameterStore = M_strParameterStore & "#" & If(ChkAuTo_PB.Checked, "1", "0")
