Public Class GLTC1
    ...
    Private Sub GLTC1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        DtDmMauBc = CyberSmodb.OpenTableKey(AppConn, _DsTmp, "DmMauBC", "FILE_MauBC", "Acti=N'1' AND Ma_mauBc =N'GLTC1'", CyberSmLib)
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim Dt2 As Date = TxtM_Ngay_Ct1.Value
        ...
        Dim M_strParameterStore As String = Dt2.ToString("yyyyMMdd")
        M_strParameterStore = M_strParameterStore & "#" & Dt1.ToString("yyyyMMdd")
