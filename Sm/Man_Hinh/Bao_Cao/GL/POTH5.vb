Public Class POTH5
    ...
    Dim _GroupByTH, _GroupByCT, _GroupByKy_BC, _GroupSoKy As DataTable
    Private Sub POTH5_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        _GroupSoKy = GetGroupSoKy()
...
#Region "Chi tiet theo"
    ...
    End Sub
#End Region
    Private Function GetGroupSoKy() As DataTable
        Dim _Return As New DataTable
        _Return.Columns.Add("So_KY")
        _Return.Columns.Add("Ten_ky")
        _Return.Columns.Add("Ten_Ky2")
        _Return.Columns.Add("Ngam_Dinh")
        _Return.Rows.Add("02", "02 Kỳ", "02 Periods", "0")
        _Return.Rows.Add("03", "03 kỳ", "03 Periods", "1")
        _Return.Rows.Add("04", "04 kỳ", "04 Periods", "0")
        _Return.Rows.Add("05", "05 kỳ", "05 Periods", "0")
        _Return.Rows.Add("05", "06 kỳ", "06 Periods", "0")
        _Return.Rows.Add("07", "07 kỳ", "07 Periods", "0")
        _Return.Rows.Add("08", "08 kỳ", "08 Periods", "0")
        _Return.Rows.Add("09", "09 kỳ", "09 Periods", "0")
        _Return.Rows.Add("10", "10 kỳ", "10 Periods", "0")
        _Return.Rows.Add("11", "11 kỳ", "11 Periods", "0")
        _Return.Rows.Add("12", "12 kỳ", "12 Periods", "0")
        GetGroupSoKy = _Return
    End Function
#Region "Load"
    Private Sub V_Load()
        CyberFill.V_FillComBoxDefaul(Me.CbbM_So_Ky, _GroupSoKy, "So_KY", If(Me.LAN = "V", "ten_ky", "ten_ky2"), "Default")

        Dim _DsGroup As New DataSet
        _DsGroup = CyberSmLib.SQLExcuteStoreProcedure(AppConn, "CP_SysGetTable", "DmkyBC#Acti = N'1'#ID")
        _GroupByKy_BC = _DsGroup.Tables(0).Copy
        CyberFill.V_FillComBoxDefaul(Me.CbbM_Ky_Theo, _GroupByKy_BC, "ID", If(Me.LAN = "V", "Title", "Title2"), "Default")

        _DsGroup = Nothing
        _DsGroup = CyberSmLib.SQLExcuteStoreProcedure(AppConn, "CP_SysGetTable", "SysNhapXuat#CP_NAME= N'MUA_BAN1' AND Acti = N'1'#ID")
        _DtLoai_Phieu = _DsGroup.Tables(0).Copy
        CyberFill.V_FillComBoxDefaul(Me.CbbLoai_Phieu, _DtLoai_Phieu, "Nhom", "Ten_nhom")

        _DsGroup = Nothing
        _DsGroup = CyberSmLib.SQLExcuteStoreProcedure(AppConn, "CP_SysGetTH", "" + "#" + "" + "#" + "" + "#" + "" + "#" + Me.Ma_Dvcs + "#" + Me.User_Name)
        ...
        If TxtMa_Lo.Text.Trim = "" Then TxtTen_lo.Text = "" Else TxtTen_lo.Text = CyberSmodb.SQLGetvalue(AppConn, "Ten_Lo", "DmLo", "(Ma_Lo= N'" + TxtMa_Lo.Text.Trim + "')", CyberSmLib)
...
#Region "Valid --- ma_NX"
    Private Sub V_ma_NX(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        TxtMa_Nx.V_LookUp(Me.LAN, Me.Para, Me.sysvar, AppConn, DsLookup, "Tk0", "Dmtk0", "1=1", "1=1")
    End Sub
    Private Sub L_Ma_NX(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        ...
        If Not DrReturn Is Nothing Then
            TxtMa_Nx.Text = DrReturn.Item("TK0")
            TxtTen_NX.Text = DrReturn.Item("Ten_Tk0")
        Else
            TxtMa_Nx.Text = ""
            TxtTen_NX.Text = ""
            Exit Sub
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        M_strParameterStore = M_strParameterStore & "#" & CyberMe.V_GetValueCombox(CbbM_So_Ky)
        M_strParameterStore = M_strParameterStore & "#" & CyberMe.V_GetValueCombox(CbbM_Ky_Theo)
        M_strParameterStore = M_strParameterStore & "#" & Dt.ToString("yyyyMMdd")
        ...
        M_strParameterStore = M_strParameterStore & "#" & TxtMa_Nx.Text.Trim
