Public Class GLTH1DETAIL
    Dim CyberMe As New Cyber.Reports.Sys
    Private Sub GLTH1DETAIL_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_AddMenuShorcut()
        V_Load()
        V_Addhander()
    End Sub
#Region "Load"
    Private Sub V_Load()
        ...
        TxtM_Tk_Du.Text = CyberSmLib.GetKeyValueRegistry(Me.sysvar, TxtM_Tk_Du)
        '----
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim M_strParameterStore As String = TxtM_Tk_Du.Text.Trim.Replace("#", "")
