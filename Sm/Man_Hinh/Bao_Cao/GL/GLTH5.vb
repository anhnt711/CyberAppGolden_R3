Public Class GLTH5
    ...
    Dim Dt_Phatsinh As New DataTable
    Private Sub GLTH5_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dt_Phatsinh.Columns.Add("Ma")
        Dt_Phatsinh.Columns.Add("Ten")
        Dt_Phatsinh.Columns.Add("Ten2")
        Dt_Phatsinh.Columns.Add("Default")
        Dt_Phatsinh.Rows.Add("1", "Phát sinh nợ", "Phát sinh nợ", "1")
        Dt_Phatsinh.Rows.Add("2", "Phát sinh có", "Phát sinh có", "0")
        CyberFill.V_FillComBoxDefaul(CbbPhat_Sinh, Dt_Phatsinh, "Ma", IIf(Me.LAN = "V", "Ten", "Ten2"), "Default")
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        End If
        '-----------------------------------------------------------------------------
        Dim _Ps As String = CbbPhat_Sinh.SelectedValue.ToString.Trim
        ...
        M_strParameterStore = M_strParameterStore & "#" & _Ps
