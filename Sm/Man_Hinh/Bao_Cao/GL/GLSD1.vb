Public Class GLSD1
    ...
    Private Sub GLSD1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_AddMenuShorcut()
        V_Load()
        V_Addhander()
    End Sub
#Region "Load"
    Private Sub V_Load()
        ...
        If Me.Para(Me.VT_PARA + 1).Trim().ToUpper = "CP_GLSD2" Then
            TxtM_Tk.Text = Me.Para(Me.VT_PARA + 3)
        End If
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim M_strParameterStore As String = TxtM_Tk.Text.Trim
