Public Class INSD3
    ...
    Dim _DtGroupByKho As DataTable
    Private Sub INSD3_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_AddMenuShorcut()
        _DtGroupBy = GetGroupBy()
        _DtGroupByKho = GetGroupBykho()
        V_Load()
        V_Addhander()
    End Sub
#Region "Load"
    Private Function GetGroupBy() As DataTable
        ...
        GetGroupBy = _Return
    End Function
    Private Function GetGroupBykho() As DataTable
        Dim _Return As New DataTable
        _Return.Columns.Add("Loai_GB")
        _Return.Columns.Add("Ten_GB")
        _Return.Columns.Add("Ten_GB2")
        _Return.Columns.Add("Ngam_Dinh")
        _Return.Rows.Add("1", "Chi tiết theo kho hàng gửi bán", "Detailed consignment warehouse", "1")
        _Return.Rows.Add("2", "Gộp theo kho hàng gửi bán", "Group consignment warehouse ", "0")
        GetGroupBykho = _Return
    End Function
    Private Sub V_Load()
        CyberFill.V_FillComBoxDefaul(Me.cbbTinh_dc, _DtGroupBy, "Tinh_dc", "Ten_DC", "Ngam_Dinh")
        CyberFill.V_FillComBoxDefaul(Me.cbbloai_gd, GetGroupBykho, "Loai_GB", "Ten_GB", "Ngam_Dinh")
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim M_strParameterStore As String = TxtMa_kho.Text.Trim
        M_strParameterStore = M_strParameterStore & "#" & TxtMa_Vt.Text.Trim
        M_strParameterStore = M_strParameterStore & "#" & Dt2.ToString("yyyyMMdd").Trim
        ...
        M_strParameterStore = M_strParameterStore & "#" & cbbloai_gd.SelectedValue.ToString.Trim
