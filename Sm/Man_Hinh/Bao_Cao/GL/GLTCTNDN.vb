Public Class GLTCTNDN
    ...
    Private Sub GLTCTNDN_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        DtDmMauBc = CyberSmodb.OpenTableKey(AppConn, _DsTmp, "DmMauBC", "FILE_MauBC", "Acti=N'1' AND Ma_mauBc LIKE 'GLTCTNDN%'", CyberSmLib)
