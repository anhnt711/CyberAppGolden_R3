Public Class GLNKBK01
    Dim CyberMe As New Cyber.Reports.Sys
    Dim DrReturn As DataRow
    Dim DsLookup As DataSet
    Private Sub GLNKBK01_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
#Region "Load"
    Private Sub V_Load()
        ...
        TxtM_Tk.Text = Me.Para(Me.VT_PARA + 2).Trim.ToString.Trim
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        M_strParameterStore = M_strParameterStore & "#" & Me.Para(Me.VT_PARA + 3)
