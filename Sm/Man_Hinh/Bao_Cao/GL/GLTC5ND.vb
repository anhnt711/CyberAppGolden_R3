Public Class GLTC5ND
    Dim CyberMe As New Cyber.Reports.Sys
    Dim DtThang, DtNam As DataTable
    Dim DtDmMauBc As DataTable
    Dim _DsTmp As DataSet
    Private Sub GLTC5ND_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        DtThang = CyberSmodb.OpenTableKey(AppConn, _DsTmp, "Dmthang", "Id_Date", "1=1", CyberSmLib)
        DtNam = CreateTableYear()
        DtDmMauBc = CyberSmodb.OpenTableKey(AppConn, _DsTmp, "DmMauBC", "FILE_MauBC", "Acti=N'1' AND Ma_mauBc =N'GLTC5'", CyberSmLib)
        ''---------------------------------------------
