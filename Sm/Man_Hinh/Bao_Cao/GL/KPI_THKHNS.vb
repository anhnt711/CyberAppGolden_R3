Public Class KPI_THKHNS
    Dim DtThang1, DtThang2, DtNam As DataTable
    Dim CyberMe As New Cyber.Reports.Sys
    Dim _Mau_BC As String = ""

    Private Sub KPI_THKHNS_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_AddMenuShorcut()
        Dim M_VT_PARA As Integer = CType(Me.Para(0).Trim, Integer)
        Try
            _Mau_BC = Me.Para(M_VT_PARA + 2).Trim
        Catch ex As Exception

        End Try
        Try
            ChkIs_TH.Checked = (Me.Para(M_VT_PARA + 3).Trim = "1")
        Catch ex As Exception
        End Try
        Try
            ChkIs_LK.Checked = (Me.Para(M_VT_PARA + 4).Trim = "1")
        Catch ex As Exception
        End Try
        V_Load()
        V_Addhander()
...
#Region "Load"
    ...
    Private Sub V_Addhander()
        ...
        RemoveHandler ChkIs_LK.CheckedChanged, AddressOf V_Is_LK

        AddHandler ButtOK.Click, AddressOf V_Nhan
        AddHandler ButtExit.Click, AddressOf V_Exit
        AddHandler ChkIs_LK.CheckedChanged, AddressOf V_Is_LK
    End Sub
    Private Sub V_Is_LK(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim _is_Lk As Boolean = False
        If ChkIs_LK.Checked Then _is_Lk = True
        CbbM_Thang1.Enabled = Not _is_Lk
        If _is_Lk Then
            Try
                CbbM_Thang1.SelectedValue = "1"
            Catch ex As Exception

            End Try
            Try
                CbbM_Thang1.SelectedValue = "01"
            Catch ex As Exception
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        '-----------------------------------------------------------------------------
        Dim _Is_TH As String = "0"
        Dim _Is_LK As String = "0"
        If ChkIs_TH.Checked Then _Is_TH = "1"
        If ChkIs_LK.Checked Then _Is_LK = "1"

        Dim M_Ma_Dvcs_Filter As String = Me.CBBMa_Dvcs.SelectedValue.ToString.Trim
        Dim M_strParameterStore As String = _Mau_BC & "#" & _Is_TH & "#" & _Is_LK
