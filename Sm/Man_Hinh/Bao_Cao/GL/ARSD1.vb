Public Class ARSD1
    ...
    Private Sub ARSD1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
        V_Addhander()
    End Sub
#Region "Load"
    Private Sub V_Load()
        ...
        Try
            TxtM_Tk_CN.Text = Me.Para(Me.VT_PARA + 3).ToString.Trim
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        M_strParameterStore = M_strParameterStore & "#" & Me.Para(Me.VT_PARA + 2)
