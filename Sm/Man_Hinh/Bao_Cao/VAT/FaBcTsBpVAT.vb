Public Class FaBcTsBpVAT
    ...
    Dim _DtThang, _DtNam, _DtDauCuoiThang As DataTable

    Private Sub FaBcTs_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        _DtDauCuoiThang = GetTbSoLieu()
        _DtThang = CreateTableMonth()
        _DtNam = CreateTableYear()
...
#Region "Load"
    Private Sub V_Load()
        ...
        '----Set
        CyberFill.V_FillComBoxDefaul(Me.CbbMau_Bc, _DtDauCuoiThang, "Mau_BC", IIf(Me.LAN = "V", "Ten_Mau", "Ten_Mau2"), "Default")
        CyberFill.V_FillComBoxDefaul(CbbM_Thang, _DtThang, "Thang", IIf(Me.LAN = "V", "Ten_Thang", "Ten_Thang2"), "Default")
        CyberFill.V_FillComBoxDefaul(CbbM_Nam, _DtNam, "Nam", IIf(Me.LAN = "V", "Ten_Nam", "Ten_nam2"), "Default")
        '----
    ...
    End Sub
    Public Function GetTbSoLieu() As DataTable
        Dim _Return As New DataTable
        _Return.Columns.Add("Mau_BC")
        _Return.Columns.Add("Ten_Mau")
        _Return.Columns.Add("Ten_Mau2")
        _Return.Columns.Add("Default")
        _Return.Rows.Add("1", "Số liệu đầu tháng", "Begin month", "0")
        _Return.Rows.Add("2", "Số liệu cuối tháng", "End month", "1")
        GetTbSoLieu = _Return
    End Function
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        M_strParameterStore = M_strParameterStore & "#" & CbbMau_Bc.SelectedValue.ToString.Trim
