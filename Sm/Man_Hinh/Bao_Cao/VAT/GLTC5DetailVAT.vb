Public Class GLTC5DetailVAT
    Dim CyberMe As New Cyber.Reports.Sys
    Dim DrReturn As DataRow
    Dim DsLookup As DataSet
    Private Sub GLTC5Detail_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ChkM_GROUP.Checked = True
        ChkM_goup1.Checked = True
        V_Load()
        V_Addhander()
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        M_strParameterStore = M_strParameterStore & "#" & If(ChkM_goup1.Checked, "1", "0")
