Public Class GLSO1TTCP
    Dim CyberMe As New Cyber.Reports.Sys
    Dim DrReturn As DataRow
    Dim DsLookup As DataSet
    Private Sub GLSO1TTCP_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ChkM_GROUP_TK.Checked = True
        ChkM_Group_TTCP.Checked = True
        ChkM_Group_TTLN.Checked = True
        V_Load()
        V_Addhander()
    End Sub
#Region "Load"
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        M_strParameterStore = M_strParameterStore & "#" & If(ChkM_GROUP_TK.Checked, "1", "0")
        M_strParameterStore = M_strParameterStore & "#" & If(ChkM_Group_TTLN.Checked, "1", "0")
        M_strParameterStore = M_strParameterStore & "#" & If(ChkM_Group_TTCP.Checked, "1", "0")
