Public Class IMTH3
    ...
    Dim _Tag2 As String = ""
    Private Sub IMTH3_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
...
#Region "Load"
    Private Sub V_Load()
        ...
        If _Tag2 = "" Then
            _DsGroup = CyberSmLib.SQLExcuteStoreProcedure(AppConn, "CP_SysGetTable", "SysNhapXuat#CP_NAME= N'LOAI_PHIEUCC" & Me.Para(Me.VT_PARA + 2).ToString.Trim & "' AND Acti = '1'#ID")
        Else
            _DsGroup = CyberSmLib.SQLExcuteStoreProcedure(AppConn, "CP_SysGetTable", "SysNhapXuat#CP_NAME= N'LOAI_PHIEUCC" & _Tag2 & "' AND Acti = '1'#ID")
        End If
        ...
        _DsGroup = Nothing
        _DsGroup = CyberSmLib.SQLExcuteStoreProcedure(AppConn, "CP_SysGetTHCC", "" + "#" + "" + "#" + "" + "#" + "" + "#" + Me.Ma_Dvcs + "#" + Me.User_Name)
