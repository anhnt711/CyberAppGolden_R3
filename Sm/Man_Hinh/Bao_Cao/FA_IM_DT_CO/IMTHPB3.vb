Public Class IMTHPB3
    ...
    Private Sub IMTHPB3_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_AddMenuShorcut()
        V_Load()
        V_Addhander()
    End Sub
#Region "Load"
    Private Sub V_Load()
        ...
        _DsGroup = CyberSmLib.SQLExcuteStoreProcedure(AppConn, "CP_SysGetTHCC", "CP_IMTHPB_TH" + "#" + "CP_IMTHPB_CT" + "#" + "" + "#" + "" + "#" + Me.Ma_Dvcs + "#" + Me.User_Name)
...
#End Region
    ...
    Private Sub TxtTen_Td2_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtTen_Td2.TextChanged
