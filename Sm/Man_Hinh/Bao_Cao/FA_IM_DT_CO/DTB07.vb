Public Class DTB07
    ...
    Private Sub DTB07_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
#Region "Load"
    ...
    Private Sub V_Load()
        ...
        _DsGroup = CyberSmLib.SQLExcuteStoreProcedure(AppConn, "CP_SysGetTable", "DMMauBC#Ma_MauBC= N'DTB07'#Ma_MauBC")
