Public Class BEHDXTH1_DT
    ...
    Private Sub BEHDXTH1_DT_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
#Region "Load"
    Private Sub V_LoadDate()
        ...
        Dim _Thang1 As Integer = Now.Date.Month
        Dim _Nam1 As Integer = Now.Date.Year

        Dim _Date1 As Date = Now.Date
