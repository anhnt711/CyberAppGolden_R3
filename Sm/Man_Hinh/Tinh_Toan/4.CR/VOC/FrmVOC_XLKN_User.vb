...
Public Class FrmVOC_XLKN_User
    ...
    Private Sub ROXPTFilter_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'AddHandler txtDien_giai.KeyDown, AddressOf EnterasTab
    ...
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Me.Save_OK = True
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_VOC_XLKN_ChangeUser", Stt_rec & "#" & Stt_rec0 & "#" & TxtMa_Hs.Text & "#" & M_Ma_Dvcs & "#" & M_User_Name.Trim)
