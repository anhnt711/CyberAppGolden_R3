...
Public Class IMBTPBCC
    ...
    Private Sub FABTPBTS_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        V_AddHandler()
        If Not Me.Para Is Nothing Then Me.Text = Me.Para(11).Trim
    ...
    Private Sub V_LoadDatabase(ByVal Status)
        ...
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_IMBTPBCC", Status & "#" & _Thang & "#" & _Nam & "#" & M_Ma_Dvcs & "#" & M_User_Name)
...
#End Region
    ...
    Private Sub V_DeleteBT(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Not MsgBox("Bạn có muốn xóa bút toán phân bổ công cụ dụng cụ tháng " + _Thang + " năm " + _Nam, MsgBoxStyle.Critical + MsgBoxStyle.OkCancel, Me.Sysvar("M_CYBER_VER")) = MsgBoxResult.Ok Then Exit Sub

        Dim _Title As String = "Đang thực hiện xoá bút toán phân bổ công cụ dụng cụ"
        Dim _Title2 As String = "Deleting tool budget allocations"


        If Not CyberLoading.IsShowWaitFrom Then CyberLoading.V_ShowWailtForm(_Title, _Title2, Me.Lan)
        Dim _DsDelete As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_IMBTDelete", "X#" & _Thang & "#" & _Nam & "#" & M_Ma_Dvcs & "#" & M_User_Name)
    ...
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Not MsgBox("Bạn có muốn tạo bút toán hạch toán phân bổ công cụ dụng cụ: tháng " + _Thang + " năm " + _Nam, MsgBoxStyle.Information + MsgBoxStyle.OkCancel, Me.Sysvar("M_CYBER_VER")) = MsgBoxResult.Ok Then Exit Sub

        Dim _Title As String = "Đang thực hiện tạo bút toán phân bổ công cụ dụng cụ"
        Dim _Title2 As String = "Ongoing creation of toolkits budget"



        If Not CyberLoading.IsShowWaitFrom Then CyberLoading.V_ShowWailtForm(_Title, _Title2, Me.Lan)
        '--Xoa truoc khi tao
        Dim _DsDelete As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_IMBTDelete", "S#" & _Thang & "#" & _Nam & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        ...
        For i As Integer = 0 To Dt_Master.Rows.Count - 1
            ...
            _DsCreate = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_IMBTCREATE", (i + 1).ToString.Trim & "#" & _strField & "#" & _strValue & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        Next
        If CyberLoading.IsShowWaitFrom Then CyberLoading.V_CloseWailtForm()
