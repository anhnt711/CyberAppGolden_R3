Public Class IMDcCcF3
    ...
    Protected Overrides Sub V_GetValueParameter()
        ...
        '----------------------------
    End Sub
    Private Sub IMDcCcF3_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Save_OK = False
    ...
    Private Sub V_Load()
        ...
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_ImDcCc2Loc", _Mode + "#" + _Ngay_Dc.ToString("yyyyMMdd") + "#" + _Ma_Cc + "#" + _Stt_Rec0 + "#" + _Stt_Rec + "#" + M_Ma_Dvcs + "#" + M_User_Name)
    ...
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim DsChk As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_IMDcCcChk", "" + "#" + _Mode + "#" + _Ngay_Dc.ToString("yyyyMMdd") + "#" + _Ma_Cc + "#" + _Stt_Rec0 + "#" + _Stt_Rec + "#" + M_Ma_Dvcs + "#" + M_User_Name)
        ...
        If _Mode = "S" Then
            ...
            _StrDelete = "Ma_Cc = N'" + _Ma_Cc + "' AND Stt_Rec = N'" + _Stt_Rec + "' AND Stt_Rec0 = N'" + _Stt_Rec0 + "' AND Ngay_Dc = N'" + _Ngay_DcOld.ToString("yyyyMMdd") + "'"
        Else
            _StrDelete = "1=0"
        End If
        ...
        CyberSmodb.V_SaveToSQL(AppConn, Sysvar, M_User_Name, _Dr, "CTDCCC", Me.Mode, _StrDelete, IIf(Me.Mode.Trim = "S", True, False))
        '---------------------------------------------------------------------------------------
        '---Lay Lai
        Dim _DsSave As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_IMDcCCloc", "0#" & _Stt_Rec & "#" & _Stt_Rec0 & "#" & _Ma_Cc & "#" & "" & "#" & "" & "#" & "" & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        '---------------------------------------------------------------------------------------
