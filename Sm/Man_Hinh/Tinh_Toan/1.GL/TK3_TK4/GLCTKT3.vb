...
Public Class GLCTKT3
    ...
    Private Sub FGLCTKT3_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
#Region "V_AddHandler"
    ...
    Private Sub V_CreateBT(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim _DsChk As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_ChkKT3", "D" & "#" & _thang1 & "#" & _thang2 & "#" & _Nam & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        ...
        For i = 0 To Dt_Master.Rows.Count - 1
            ...
            _DsTmp = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GLCTKT3", Dt_Master.Rows(i).Item("Stt").ToString.Trim & "#" & _thang1 & "#" & _thang2 & "#" & _Nam & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        Next
    ...
    Private Sub V_DeleteBT(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        For i = 0 To Dt_Master.Rows.Count - 1
            If Not Dt_Master.Rows(i).Item("Tag") Then Continue For
            _DsTmp = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GLCTKT3DELETE", "Y" & "#" & Dt_Master.Rows(i).Item("Stt").ToString.Trim & "#" & _thang1 & "#" & _thang2 & "#" & _Nam & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        Next
        If Not _DsTmp Is Nothing Then If _DsTmp.Tables.Count > 0 Then If _DsTmp.Tables(0).Columns.Contains("status") Then CyberSupport.V_MsgChk(_DsTmp.Tables(0), Me.Sysvar, Me.Lan)
