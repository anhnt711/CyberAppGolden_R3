...
Public Class GLCTKT4
    ...
    Private Sub FGLCTKT4_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
#Region "V_AddHandler"
    ...
    Private Sub V_CreateBT(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim _DsChk As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_ChkKT4", "D" & "#" & _thang1 & "#" & _thang2 & "#" & _Nam & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        ...
        For i = 0 To Dt_Master.Rows.Count - 1
            ...
            _DsTmp = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GLCTKT4", Dt_Master.Rows(i).Item("Stt_rec").ToString.Trim & "#" & _thang1 & "#" & _thang2 & "#" & _Nam & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        Next
    ...
    Private Sub V_DeleteBT(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        For i = 0 To Dt_Master.Rows.Count - 1
            If Not Dt_Master.Rows(i).Item("Tag") Then Continue For
            _DsTmp = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GLCTKT4DELETE", "Y" & "#" & Dt_Master.Rows(i).Item("Stt_rec").ToString.Trim & "#" & _thang1 & "#" & _thang2 & "#" & _Nam & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        Next
        If Not _DsTmp Is Nothing Then If _DsTmp.Tables.Count > 0 Then If _DsTmp.Tables(0).Columns.Contains("status") Then CyberSupport.V_MsgChk(_DsTmp.Tables(0), Me.Sysvar, Me.Lan)
...
#Region "Dieu chinh So_Ct/HeSo"
    Private Sub V_F3(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim FrmF3 As GLCTKT4_F3
        FrmF3 = New GLCTKT4_F3
        FrmF3.Lan = Me.Lan
        FrmF3.Para = Me.Para
        FrmF3.Sysvar = Me.Sysvar
        FrmF3.AppConn = Me.AppConn
    ...
    Private Sub V_F31(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim FrmF3 As GLCTKT4_F31
        FrmF3 = New GLCTKT4_F31
        FrmF3.Lan = Me.Lan
        FrmF3.Para = Me.Para
        FrmF3.Sysvar = Me.Sysvar
        FrmF3.AppConn = Me.AppConn
