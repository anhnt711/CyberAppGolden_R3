...
Public Class FATgNgXem
    ...
    Private Sub FATgNgXem_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
#Region "Load data"
    ...
    Private Sub V_Tang_Giam_F8(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim _DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_FaTgNgDelete", _Ma_Nv & "#" & _Stt0 & "#" & _Ma_Ts & "#" & Me.M_Ma_Dvcs & "#" & Me.M_User_Name)
