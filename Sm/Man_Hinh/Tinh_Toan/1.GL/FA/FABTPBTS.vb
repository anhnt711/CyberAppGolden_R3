...
Public Class FABTPBTS
    ...
    Private Sub V_LoadDatabase(ByVal Status)
        ...
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_FABTPBTS", Status & "#" & _Thang & "#" & _Nam & "#" & M_Ma_Dvcs & "#" & M_User_Name)
...
#End Region
    ...
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Not CyberLoading.IsShowWaitFrom Then CyberLoading.V_ShowWailtForm(_Title, _Title2, Me.Lan)
        '--Xoa truoc khi tao
        Dim _DsDelete As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_FaBTDelete", "S#" & _Thang & "#" & _Nam & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        ...
        For i As Integer = 0 To Dt_Master.Rows.Count - 1
            ...
            _DsCreate = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_FaBTCREATE", (i + 1).ToString.Trim & "#" & _strField & "#" & _strValue & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        Next
        If CyberLoading.IsShowWaitFrom Then CyberLoading.V_CloseWailtForm()
