Public Class FAGiamTsF3
    ...
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_FaGiamTsUpdate", _Ngay_Ct.ToString("yyyyMMdd") + "#" + If(ChkGiam_Ts.Checked, "1", "0") + "#" + _ma_Ts + "#" + _ma_NV + "#" + _Stt0 + "#" + TxtMa_Giam.Text + "#" + txtSo_ct.Text.Trim + "#" + txtLy_do.Text.Trim + "#" + M_Ma_Dvcs + "#" + M_User_name)
