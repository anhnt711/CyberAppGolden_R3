Public Class FASuaKHF3VAT
    ...
    Private Sub FASuaKHF3VAT_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Save_OK = False
    ...
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_FaSuaKhUpdateVAT", _Ngay_Ct.ToString("yyyyMMdd") + "#" + If(ChkSua_Kh.Checked, "1", "0") + "#" + TxtGt_kh.Double.ToString.Trim.Replace(" ", "").Replace(",", ".") + "#" + _ma_Ts + "#" + _ma_NV + "#" + _Stt0 + "#" + M_Ma_Dvcs + "#" + M_User_Name)
