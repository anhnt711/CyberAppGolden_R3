...
#Region "Load data"
    ...
    Private Sub V_F3(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Select Case Cp_Loc.Trim.ToUpper
            Case "CP_FASUAKHLOCVAT".ToUpper.Trim
                Dim FrmF3 As New FASUAKHF3VAT
                FrmF3.Lan = Me.Lan
                FrmF3.Para = Me.Para
                ...
                _Drv = FrmF3.Drv
            Case "CP_FATHOIKHLOCVAT".ToUpper.Trim
                ...
                If Not FrmF3.Save_OK Then Exit Sub
                _Drv = FrmF3.Drv
            Case "CP_FAGIAMTSLOCVAT".ToUpper.Trim
                Dim FrmF3 As New FAGiamTsF3VAT
                FrmF3.Lan = Me.Lan
                FrmF3.Para = Me.Para
                FrmF3.Sysvar = Me.Sysvar
                FrmF3.AppConn = Me.AppConn
                ...
                If Not FrmF3.Save_OK Then Exit Sub
                _Drv = FrmF3.Drv
            Case "CP_FADCTSLOCVAT".ToUpper.Trim
                Dim FrmF3 As New FADcTsF3VAT
                FrmF3.Mode = "S"
                FrmF3.Lan = Me.Lan
                FrmF3.Para = Me.Para
                FrmF3.Sysvar = Me.Sysvar
