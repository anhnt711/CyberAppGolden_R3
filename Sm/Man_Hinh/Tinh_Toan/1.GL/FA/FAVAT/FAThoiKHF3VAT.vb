Public Class FAThoiKHF3VAT
    ...
    Private Sub FAThoiKHF3VAT_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Save_OK = False
    ...
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_FaThoiKhUpdateVAT", _Ngay_Ct.ToString("yyyyMMdd") + "#" + If(ChkThoi_Kh.Checked, "1", "0") + "#" + _ma_Ts + "#" + _ma_NV + "#" + _Stt0 + "#" + txtLy_do.Text.Trim.Replace("'", "").Replace("#", "") + "#" + M_Ma_Dvcs + "#" + M_User_Name)
