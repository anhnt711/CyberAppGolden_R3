Public Class FaTgNgF3VAT
    ...
    Private Sub V_Load()
        ...
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_FaTgNGlocVAT", "0" & "#" & _Ma_Nv & "#" & _Stt0 & "#" & _Ma_TS & "#" & "#" & "#" & "#" & M_Ma_Dvcs & "#" & M_User_Name)
    ...
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim DsUpdate As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_FATGNGUPDATEVAT", Loai_TG.Trim + "#" + _Mode + "#" + _StrField + "#" + _StrValue + "#" + M_Ma_Dvcs + "#" + M_User_Name)
