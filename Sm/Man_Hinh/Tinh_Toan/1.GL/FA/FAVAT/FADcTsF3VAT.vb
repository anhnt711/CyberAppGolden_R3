Public Class FADcTsF3VAT
    ...
    Private Sub V_Load()
        ...
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_FaDcTs2LocVAT", _Mode + "#" + _Ngay_Dc.ToString("yyyyMMdd") + "#" + _Ma_TS + "#" + _Stt0 + "#" + _Ma_Nv + "#" + M_Ma_Dvcs + "#" + M_User_Name)
    ...
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim DsChk As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_FaDcTsChkVAT", "" + "#" + _Mode + "#" + _Ngay_Dc.ToString("yyyyMMdd") + "#" + _Ma_TS + "#" + _Stt0 + "#" + _Ma_Nv + "#" + M_Ma_Dvcs + "#" + M_User_Name)
        ...
        CyberSmodb.V_SaveToSQL(AppConn, Sysvar, M_User_Name, _Dr, "CTDCTSVAT", Me.Mode, _StrDelete, IIf(Me.Mode.Trim = "S", True, False))
        '---------------------------------------------------------------------------------------
        '---Lay Lai
        Dim _DsSave As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_FaDcTslocVAT", "0#" & _Ma_Nv & "#" & _Stt0 & "#" & _Ma_TS & "#" & "" & "#" & "" & "#" & "" & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        '---------------------------------------------------------------------------------------
