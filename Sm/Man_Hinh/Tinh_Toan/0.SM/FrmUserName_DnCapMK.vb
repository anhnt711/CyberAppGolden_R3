Public Class FrmUserName_DnCapMK
#Region "AddProperty"
...
#End Region
    ...
    Private Sub FrmUserName_DnCapMK_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Save_OK = False
        V_Addhander()
        V_Load()
    ...
    Private Sub V_Load()
        ...
        '--------------------------------------------------------------------
        Dim Dstmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_SmUserDNCapMK_F3", M_Stt_Rec + "#" + M_Mode + "#" + M_Ma_Dvcs + "#" + M_User_Name)
        ...
        If M_Mode = "M" Then
            ...
            Me.Text = "Tạo mới đề nghị cấp mật khẩu"
        Else
            Me.Text = "Sửa đề nghị cấp mật khẩu"
        End If
...
#End Region
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Me.Tag = M_Stt_Rec
        Dim _Str As String = "SELECT TOP 0 * FROM dbo.DmDNCapMK WHERE 1=0"
        ...
        '------------
        Dim _Xml As String = CyberSmodb.V_ConvertDataToXML({"DmDNCapMK"}, {DtMaster})
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_SmUserDNCapMK_Save", TxtStt_Rec.Text + "#" + M_Mode + "#" + _Xml + "#" + M_Ma_Dvcs + "#" + M_User_Name)
