Public Class FrmUserName_DnDongTK
#Region "AddProperty"
    ...
    End Property
#End Region
    Dim DtDvcs, DtPost As DataTable
    Dim DrReturn As DataRow
    Dim DsLookup, Ds As DataSet
    Private Sub FrmUserName_DnDongTK_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Save_OK = False
        V_Addhander()
        V_Load()
    ...
    Private Sub V_Load()
        ...
        '--------------------------------------------------------------------
        Dim Dstmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_SmUserDNDongTK_F3", M_Stt_Rec + "#" + M_Mode + "#" + M_Ma_Dvcs + "#" + M_User_Name)
        ...
        If M_Mode = "M" Then
            ...
            Me.Text = "Tạo mới đề nghị đóng tài khoản"
        Else
            Me.Text = "Sửa đề nghị đóng tài khoản"
        End If
...
#End Region
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Me.Tag = M_Stt_Rec
        Dim _Str As String = "SELECT TOP 0 * FROM dbo.DmDNDongTK WHERE 1=0"
        ...
        '------------
        Dim _Xml As String = CyberSmodb.V_ConvertDataToXML({"DmDNDongTK"}, {DtMaster})
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_SmUserDNDongTK_Save", TxtStt_Rec.Text + "#" + M_Mode + "#" + _Xml + "#" + M_Ma_Dvcs + "#" + M_User_Name)
