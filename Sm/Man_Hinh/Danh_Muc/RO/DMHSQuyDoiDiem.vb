...
#Region "Buuton"
    Protected Overrides Sub V_Save(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim DsTmpSave As DataSet = CyberSmlib.SQLExcuteStoreProcedure(Appconn, "CP_ChckSaveDMHSQuyDoiDiem", Me.Mode + "#" + _Ngay_HL.ToString("yyyyMMdd") + "#" + TxtID.Text + "#" + _
                                                                         _Gia_tri_C.ToString + "#" + _Gia_tri_I.ToString + "#" + _Gia_tri_N.ToString + "#" + _Gia_tri_W.ToString + "#" + _Acti_C + "#" + _Acti_I + "#" + _Acti_N + "#" + _Acti_W + "#" + TxtMa_Dvcs.Text + "#" + Me.M_User_Name.Trim)
