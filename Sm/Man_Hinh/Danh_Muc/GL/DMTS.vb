...
#Region "Buuton"
    Protected Overrides Sub V_Save(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        End If
        For i = 0 To tbCtdmts.Rows.Count - 1
            If tbCtdmts.Rows(i).Item("TK_No").ToString.Trim = "" Or tbCtdmts.Rows(i).Item("TK_Co").ToString.Trim = "" Then
                MsgBox(IIf(M_LAN = "V", "Bạn chưa khai báo tài khoản khấu hao. Không lưu được!", "No details on asset. Do not save it!"), 64, M_CYBER_VER)
                Exit Sub
            End If
        Next
