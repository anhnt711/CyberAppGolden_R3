Public Class DMHLTD4
    Dim DrReturn As DataRow
    Dim DsLookup As New DataSet
    Private Sub DMHLTD4_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_GetChkErro()
...
#Region "Vali --- Ma_Kho"
    Private Sub V_Ma_TD4(ByVal sender As System.Object, ByVal e As System.EventArgs)
        TxtMa_TD4.V_LookUp(M_LAN, M_Para, oSysvar, Appconn, DsLookup, "Ma_TD4", "DmTD4", "1=1", "1=1")
    End Sub
    Private Sub L_Ma_TD4(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If TxtMa_TD4.Text = "" Then
            ...
            Exit Sub
        End If
        DrReturn = TxtMa_TD4.GetRowsSelectData(True)
