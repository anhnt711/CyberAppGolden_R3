...
#Region "Load"
    ...
    Sub V_Load_CtPb(ByVal M_Mode As String, ByVal Stt_rec As String, ByVal sMa_Dvcs As String)
        ...
        M_Mode = M_Mode.Trim
        DsFilterTsCd = CyberSmlib.SQLExcuteStoreProcedure(Appconn, "CP_FilterCtPb", Stt_rec & "#" & sMa_Dvcs & "#" & M_Mode)
...
#Region "Buuton"
    Protected Overrides Sub V_Save(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If Mode.Trim = "M" Or TxtStt_Rec.Text.Trim = "" Then
            ...
            TxtNam.Text = Me.Key_Nam.ToString
            dstmpPB = CyberSmlib.SQLExcuteStoreProcedure(Appconn, "CP_GetStt_RecDMPB", Me.Key_Nam.ToString.Trim + "#" + M_Ma_Dvcs.Trim)
        ...
        CyberSmodb.V_SaveToSQL(Appconn, oSysvar, M_User_Name, tbCtPb, "DMPB1", Mode, " Stt_rec =N'" + TxtStt_Rec.Text.Trim + "'")
