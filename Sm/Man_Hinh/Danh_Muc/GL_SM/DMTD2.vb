Public Class DMTD2
    ...
    Private Sub FDMTD2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Cyber.ListGroupGL.Sys.SetAutoCode(Appconn, Me.Tb_Name, Me.Mode, CyberSmlib, CyberSmodb, TxtMa_TD2, TxtNh_TD1, TxtNh_TD2, TxtNh_TD3, TxtNh_TD4, TxtNh_TD5)
        TxtMa_TD2.Focus()
        CyberSupport.Translaste(Me, M_LAN, True)
    End Sub
#Region "Load"
    Protected Overrides Sub V_Load()
        MyBase.V_Load()
        If TxtNh_TD1.Text.Trim = "" Then TxtTen_Nh1.Text = "" Else TxtTen_Nh1.Text = CyberSmodb.SQLGetvalue(Appconn, "Ten_Nh", "DmNhTD2", "(Loai_Nh = '1' AND Ma_Nh = N'" + TxtNh_TD1.Text.Trim + "')", CyberSmlib)
        If TxtNh_TD2.Text.Trim = "" Then TxtTen_Nh2.Text = "" Else TxtTen_Nh2.Text = CyberSmodb.SQLGetvalue(Appconn, "Ten_Nh", "DmNhTD2", "(Loai_Nh = '2' AND Ma_Nh = N'" + TxtNh_TD2.Text.Trim + "')", CyberSmlib)
        If TxtNh_TD3.Text.Trim = "" Then TxtTen_Nh3.Text = "" Else TxtTen_Nh3.Text = CyberSmodb.SQLGetvalue(Appconn, "Ten_Nh", "DmNhTD2", "(Loai_Nh = '3' AND Ma_Nh = N'" + TxtNh_TD3.Text.Trim + "')", CyberSmlib)
        If TxtNh_TD4.Text.Trim = "" Then TxtTen_Nh4.Text = "" Else TxtTen_Nh4.Text = CyberSmodb.SQLGetvalue(Appconn, "Ten_Nh", "DmNhTD2", "(Loai_Nh = '4' AND Ma_Nh = N'" + TxtNh_TD4.Text.Trim + "')", CyberSmlib)
        If TxtNh_TD5.Text.Trim = "" Then TxtTen_Nh5.Text = "" Else TxtTen_Nh5.Text = CyberSmodb.SQLGetvalue(Appconn, "Ten_Nh", "DmNhTD2", "(Loai_Nh = '5' AND Ma_Nh = N'" + TxtNh_TD5.Text.Trim + "')", CyberSmlib)
...
#Region "Vali --- Ma_TD1"
    Private Sub V_Nh_TD1(ByVal sender As System.Object, ByVal e As System.EventArgs)
        TxtNh_TD1.V_LookUp(M_LAN, M_Para, oSysvar, Appconn, DsLookup, "Ma_NH", "DmNhTD2", "1=1", "Loai_Nh='1'")
    End Sub
...
#Region "Vali --- Ma_TD2"
    Private Sub V_Nh_TD2(ByVal sender As System.Object, ByVal e As System.EventArgs)
        TxtNh_TD2.V_LookUp(M_LAN, M_Para, oSysvar, Appconn, DsLookup, "Ma_NH", "DmNhTD2", "1=1", "Loai_Nh='2'")
    End Sub
...
#Region "Vali --- Ma_TD3"
    Private Sub V_Nh_TD3(ByVal sender As System.Object, ByVal e As System.EventArgs)
        TxtNh_TD3.V_LookUp(M_LAN, M_Para, oSysvar, Appconn, DsLookup, "Ma_NH", "DmNhTD2", "1=1", "Loai_Nh='3'")
    End Sub
...
#Region "Vali --- Ma_TD4"
    Private Sub V_Nh_TD4(ByVal sender As System.Object, ByVal e As System.EventArgs)
        TxtNh_TD4.V_LookUp(M_LAN, M_Para, oSysvar, Appconn, DsLookup, "Ma_NH", "DmNhTD2", "1=1", "Loai_Nh='4'")
    End Sub
...
#Region "Vali --- Ma_TD5"
    Private Sub V_Nh_TD5(ByVal sender As System.Object, ByVal e As System.EventArgs)
        TxtNh_TD5.V_LookUp(M_LAN, M_Para, oSysvar, Appconn, DsLookup, "Ma_NH", "DmNhTD2", "1=1", "Loai_Nh='5'")
    End Sub
...
#Region "Buuton"
    Protected Overrides Sub V_Save(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If Not _Value.Trim = "" Then TxtMa_TD2.Text = _Value
