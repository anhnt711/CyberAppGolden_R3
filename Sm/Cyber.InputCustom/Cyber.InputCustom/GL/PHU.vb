...
#End Region
    Private Sub PHU_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#Region "Valid - Detail - Core"
    ...
    Private Sub L_Tk_I(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If DrReturn Is Nothing Then
            ...
            End If
        End If
        CyberSupport.V_SetSD(StatusFooter1, AppConn, "KT", M_Mode, Dv_DetailTmp.Item(iRow).Item("TK_I"), TxtMa_Kh.Text, "", "", M_Stt_Rec, M_Ma_CT, M_Ma_Dvcs, M_User_Name, CyberSmlib)
    End Sub
    ...
    Private Sub L_Ma_kh_i(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        iRow = DetailGRV.GetFocusedDataSourceRowIndex
        If iRow < 0 Then Exit Sub
        CyberSupport.V_GetNameList(StatusFooter1, AppConn, osysvar, M_Mode, Dv_DetailTmp.Item(iRow).Item("Ma_KH_I"), "Ma_KH", "Ten_KH", "DMKH", M_Stt_Rec, M_Ma_CT, M_Ma_Dvcs, M_User_Name, CyberSmlib)
    End Sub
