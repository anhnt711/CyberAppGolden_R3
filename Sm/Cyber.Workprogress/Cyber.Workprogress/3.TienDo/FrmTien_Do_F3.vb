...
#Region "Biến"
    ...
    Dim Dt_CD, Dt_DmMucSDS, Dt_DmMucSBD, Dt_DMTTCP As DataTable
    ...
    Dim EditCVIs_GO, EditCVIs_SON, EditMa_KtVt, EditTen_KtVt, EditCVMa_Ktv1, EditCVMa_Ktv2, EditVTMa_Ktv1, EditVTMa_Ktv2 As New Cyber.Fill.CyberColumnGridView
    Dim EditCVTen_Ktv1, EditCVTen_KTV2, EditVTTen_Ktv1, EditVTTen_KTV2 As New Cyber.Fill.CyberColumnGridView
...
#End Region
    Private Sub FrmCVDV_KH_SCC_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim _iRow_VT As Integer = MasterVtGRV.GetFocusedDataSourceRowIndex
    ...
    Private Sub V_AddHander()
        ...
        EditVTMa_Ktv1.GetColumn(MasterVtGRV, "Ma_KTV1")
        EditVTMa_Ktv2.GetColumn(MasterVtGRV, "Ma_KTV2")
        EditVTTen_Ktv1.GetColumn(MasterVtGRV, "Ten_KTV1")
        EditVTTen_KTV2.GetColumn(MasterVtGRV, "Ten_KTV2")
        '---------------------------------------------------------
        ...
        EditVTMa_Ktv1.V_ActiLookUpColumn(AddressOf V_Ma_KTV1_VT, AddressOf L_Ma_KTV1_VT)
        EditVTMa_Ktv2.V_ActiLookUpColumn(AddressOf V_Ma_KTV2, AddressOf L_Ma_KTV2)
        '------------------------------------
...
#Region "Select And Remove tag"
    ...
    Private Sub MasterCV_Click(sender As Object, e As EventArgs) Handles MasterCV.Click
...
#Region "Xem hen"
    ...
    End Sub
#End Region
    Private Sub V_Ma_KTV1_VT(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        Dim _Keyclient As String = "1=1"
        Dim _KeySQL As String = "1=1"
        Dim _ma_TO As String = ""
        _ma_TO = CyberWork.V_GetvalueCombox(CbbMa_To).ToString.Trim
    ...
    End Sub
    Private Sub L_Ma_KTV1_VT(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim iRow As Integer = -1
        iRow = MasterVtGRV.GetFocusedDataSourceRowIndex
        If iRow < 0 Then Exit Sub
        DrReturn = CyberSupport.L_Lookup(M_Mode, M_Ma_Ct, sender, True)
        If DrReturn Is Nothing Then
            Dv_VT.Item(iRow).BeginEdit()
            Dv_VT.Item(iRow).Item("Ma_KTV1") = ""
            If Dv_VT.Table.Columns.Contains("Ten_KTV1") Then Dv_VT.Item(iRow).Item("Ten_KTV1") = ""
            Dv_VT.Item(iRow).EndEdit()
            Exit Sub
        Else
            Dv_VT.Item(iRow).BeginEdit()
            Dv_VT.Item(iRow).Item("Ma_KTV1") = DrReturn("Ma_HS").ToString.Trim
            If Dv_VT.Table.Columns.Contains("Ten_KTV1") And DrReturn.Table.Columns.Contains("Ten_HS") Then Dv_VT.Item(iRow).Item("Ten_KTV1") = DrReturn("Ten_HS").ToString.Trim
            Dv_VT.Item(iRow).EndEdit()
        End If
        Dt_VT.AcceptChanges()
        MasterVtGRV.UpdateCurrentRow()
...
#Region "Event DragDrop"
    ...
    Private Sub Master_DragDrop_VT(ByVal sender As Object, ByVal e As System.Windows.Forms.DragEventArgs)
        ...
        If _Tag.Trim.Trim <> "1" Then Return
        Dv_VT.BeginInit()
        If Dv_VT.Table.Columns.Contains("Ma_KTV1") Then Dv_VT.Item(IRow_Master_VT).Item("Ma_KTV1") = _Ma_Hs
        If Dv_VT.Table.Columns.Contains("Ten_KTV1") Then Dv_VT.Item(IRow_Master_VT).Item("Ten_KTV1") = _Ten_Hs
        ...
        For i As Integer = 0 To Dt_VT.Rows.Count - 1
            If _KTV Then
                If Dt_VT.Rows(i).Item("Ma_KTV1").ToString.Trim = "" Then
                    Dt_VT.Rows(i).Item("Ma_KTV1") = _Ma_Hs
                    Dt_VT.Rows(i).Item("Ten_KTV1") = _Ten_Hs
                End If
            Else
                If Dt_VT.Rows(i).Item("Ma_KTV2").ToString.Trim = "" Then
                    Dt_VT.Rows(i).Item("Ma_KTV2") = _Ma_Hs
                    Dt_VT.Rows(i).Item("Ten_KTV2") = _Ten_Hs
                End If
            End If
        Next
        Dt_VT.AcceptChanges()
...
#Region "Save/Quit..."
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        '--------------------------------------------------------------------------------------------
        Dim M_strParameterStore As String = M_Kieu_Xem + "#" + M_Loai_SC + "#" + M_Loai_Giao_Viec + "#" + M_Mode.Trim + "#" + M_Stt_Rec + "#" + M_Stt_Rec_Ro + "#" + M_So_Ro + "#" + strXML + "#" + M_Ma_TTCP + "#" + M_Ma_Dvcs + "#" + M_User_Name
...
#Region "Loại giao việc"
    ...
    'End Sub
#End Region
#Region "Chọn theo loại công việc"
#End Region
    Private Sub ChkAll_chon_GO(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ChkLoc_CV_GO.CheckedChanged
        Dim i As Integer = 0
        Dim Dr As DataRow

        If ChkLoc_CV_GO.Checked = True Then
            ChkLoc_CV_Son.Checked = False
            ChkLoc_CV_VSNT.Checked = False
            ChkLoc_CV_MGD.Checked = False
        End If

        For i = 0 To MasterCVGRV.RowCount - 1
            Dr = MasterCVGRV.GetDataRow(i)
            If ChkLoc_CV_GO.Checked = True And Dr.Item("IS_Go").ToString = 1 Then
                Dr.Item("Tag") = "1"
            Else
                Dr.Item("Tag") = "0"
            End If
        Next
    End Sub
    Private Sub ChkAll_chon_Son(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ChkLoc_CV_Son.CheckedChanged
        Dim i As Integer = 0
        Dim Dr As DataRow

        If ChkLoc_CV_Son.Checked = True Then
            ChkLoc_CV_GO.Checked = False
            ChkLoc_CV_VSNT.Checked = False
            ChkLoc_CV_MGD.Checked = False
        End If
        ...
        For i = 0 To MasterCVGRV.RowCount - 1
            Dr = MasterCVGRV.GetDataRow(i)
            If ChkLoc_CV_Son.Checked = True And Dr.Item("IS_Son").ToString = 1 Then
                Dr.Item("Tag") = "1"
            Else
                Dr.Item("Tag") = "0"
            End If
        Next
    End Sub
    Private Sub ChkAll_chon_MGD(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ChkLoc_CV_MGD.CheckedChanged
        Dim i As Integer = 0
        Dim Dr As DataRow

        If ChkLoc_CV_MGD.Checked = True Then
            ChkLoc_CV_GO.Checked = False
            ChkLoc_CV_VSNT.Checked = False
            ChkLoc_CV_Son.Checked = False
        End If
        ...
        For i = 0 To MasterCVGRV.RowCount - 1
            Dr = MasterCVGRV.GetDataRow(i)
            If ChkLoc_CV_MGD.Checked = True And Dr.Item("Is_MGD").ToString = 1 Then
                Dr.Item("Tag") = "1"
            Else
                Dr.Item("Tag") = "0"
            End If
