...
Public Class FrmTien_Do
    Dim TimerLoad As Integer = 15000, RowStep As Integer = 7, FontSizeHead As Integer = 26, FontSizeRow As Integer = 26, FontName As String = "Microsoft Sans Serif"
...
#Region "System"
    ...
    Private Sub V_LoadTabVisible()
        M_Ma_TTCP = CyberSupport.V_GetDefault_TTCP("PKH", M_Ma_Dvcs, M_User_Name, AppConn, CyberSmlib)
        Dim Dstmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_Work_Config", M_Kieu_Xem & "#" & M_Loai_SC & "#" & M_Ma_Dvcs & "#" & M_User_Name & "#" & M_Ma_TTCP)
