...
Public Class FrmCapStt
    Dim Dt_Master, Dt_ColFrozen, Dt_Header As New DataTable
    Dim Dv_Master, Dv_Header As New DataView
    ...
    Private Sub MasterGRV_PopupMenuShowing(ByVal sender As System.Object, ByVal e As DevExpress.XtraGrid.Views.Grid.PopupMenuShowingEventArgs)
        ...
        PopupMenu.ItemLinks.Add(New Cyber.SmLib.CyberMenuPopup(sender, 0, IIf(Lan = "V", "Gọi xác nhận lịch hẹn", "Call"), AddressOf V_Goi, System.Windows.Forms.Shortcut.F6, Nothing, True, True), True).BeginGroup = True
