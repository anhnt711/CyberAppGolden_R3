...
#End Region
    Private Sub DmDLHen_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        End If
        If M_Mode = "M" Then TxtMa_Xe.Focus()
...
#Region "Load..."
    ...
    Private Sub V_AddHander()
        ...
        AddHandler ChkIs_Sua_Bien.CheckedChanged, AddressOf V_Sua_Bien
    ...
    End Sub
    Private Sub V_Sua_Bien()
        If ChkIs_Sua_Bien.Checked Then
            TxtMa_Xe.Enabled = True
        End If
